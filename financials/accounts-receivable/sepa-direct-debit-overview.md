...
<a name="what-is-the-goal-of-sepa-direct-debits"></a>什么是 SEPA 直接借记目标？
---------------------------------------

在一个已签名的授权由该债权人的情况下，授予客户的 SEPA 直接借记债权人允许从客户的银行筹集账户资金。 客户签署授权允许债权人收取付款并指示客户的银行支付该收款。 
...
国际银行帐号 (IBAN) 和银行标识符代码 (BIC) 用于标识在 32 个 SEPA 国家/地区的任何帐户。 在字段中输入伊班族 SWIFT 代码的字段和伊班族 BIC。 这两个字段位于“银行帐户”页中的“银行帐户”选项卡上的“附加标识”快速选项卡上。 这对于债权人的银行帐户和客户的银行帐户皆适用。
...
SEPA 数据格式基于 ISO 20022 消息标准。 在配置应收帐款付款方式，将检查一般电子报告此复选框并选择 SEPA 直接借记格式为配置导出格式。 当您在客户付款日记帐中生成一个付款文件时，您使用该付款方式。
