---
title: "在应收帐款中的信用和收款"
description: "应收帐款信息在催款中央管理催款页面查看工序使用的 Microsoft Dynamics 365。 贷方和收款经理可以使用此主要观点以管理集合。 收款代理通过使用预定义的收集标准，或者从客户页生成的客户列表收集流程开始。"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
应收帐款信息在催款中央管理催款页面查看工序使用的 Microsoft Dynamics 365。 贷方和收款经理可以使用此主要观点以管理集合。 收款代理通过使用预定义的收集标准，或者从客户页生成的客户列表收集流程开始。
...
默认情况下，用户可以查看有关催款的所有客户信息的工序的 Microsoft Dynamics 365 列表页。 您可以使用收费代理记录确定可用于筛选“收款列表”页和“收款”页中的信息的客户池。 

收款代理是处理客户工作以确保按时收到付款的人员。 在工序的 Microsoft Dynamics 365 中，应收该代理是分配给用户安装"页面上的用户的工作人员。
...
<li>默认情况下，用户工序的 Microsoft Dynamics 365 访问具有帐龄的快照的所有客户。</li>
...
所选客户的陈列橱上部窗格。 中间名窗格查看客户的交易记录。 下部窗格显示客户的活动。 您可以创建收集案例跟踪一个或多个交易记录和活动的催款信息。 在上部和下部窗格中的信息可以按例筛选。 
...
## <a name="create-writeoff-transactions"></a>注销创建交易记录
