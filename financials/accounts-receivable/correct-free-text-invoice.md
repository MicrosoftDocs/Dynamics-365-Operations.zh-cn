...
若要更正已过帐的普通发票，请打开过帐的普通发票。 **在发票** "页面上，选择取消** **，然后选择**纠正**发票。 选择一个原因代码，添加注释，并且为新的已更正发票选择日期。 您可以修改已更正发票并将其过帐。 
...
-   普通发票的标题查看一个省**取消发票“\[发票号码\]”** **或纠正后的发票\[“发票”\]**号码。

> [!NOTE]
> 只有当**后，此功能才可用。普通发票**更正 Configuration Key。
