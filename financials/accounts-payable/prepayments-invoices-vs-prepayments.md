...
4.  您可以将付款标记为预付款。 如果付款为预付款，标记付款过帐到过帐模板定义设置的您在步骤 1 和 2. 的会计科目。 此外，标记，如果付款为预付款，计算税金。 某些政府需要在记录预付款时支付税金，即使没有发票也是。
5.  过帐预付款。
6.  选项：，在您创建发票前，您可以结算预付款采购订单或销售订单。 在销售订单或采购订单"页，操作窗格上，请使用** **结算交易记录。
