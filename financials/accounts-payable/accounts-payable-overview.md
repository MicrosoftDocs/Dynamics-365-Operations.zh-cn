...
## <a name="setup-pages-for-accounts-payable"></a>应付帐款设置页面
...
## <a name="optional-setup-pages-for-accounts-payable"></a>应付帐款的页面设置选项
...
-   **在 1099 字段**页，根据最新的 IRS 要求更新必须申报到验证和美国国税局 (IRS)，的最小金额。

## <a name="optional-setup-for-other-modules"></a>**其他模块的选项设置**
