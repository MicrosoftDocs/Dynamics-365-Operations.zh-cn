...
|             |                  |              |                 |           |            |                 |                    |
|-------------|------------------|--------------|-----------------|-----------|------------|-----------------|--------------------|
| **凭证** | **科目类型** | **科目**  | **描述** | **借记卡** | **信用卡** | **Offset type** | **Offset account** |
| GNJL001     | 供应商           | 1001         | INV1            |           | 100.00     | 分类帐          | &lt;为空&gt;      |
| GNJL001     | 分类帐           | 606300-001-- | INV1            |   50.00   |            | 分类帐          | &lt;为空&gt;      |
| GNJL001     | 分类帐           | 606300-002-- | INV1            |   50.00   |            | 分类帐          | &lt;为空&gt;      |
