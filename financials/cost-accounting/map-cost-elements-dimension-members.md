...
# <a name="map-different-cost-element-dimension-members-to-a-common-set-of-dimension-members"></a>映射不同的成本要素维度成员到公共组维度成员
