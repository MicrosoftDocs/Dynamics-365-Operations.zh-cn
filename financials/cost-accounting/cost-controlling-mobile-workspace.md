...
如果已经为您的组织部署 Microsoft Dynamics 365 for Finance and Operations Enterprise Edition 2017 年 7 月更新，系统管理员必须发布**成本控制**移动工作区。 有关说明，请查阅 [发布移动工作区](/dynamics365/unified-operations/dev-itpro/mobile-apps/publish-mobile-workspace)。
