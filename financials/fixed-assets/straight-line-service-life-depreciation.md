...
例如，对于会计年度 7 月 1 日到 6 月 30 日，折旧计算从 3 月 7 月 1 日开始。 会计年度可以长于或短于 12 个月。 对于每个会计期间，自动调整折旧。 下一会计年度的长度基于您在“会计日历”窗体中创建新的会计年度时设置的会计期间。 
...
| 第 6 年 | 持有的 800\*                           | 1,800 – 800 = 1,000                   |

剩余金额\*，由于余额小于折旧金额，减去残，则值的剩余金额的操作。
