...
> [!NOTE] 
> 在选择**系数**时** **方法"字段，系数** **字段，并** **间隔"字段中显示。
...
购置价格都是 100,000，该系数为 70，使用年限为 10 年，并且折旧 1 月 1 日开始。 折旧金额与帐面净值仅查看使用年限的前六年。
...
购置价格都是 100,000，该系数为 20，使用年限为 10 年，并且折旧 1 月 1 日开始。 折旧金额与帐面净值仅查看使用年限的前六年。
