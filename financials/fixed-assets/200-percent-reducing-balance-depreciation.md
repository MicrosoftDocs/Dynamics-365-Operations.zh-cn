...
**“日历”**选项在每年的 1 月 1 日更新折旧基数。 通常，折旧是减去残帐面净值。 在此主题后面的示例中，折旧基数是计算列中第一个表达式的分子。 
...
例如，对于会计年度 7 月 1 日到 6 月 30 日，折旧计算从 3 月 7 月 1 日开始。 会计年度可以长于或短于 12 个月。 对于每个期间，都可以调整折旧。 下一会计年度的长度由**“会计日历”**页面上的期间设置决定。 
...
> [!NOTE] 
> 通常，在，来计算 200% 余额递减法折旧的方法金额比使用直线法方法，将计算的金额将变得少，具有对直线方法创建转换。剩余年限。
