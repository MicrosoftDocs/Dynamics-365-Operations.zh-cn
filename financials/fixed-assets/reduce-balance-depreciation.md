...
# <a name="reduce-balance-depreciation"></a>余额递减折旧
...
如果在“折旧年份”字段中选择“会计”，则使用直线折旧法。 它是基于会计年度计算的，会计年度在“分类帐”页中选择的会计日历的“会计日历”页中设置。 例如，对于会计年度 7 月 1 日到 6 月 30 日，折旧计算从 3 月 7 月 1 日开始。 会计年度可以长于或短于 12 个月。 对于每个会计期间，都可以调整折旧。 下一会计年度的长度基于您在“会计日历”页中创建新的会计年度时设置的会计期间。
