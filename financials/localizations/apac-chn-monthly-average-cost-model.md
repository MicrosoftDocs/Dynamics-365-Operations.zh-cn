...
ms.openlocfilehash: 4bc3f25d9e9cd300120038676772bcad914095b3
ms.lasthandoff: 03/31/2017


---

# <a name="monthly-average-cost-model-for-china"></a>Monthly average cost model for China
...
| 开票的库存结转日期前的交易记录在计算和结算。 例如，您，则 2016 年 10 月 31 日为存货期末和具有未结交易记录和 9 月十月，则所有打开颁发的交易记录将一起 10 月对于 9 月份，并结算，以及具有相同的平均成本调整。 | 每月计算和结算开票的库存交易记录。 例如，您，则 2016 年 10 月 31 日为存货期末和具有未结交易记录和 9 月 10 月，9 月交易记录的平均成本在首次计算并结算和 9 月为调整。 然后，计算 10 月的交易记录并结算，并且调整为 10 月的平均成本。 |
...
> [!NOTE]
> 如果只发生过一次收货或在该月之前，则不必评估平均值。 这是因为所有发货从其结算，并且不创建收货和转移。 同样，如果只有一个发货，在这个月平均为值未发生，并将从收货未创建的。
...
许多中国贸易制造公司使用每月平均成本模型，因为这是一个简单的手动计算库存成本的方法。 下表进行比较来处理发货和收货交易记录手动在每月的平均成本模型和每月平均成本模型可用于以" Microsoft Dynamics 365。工序中的流程。
| 手动每月平均成本模型                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | 每月平均成本模型在工序 365 的 Microsoft Dynamics 中                                                                                                                                                        |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
