...
-   应用维度筛选器到报表，请添加**选择一个维度筛选器**。 选择维度，然后键入 ID 或选择维度在列表的维度。 若要删除维度筛选器，请单击**清除**。
...
您可以查看当前月或以前月的报表，而不重新生成报表。 若要打开的报表中，单击一个月**查看**，然后单击** **以前报表。 前一个月的列表报表生成用于显示。 展开要查看报表的那个月，选择该日期，然后单击**确定**。 之前月的报表将显示。 若要返回当前月的报表，请单击**取消**。
