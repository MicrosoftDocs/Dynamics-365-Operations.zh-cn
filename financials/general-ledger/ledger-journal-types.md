---
title: "分类帐日记帐类型"
description: "本文介绍可以为财务日记帐设置的日记帐类型。 使用&quot;页面设置日志名称可以在整个中使用 Microsoft Dynamics 365。工序的日志。"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
本文介绍可以为财务日记帐设置的日记帐类型。 使用"页面设置日志名称可以在整个中使用 Microsoft Dynamics 365。工序的日志。
...
| 供应商发票池 (未 过帐 | 创建尚未过帐到临时到达帐户的供应商发票交易记录。                                                                                                                                                                                                                                                             | 供应商发票池(不包括过帐)详细信息                  |
| 供应商发票池               | 创建供应商发票池交易记录。                                                                                                                                                                                                                                                                                                                    |                                                                |
