...
# <a name="organize-your-workforce-using-departments-jobs-and-positions"></a>使用部门、工作和职位，组织您的人才
...
|**销售**|销售经理（西部）|销售经理|
|**销售**|销售经理（中部）|销售经理|
|**Accounting**|会计主管|会计经理|
|**Accounting**|会计-A|会计师|
|**Human resources**|人力资源经理（东部）|人力资源经理|
|**Human resources**|人力资源经理（西部）|人力资源经理|
|**Human resources**|人力资源经理（中部）|人力资源经理|
...
工作职能就像作业任务。 工作职能描述分配给作业的一个或多个任务、职责或责任。 工作职能可分配给作业并用于设置和实现薪酬计划的资格规则。 工作职能的示例在下表中列出。
...
职位是更低级别的组织层次结构中的重要元素。 位置是工作的单个实例。 例如，位置，“销售经理 (东部)，”是与作业的一个位置，“销售经理”。 职位存在部门和分配给工作人员。
