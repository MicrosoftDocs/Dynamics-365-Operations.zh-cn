...
下图显示绩效管理的主要组件彼此之间的关系。 [] (性能![流程概览。/media/hcm_performanceoverviewdiagram-300x189.png)](。/media/hcm_performanceoverviewdiagram.png)    
...
2.  最终审核。 添加此元素控制状态更改为从**查看准备** **最终**查看。 请更改分配使用 Employee.line 经理级别= 1 的管理层次结构，如果希望经理审核最终审核。 如果希望员工批准，请更改工作流用户的分配。 如果希望经理和员工都批准，请在工作流中添加两个步骤，然后按照所需批准顺序为每个步骤执行相应的分配。
