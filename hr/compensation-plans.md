...
使用薪酬管理来控制基本工资和奖励的发放。 员工的固定基本工资和业绩调薪通过固定薪酬计划进行控制的。 激励性的付款，例如额外津贴、绩效奖、股票期权和赠与以及一次性奖励，是通过可变薪酬计划控制的。 
...
<li>行动可以确保计算时，将会应用固定薪酬计划时处理。  例如，类型权益的操作将比较员工支付的最小参考点的员工的有关级别并确保员工的工资至少最小数量。</li>
</ul></td>
</tr>
<tr class="even">
<td>级别</td>
...
<tr class="even">
<td>付薪频率</td>
<td>付薪频率用于薪酬定义指定的时段。  例如，付薪频率帮助您理解薪酬金额指定是否为年薪与一工时付薪比率。 每周从每月付薪频率，还可以设置换算系数，薪酬转换金额小时和双周付薪频率转换为年度付薪频率。</td>
</tr>
<tr class="odd">
<td>薪酬地区</td>
...
<tr class="even">
<td>薪酬网格</td>
<td>薪酬网格包含薪酬结构。  薪酬网格可以由一个或多个薪酬计划中使用。</td>
</tr>
<tr class="odd">
<td>绩效计划</td>
...
每次运行流程事件，薪酬事件创建。  薪酬事件包含薪酬流程的结果。该过程包括的每个员工的事件。  在计算正确无误时，您可以加载薪酬事件更新受流程事件的影响的员工薪酬记录。
