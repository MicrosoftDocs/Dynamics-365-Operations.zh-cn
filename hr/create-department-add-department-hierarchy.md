...
部门还可能包括成本中心组。 可以向部门分配位置。 若要为部门，请单击** ** &gt; **人力资源部门** &gt; ** **部门。 下表对可用的字段。
...
5.  保存所做的更改。 您将收到一条消息起草版创建的层次结构。
6.  当您准备好，单击**发布**请在层次结构设计器。 您可以输入指示的生效日期什么时候应过帐层次结构。 例如，要在下一个日历年的年初添加新部门，请将生效日期设置为新日历年的 1 月 1 日。 对层次结构进行的更改将在该日期生效。
