---
title: "配置全球通讯簿"
description: "文章此描述必须在计划过程中进行，因此，在设置和配置全球通讯簿和任何其他的通讯簿在 Microsoft Dynamics 365 中的工序前的注意事项和决策。 某些决策需要您确认已为产品的其他区域做出了决策，例如组织层次结构。"
author: kfend
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
文章此描述必须在计划过程中进行，因此，在设置和配置全球通讯簿和任何其他的通讯簿在 Microsoft Dynamics 365 中的工序前的注意事项和决策。 某些决策需要您确认已为产品的其他区域做出了决策，例如组织层次结构。
