...
-   您不能合并与同一当事方角色（如同一法人中的客户或供应商）关联的当事方记录。 例如，可集会 A 与一个法人，客户在 123 中，并且各当事方 B 中法人 123 ) 与不同的客户。 这些当事方记录不能，合并，因为它们，则合并，合并的当事方记录在同一中将法人与多个客户端，则请不要授予权限。 但是，如果当事方 B 与法人 123 中的供应商或不同法人中的客户关联，则可合并记录。
