...
| 在装箱工作站对集装箱分组。                                     | 此功能能够将多个包装分组到装箱工作站的一个集装箱或牌照。 例如，电子商务/批发运营商可以将 100 个单独装箱的包装分组到一个集装箱（例如托盘或箱子）。 随后，工作人员可以通过扫描分组集装箱的一个条形码（牌照）生成一份工作说明，从而移动、分级或装载此集装箱。 此功能最大限度地减少了移动许多小型已装箱集装箱的工作交易。 有关详细信息，请参阅[创建移动设备菜单项以合并牌照（任务指南）](/dynamics365/unified-operations/supply-chain/warehousing/tasks/create-mobile-device-license-plate-consolidation)。                                                                                                                                                                                                                                                                                                                                                                                            |
