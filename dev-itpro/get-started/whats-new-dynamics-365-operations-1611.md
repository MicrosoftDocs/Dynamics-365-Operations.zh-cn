...
| 创建和维护未附加到费用报表的费用。    | 用户现在可以创建费用和维护它们（例如，通过附加收据或逐条记录的方式），而不必首先创建费用报表。 可以选择一个或多个费用，并添加到新的费用报表中，以便可以一次提交审批。 维护支出的新的页面。**可用于出差费用管理** &gt; **我的代价** &gt; ** **支出。                                                                                                                                                                                                                                                       |
...
| 访问新增五 Power BI 的内容打包为人力资源                                     | 新的内容包使组织人力资源和人力资源管理器分析以下操作：人才度量。•按年限、性别和婚姻状况的人口统计的分类•通过比较损耗率年度期间和年度为将组织员工授予查看原因列表•显示打开位置列表，以及比较打开在对已结转的薪酬福利和职位•比较每小时工资和包含的员工•显示在"可用福利登记的员工的数量•通过雇用员工类型查看招聘•分析的数量基于申请人的申请人，其来自，职位，以及为他们为组织培训应用•按位置划分课程登记•按状态的 Couse 出勤•员工的列表。课程能力和开发登记员工•员工持有的技能列表•按技能类型细分的成员 |
...
| 您能做什么                                                                                                                                                                                                      | 为什么如此重要                                                                                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 基于基础产品上的任何活动产品维度设置销售和购买的默认订单设置。 因此，您可以定义库存单位 (SKU) 或部分 SKU 的默认订单设置。 | 您可以指定适用于产品维度或产品维度组合的默认订单设置。 **示例**您销售 Polo 称作 T-shirt 的产品。 该产品提供两种颜色：绿色和蓝色。 还提供两种尺寸：小码和中码。 颜色和尺寸是 Polo 衫的活动产品维度。 您可以锁定所有绿色 Polo 衫的购买记录，无论尺寸。 |
...
<td>此功能可以提高工作效率。 <strong>Example</strong> You sell a product that is named Polo T-shirt. 该产品提供两种颜色：绿色和蓝色。 还提供两种尺寸：小码和中码。 颜色和尺寸是 Polo 衫的活动产品维度。 在您输入颜色为“绿色”、尺寸为“小码”的 Polo 衫的销售行时，您无需在“<strong>物料编号</strong>”、“<strong>颜色</strong>”和“<strong>尺寸</strong>”字段中输入数据。 您可以执行以下其中一个步骤创建行：
<ul>
...
### <a name="personalized-product-recommendations"></a>个性化的产品建议

| 您能做什么                                                                                                                                                                                                                                                                        | 为什么如此重要                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 查看建议个性化的产品在多个 touchpoints 在销售点 (POS) 确定基于的采购历史记录、为感物料兴趣其利息和物料可以是客户购买的客户其他在线和在砖和泥商店 | 对于具有大的目录，零售商个性化的建议使用产品帮助查看的客户并授权使用 clienteling 智能的商店关联。 展示通过产品所针对的客户的利息和采购习惯，建议使用 upsell 的产品帮助零售商，并且可以提高客户保留。 在工序的-零售产品，建议 Dynamics 365 是 powered by 认知服务和 Microsoft Azure 机器学习。 |
...
| 进一步了解 Dynamics 365 for Operations 中的托运支持                                                                                                         | 有关支持的过程进行托运的详细信息，请参阅 (托运 []，设置进行托运 [] () /dynamics365/operations/scm/inventory/setup 托运的/dynamics365/operations/scm/inventory/consignment) [托运，请创建补货 (订单任务指南)][(http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/)，请和基于更改生产的需求进行托运所有权 (库存任务指南)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/)。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
<tbody>
<tr class="odd">
<td>直接在销售订单行上定义需求采购来源和采购方式。 <strong>示例</strong> 创建销售订单行，并指定为直接交运交货类型。 主要供应商作为采购点添加到销售订单行。</td>
...
<tr class="even">
<td>直接从销售订单行创建订单承诺。 <strong>示例</strong> 创建从内部公司供应商是来源的销售订单行。 离开该行。 交货日期根据采购公司的现有量进行计算。</td>
