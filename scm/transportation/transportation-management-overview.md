...
![负荷制图](./media/Load-drawing1-1024x477.jpg)

## <a name="inbound-transportation"></a>入站运输
在您从供应商订购时物料，并且必须交付物料。您的仓库，您可能要为物料的运输。 您可以使用 Dynamics 365。工序可以计划传入负荷的运输和收货。 下图显示了计划入站负荷的运输的业务流程。 
...
![计划和处理出货负荷](./media/Planningandprocessingoutboundloads.jpg)
