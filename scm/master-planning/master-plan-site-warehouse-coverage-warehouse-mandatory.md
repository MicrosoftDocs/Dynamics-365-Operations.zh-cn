...
# <a name="master-planning-for-site-and-warehouse-coverage-warehouse-mandatory"></a>站点和仓库覆盖范围的，仓库必须主计划
...
-   The warehouse is set to **Manual**. **单击"库存 &gt; 管理设置 &gt; 库存仓库**细分 &gt;。 在“主计划”****快速选项卡上，查看“手动”****字段。
-   为物料定义物料覆盖范围。 **单击产品信息管理 &gt; 产品&gt; 发放**产品。 选择某一物料，然后，在操作窗格，在** **计划选项卡上，单击** **物料覆盖范围。
-   为仓库定义重填关系。 **单击"库存 &gt; 管理设置 &gt; 库存仓库**细分 &gt;。 在“主计划”****快速选项卡上，查看“主仓库”****字段组。
-   默认订单类型设置为“生产”、“采购订单”或“看板”。 **单击产品信息管理 &gt; 产品&gt; 发放**产品。 选择某一物料，然后，在操作窗格，在** **计划选项卡，请单击** **默认订单设置。 在**“默认订单设置”**窗体中，查看**“默认订单类型”**。
