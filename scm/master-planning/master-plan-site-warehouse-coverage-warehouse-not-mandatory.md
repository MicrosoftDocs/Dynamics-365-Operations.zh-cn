...
# <a name="master-planning-for-site-and-warehouse-coverage-warehouse-not-mandatory"></a>站点和仓库覆盖范围的主计划，仓库不是必需
...
-   仓库设置为“手动”。 **单击"库存 &gt; 管理设置 &gt; 库存仓库**细分 &gt;。 在“主计划”****快速选项卡上，查看“手动”****字段。
