...
在下达生产订单后，与该订单相关的生产作业将可见并可供登记。 **运算符在作业卡终端**页可为作业登记，例如开始、结束和完成，或** **作业卡设备页。 登记工时和数量从登记"页按照自动转移到生产日志记录的时间和数量。
...
原材料领料工作在下达期间生成。 工作。为生产订单实际预留物料的数量只生成，在下达订单。 以下设置生成要求物料的领料仓库工作：
