...
具有相同功能的运营资源可被分配一个优先级。 然后，如果多个资源具有满足计划编制要求在所需的级别的功能，并具有可用产能，则计划引擎的那些资源可以在中进行选择。 **如果优先级** **在计划参数**的**页主要资源选择**字段，选择具有最高优先级的资源 (最低的数值。** **优先级"字段) 首先在编制计划期间，选择。
...
-   创建两个单独的功能：低速钻取和高速钻取。 定义低速钻取作为具有每小时 1 到 9 个单位的处理时间的钻取。 定义高速钻取作为具有每小时 10 到 19 个单位的钻取处理时间的钻取。 然后将低速和机器钻功能，并且分配 M2 机器高速钻功能。 最后，则更改工艺路线上的资源功能高速钻取到需求。 然后，计划编制引擎将选择正确的机器 (M2)。
-   使用功能水平以使分配给钻床的钻取钻功能合格。 指定和机器具有钻功能的级别则为 2.0，M2 机器，并且具有钻功能的级别 11.0。 然后指定 10.0 为该工艺路线上的钻功能要求的最低水平。 计划编制引擎随后将确定只有 M2 设备满足资源需求。

## <a name="competencies-for-human-resources"></a>人力资源的能力
当您具有与“人力资源”中的工作人员关联的**“人力资源”**类型的运营资源时，您还可以在定义生产工艺路线的资源需求时利用工作人员的能力。 换句话说，您还可以指定特定技能、课程、证书或职称的要求。 计划编制引擎随后可选择与工作人员关联的资源，该选择将基于这些工作人员的能力。 能力在“人力资源”中设置，而不是在**“资源功能”**页上设置。 在您定义该技能、课程、证书或标题为资源需求时，你必须使用人力资源功能，并将每个资源**人力资源**键入指向相应的工作人员。 如果不使用"人力资源功能，可以在或副本类似于从人力资源的能力的功能**功能**资源"。 但是，**“资源功能”**页不包含维护技能、课程、证书或职称所需的功能。
