...
# <a name="production-order-defaults-in-manufacturing-execution"></a>“制造执行”中的生产订单默认值
...
在工作人员开始在生产作业上登记之前，应仔细考虑**生产订单默认值**页上的所有设置。 如果您的公司使用了多站点功能，那么您可能要为每个站点设置不同的生产订单默认值。 与生产控制集成的订单默认值在**生产订单默认值**页的以下选项卡上设置：
