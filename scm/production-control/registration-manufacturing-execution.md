---
title: "制造执行的登记"
description: "此主题描述您需要理解配置和使用制造执行的重要概念和术语。"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
此主题描述您需要理解配置和使用制造执行的重要概念和术语。 

制造执行主要由制造公司使用。 工作人员可以使用**作业登记**页登记生产作业上的时间和物料消耗。 所有登记审核后转移到相关模块。 持续审核和庄毅登记允许经理轻松跟踪生产订单的实际成本。
...
| 术语                          | 说明                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 制造执行       | 用于登记时间消耗量、物料、费用在生产作业，项目以及间接活动的功能。 在制造执行登记客户端中执行登记。                                                                                                                                                                                                                                                                                                                                                                                                   |
...
-   **登记项目成本和项目物料** (可用与时间和出勤) –员工可以登记与在一个项目费用日志的项目，如里程"和过桥工资的费用 (支出)。 工作人员还可以在项目上登记的物料消耗量。 这可以在项目物料日记帐中执行。
