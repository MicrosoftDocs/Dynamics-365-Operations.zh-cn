...
# <a name="product-related-translations-faq"></a>产品 FAQ 面向的转换
...
## <a name="how-do-i-create-translations-for-productrelated-information"></a>如何创建转换。产品的信息面向？
按照以下步骤创产品转换：
1.  **单击产品信息管理** &gt; **常见** &gt; ** **发放的产品。
2.  选择一个，产品和操作窗格上，在语言** **组中，单击** **转换。
3.  在“**文本翻译**”页面的“**语言**”字段选择语言。 若要添加更多语言，请展开** **语言"字段，然后单击** **好。
...
3.  在“**属性**”页面，单击“**翻译**”。
4.  在“**文本翻译**”页面的“**语言**”字段选择语言。 若要添加更多语言，请展开** **语言"字段，然后单击** **好。
...
4.  选择一个维度值，然后单击“**翻译**”。
5.  在“**文本翻译**”页面的“**语言**”字段选择语言。 若要添加更多语言，请展开** **语言"字段，然后单击** **好。
6.  **在转换的文本**组中，则在"名称和描述** ** ** **字段输入转换。
...
基于维度值是小，而红色变型**的产品名称\#: 小：**红色。  

客户需要购买一些小号的红色 T 恤，并且 T 恤的名称必须在发票上用法语显示。 您翻译维度值，小，而红色的法语，转换和产品变型**的名称为\#: 小：**胭脂。
<table>
<colgroup>
<col width="100%" />
</colgroup>
...
<ol>  
<li>单击 <strong>销售和市场</strong> &gt; <strong>常见</strong> &gt; <strong>客户</strong> &gt; <strong>所有</strong><strong>客户</strong>。</li>
...
1.  **单击产品信息管理** &gt; ** ** &gt; ** **设置款式组。
2.  选择**尺寸****组**、**颜色组**或**样式组**。
3.  **，在单击新** **大小** **组中然后为组输入名称。**，** ** **组颜色或样式组**字段。 单击“**尺寸**”、“**颜色**”或“**样式**”为组创建行。
4.  **在金额** **组中**行，**颜色** ** ** **组行** **或样式组行** "页上，单击"新** **，然后创建大小、颜色和样式的组。

若要在维度值组中管理值的转换，请执行以下步骤：
1.  按照前面所述的创建维度值组的步骤打开“**尺寸组行**”、“**颜色组行**”或“**样式组行**”页面。
2.  单击“**文本翻译**”。 **在文本转换** **则在转换的文本**组中，输入"，转换在** ** ** **名称和描述字段。

## <a name="when-can-translations-of-productrelated-information-be-managed"></a>产品的信息面向的转换什么时候可以管理？
