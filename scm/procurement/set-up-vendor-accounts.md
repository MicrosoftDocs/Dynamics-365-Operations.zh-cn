...
为了加快创建供应商帐户的流程，您可以创建模板。 要创建一个模板，在** **供应商"页上，操作窗格上，单击"选项** &gt; ** ** **记录信息。 然后单击**公司帐户模板**。 公司帐户模板与其他用户共享。  
...
若要添加一个供应商的联系人，**的所有供应商** "页上，在**供应商** ** **组中设置"选项卡上，依次单击，** ** &gt; ** **联系人添加联系人。  
...
您可以为供应商添加联系人。您的个人联系人在 Microsoft Office 365。 但是，您必须首先设置在 Dynamics 365 之间的同步工序和 365 在 Microsoft Office 的" Server 同步和 Microsoft Outlook 设置向导。
