---
title: "使用供应商，该供应商有关的合作门户"
description: "本主题说明在采购订单确认流程中采购代理如何使用供应商门户来与外部供应商协作。 此信息仅适用于 Dynamics AX 2016 &amp; 2 月 2016 5 月版本。"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="collaborate-with-vendors-by-using-the-vendor-portal"></a>使用供应商，该供应商有关的合作门户

本主题说明在采购订单确认流程中采购代理如何使用供应商门户来与外部供应商协作。 此信息仅适用于 Dynamics AX 2016 &amp; 2 月 2016 5 月版本。

本主题中的信息仅适用于 Dynamics AX 2016 年 2 月和 2016 年 5 月版本。 供应商门户功能用 Dynamics 365 的延伸供应商协作功能更换了工序 1611 版中。 有关新的供应商协作功能的详细信息，请参阅供应商协作 [使用工作与外部供应商] (供应商协作外部工作 vendors.md)。  
...
查看发送给供应商" PO 的版本和供应商的日志，响应单击** ** &gt; **确认请求**从采购订单。  

已发送给供应商等待响应且状态为**正在进行外部审查**的订单将在**已发送至供应商门户的采购订单，正等待响应**列表或**已发送至供应商门户的采购订单，响应需要处理**列表中显示。 如果您更改已发送给供应商的某个订单使其状态更改回**已审核**，则该订单将不再在这些列表中显示。 若要查看以前是否具有对订单的响应从供应商，请单击**日志** &gt; ** **确认请求。  
