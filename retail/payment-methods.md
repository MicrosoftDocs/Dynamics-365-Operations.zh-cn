---
title: "付款方式"
description: "设置系统时，零售商接受的每种付款类型都必须在 Microsoft Dynamics 365 for Operations 中的“零售和商业”中配置。 本文介绍您可设置的付款类型并介绍设置它们的流程。"
author: MargoC
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
设置系统时，零售商接受的每种付款类型都必须在 Microsoft Dynamics 365 for Operations 中的“零售和商业”中配置。 本文介绍您可设置的付款类型并介绍设置它们的流程。

零售商可以接受各种类型的付款以交换其销售的产品和服务。 尽管现金付款是最常用的形式，零售商也可以接收支票的形式、卡、付款，凭证等形式的付款。 设置系统时，零售商接受的每种付款类型都必须在 Dynamics 365 for Operations - Retail 中的“零售和商业”中配置。 下表描述设置在 Dynamics 365 for Operations - Retail 中的每种付款类型：
