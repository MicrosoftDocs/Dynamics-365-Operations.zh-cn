...
-   单击“**设计器**”时，不显示下载（或运行）安装程序的提示，或者您当前的安全设置不允许您下载文件。 **解决方案：**
    ...
    -   在 Internet Explorer 中，将 Dynamics 365 for Operations URL 添加到受信任的站点中。 单击**设置** &gt; **选项** &gt; **安全** &gt; **受信任的站点** &gt; **站点** &gt; **添加**。
-   程序不开始，并且指示您联系供应商。 **解决方案：**在 Internet Explorer 中，将 Dynamics 365 for Operations URL 添加到受信任的站点中。 单击**设置** &gt; **选项** &gt; **安全** &gt; **受信任的站点** &gt; **站点** &gt; **添加**。
