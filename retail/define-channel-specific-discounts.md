...
Microsoft Dynamics 365 for Operations 中的零售和商业使用价格组来定义渠道特定的折扣。 价格组可分配给以下一个或多个实体：渠道、目录、隶属关系和会员计划。 本文讨论渠道，不过，相同的概念适用于目录折扣、隶属关系折扣和会员折扣。

## <a name="price-groups"></a>价格组
\[caption id="attachment\_256084" align="alignnone" width="640"\][![价格组](./media/price-groups-1024x608.png)](./media/price-groups.png) Retail 的价格组链接\[/caption\] 
