---
title: "收据模板和打印"
description: "本文介绍如何修改窗体布局以控制如何打印收据、发票和其他单据。 Microsoft Dynamics 365 for Operations - Retail 包括您可以用于轻松创建和修改不同类型的窗体布局的窗体布局设计器。"
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
本文介绍如何修改窗体布局以控制如何打印收据、发票和其他单据。 Microsoft Dynamics 365 for Operations - Retail 包括您可以用于轻松创建和修改不同类型的窗体布局的窗体布局设计器。
...
1.  单击**零售和商业** &gt; **渠道设置** &gt; **POS 设置** &gt; **POS** &gt; **收据格式**。
...
5.  在安装完成后，输入您的 Dynamics 365 for Operations 用户名和密码，然后单击**登录**启动设计器。
...
1.  通过单击**零售和商业** &gt; **渠道设置** &gt; **POS 设置** &gt; **POS 配置文件** &gt; **硬件配置文件**打开硬件配置文件。
