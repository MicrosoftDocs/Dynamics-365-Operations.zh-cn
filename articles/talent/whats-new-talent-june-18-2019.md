...
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-june-18-2019"></a>Dynamics 365 for Talent（2019 年 6 月 18 日）新增功能或更改
...
本部分中介绍的更改适用于内部版本号 8.1.2347。

### <a name="confirmation-of-course-participants-causes-an-error"></a>确认课程参与者导致错误

已删除了用于打印有关课程参与者的报表的对话框。 Talent 中不支持此报表。
