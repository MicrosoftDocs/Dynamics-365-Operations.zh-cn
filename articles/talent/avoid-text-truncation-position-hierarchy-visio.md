...
遗憾的是，用户不能轻松更改文本的大小。 但是，您可以将职位层次结构从 Talent 中导出，然后导入到 Microsoft Visio。 以下文章是为 Microsoft Dynamics AX 2012 所写，但过程也适用于 Talent：[导出职位层次结构到 Microsoft Visio](https://docs.microsoft.com/dynamicsax-2012/appuser-itpro/export-a-position-hierarchy-to-microsoft-visio)。
