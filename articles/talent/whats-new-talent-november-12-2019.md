...
ms.locfileid: "2896650"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Dynamics 365 Talent 中的新增功能或更改（2019 年 11 月 12 日）
...
本部分中的更改适用于内部版本号 8.1.2604。 某些标题中括号内的数字是 Microsoft Dynamics Lifecycle Services (LCS) 中的支持号码。

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>办公室位置未通过 Excel 工作簿更新 (369727)

进行此更改后，您现在可以使用 Office 工作簿设计器来更新办公室位置。
