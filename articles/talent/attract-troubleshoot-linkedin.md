...
---
# <a name="troubleshoot-integration-with-linkedin-and-attract"></a>与 LinkedIn 和 Attract 集成疑难解答

[!include [banner](includes/banner.md)]

请使用以下信息来帮助解决在您尝试从 Microsoft Dynamics 365 Talent: Attract 将工作发布到 LinkedIn 时可能遇到的问题。

## <a name="you-cant-sign-in-to-linkedin-from-attract"></a>您无法从 Attract 登录 LinkedIn

如果您在从 Attract 登录 LinkedIn 时遇到问题，请尝试以下步骤：

1. 验证您在 Attract 中输入的 LinkedIn 凭据是否有效且正确。
2. 如果凭据有效且正确，请联系 [LinkedIn 支持](https://www.linkedin.com/help/linkedin)。
3. 如果问题仍然存在，请联系 [Microsoft 支持](./talent-support.md)。

## <a name="job-posts-from-attract-dont-appear-on-linkedin"></a>来自 Attract 的工作发布不出现在 LinkedIn 上
