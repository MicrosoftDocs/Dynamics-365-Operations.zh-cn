...
员工记录的更改很少立即生效。 您需要更新员工开始日期（通常是在将来）的数据，并且还需要更新过去的信息。 使用这种简化的导航模型，您将能够更新未来和过去的数据，而无需导航到多个窗体或更改日期上下文。 此更改还会动态地在员工记录的上部横幅区域中宣传和显示关键信息。
