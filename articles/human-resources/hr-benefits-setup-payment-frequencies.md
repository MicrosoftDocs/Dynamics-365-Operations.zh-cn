...
Microsoft Dynamics 365 Human Resources 使用付款频率来计算年度福利薪金，确定员工在每个付款期间支付的福利金金额，并定义向提供商付款的频率。

福利付款频率使用换算系数转换每月、每半月、每两周、每周和每天付款频率之间的福利付款期间。 这使公司可以定义福利计划中付款频率之间的相关性。

换算系数字段标识从付款频率到标准付款期间的换算系数，允许系统在付款频率之间进行计算。 换算系数金额还用于确定员工按每个支付频率应该支付的福利金金额。
