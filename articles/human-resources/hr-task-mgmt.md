...
要在清单中创建新任务，选择 **任务** 菜单栏上的 **新建**。 创建新任务时，您可以选择将任务添加到任务库中，以可以在多个清单之间共享。 只有当 **将任务应用于库** 选项设置为 **是** 时，您才能将任务添加到库中。 如果您将任务添加到任务库，您还可以通过在 **应用于清单** 部分选择这些清单将其同时添加到其他清单中。 如果您不将任务添加到库中，它只存在于您创建任务的清单中。
