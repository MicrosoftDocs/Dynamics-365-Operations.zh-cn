...
大多数 Dataverse 表支持自定义字段。 要获取完整的 Dataverse 表列表，请参阅 [Dataverse 表](https://docs.microsoft.com/dynamics365/human-resources/hr-developer-entities)。 

请确保启用您创建的任何自定义字段，以便可以在 Dataverse 中使用它们。 有关详细信息，请参阅[在数据实体上显示自定义字段](https://docs.microsoft.com/dynamics365/unified-operations/fin-and-ops/get-started/user-defined-fields#exposing-custom-fields-on-data-entities)。
