---
title: 管理概述
description: 本文提供了用于设置、管理 Dynamics 365 Human Resources 以及对其进行故障排除的帮助主题和其他资源的列表。
author: twheeloc
ms.date: 08/11/2021
ms.topic: overview
ms.prod: ''
...
本文提供了用于设置、管理 Dynamics 365 Human Resources 以及对其进行故障排除的帮助主题和其他资源的列表。
...
有关在线课程和培训，请查看 [Dynamics 365 Human Resources 学习路径](/training/browse/?products=dynamics-human-resources&resource_type=learning%20path)。
