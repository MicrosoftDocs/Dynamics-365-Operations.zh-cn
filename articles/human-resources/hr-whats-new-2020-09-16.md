...
description: 本文介绍 2020 年 9 月 16 日 Microsoft Dynamics 365 Human Resources 中的新增功能或更改的功能。
author: jcart1106
ms.date: 09/16/2020
ms.topic: article
ms.prod: ''
...
本文介绍 Dynamics 365 Human Resources 中的新增功能或更改的功能。 更改适用于内部版本号 8.1.3557。 部分功能旁边括号内的数字是 Lifecycle Services (LCS) 支持编号，以供参考。
