...
description: 本文介绍 2020 年 7 月 23 日 Microsoft Dynamics 365 Human Resources 中的新增功能或更改的功能。
...
本文介绍 Dynamics 365 Human Resources 中的新增功能或更改的功能。 更改适用于内部版本号 8.1.3416。 某些标题中括号内的数字是 LCS 支持号码，供您参考。
