...
1. 单击 **运行流程**。
    * **显示处理结果** 控件允许您在处理完成后查看完整的薪酬流程的处理消息。  
2. 在 **显示处理结果** 字段中，选择 **是**。
3. 单击 **确定**。
...
3. 在列表中，找到并选择所需记录。
4. 展开 **固定薪酬** 部分。
    * 展开快速选项卡以查看流程结果。 如果已为薪酬操作标记 **启用建议**，则可为该操作启用 **建议** 字段。  
5. 在列表中，找到并选择所需记录。
