...
description: 本文列出截止 2016 年 2 月发布到 Microsoft BPM 库的任务指南。
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8861725"
---
# <a name="new-task-guides-february-2016"></a>新任务指南（2016 年 2 月）

[!include [banner](../includes/banner.md)]

本文列出截止 2016 年 2 月发布到 Microsoft BPM 库的任务指南。 已发布的库包括 Microsoft Dynamics AX 的（2016 年 2 月）APQC 标准库和（2016 年 2 月）入门。
...
| MX-00020 – 为墨西哥银行帐号设定 RFC 注册号                                    | 墨西哥                          |
