...
本文介绍招聘人员可以用于跟踪招聘流程的步骤的概念，包括宣传空缺职位和招聘申请人的工作，跟踪申请人和申请信息，面试申请人，以及选择一个或多个候选人以填充您的组织的空缺职位。
...
招聘项目包含在 **员工自助服务** 页面上用于宣传空缺职位的 **工作广告** 值。 仅当招聘项目具有 **工作广告** 值、**在员工自助服务中显示** 字段设置为 **是**、**申请截止日期** 字段设置为一个将来的日期，并且招聘项目的 **项目状态** 值为 **已开始** 时，才会向员工显示空缺职位。 下表列出可能的招聘项目状态和描述。
...
申请人是申请您企业的工作的人员。 申请人在您组织中的所有法人之间被共享。 因此，您拥有大量可搜索的人才。 您可以维护申请人的能力、推荐人、住宿请求和个人信息。 在您创建申请人记录时，在全球通讯簿中创建该申请人的人员记录。 您可以使用 **申请人** 页为申请人的人员更新以下全球通讯簿信息：
...
申请的通信行为确定用于和提交申请的申请人交流的文档或电子邮件模板。 通过将 **申请书签** 与通信行为关联，您可以在与申请人的通信中使用 **申请**、**申请人**、**面试** 和 **招聘项目** 页面中的值。 通过为通信行为创建 **申请电子邮件模板**，您可以快速向其申请具有特定状态和通信行为组合的申请人发送电子邮件。 例如，您可以将确认电子邮件发送给 **状态** 值为 **已接收** 且 **通信行为** 值也为 **已接收** 的所有申请。 在发送电子邮件后，您可以选择自动更新申请状态。
