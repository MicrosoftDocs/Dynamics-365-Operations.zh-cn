...
- [使用部门、工作和职位组织您的员工](../../../human-resources/hr-personnel-departments-jobs-positions.md)
- [设置特定于公司的人力资源 (HR) 参数](../../../human-resources/hr-setup-parameters.md)
- [跨法人设置人力资源 (HR) 参数](../../../human-resources/hr-setup-shared-parameters.md)
...
- [大批雇用项目](../../../human-resources/hr-personnel-mass-hire-projects.md) 

雇用员工后，您可以制定计划来有效公平地管理薪酬以及管理您的组织借给员工的物品（如计算机或手机）。 您可以创建固定和可变的薪酬计划，并定义应用薪酬计划以满足该计划的条件的规则。

- [薪酬计划](../../../human-resources/hr-compensation-overview.md)
- [创建固定薪酬计划](../../../human-resources/hr-compensation-fixed-plans.md)
- [创建可变薪酬计划](../../../human-resources/hr-compensation-variable-plans.md)
...
- [绩效管理](../../../human-resources/hr-develop-performance-management-overview.md)
- [使劳动力技能符合业务需求](../../../human-resources/hr-develop-skills.md)
- [设置培训课程](../../../human-resources/hr-learning-courses.md)
...
- [定义和管理福利计划](../../../human-resources/hr-benefits-management-overview.md)
- [福利资格政策](../../../human-resources/hr-benefits-eligibility-policies.md)
- [管理借给工作人员的物品](../../../human-resources/hr-personnel-loan-items.md)
...
- [调查表](../../../human-resources/hr-learning-questionnaires.md)
- [设计调查表](../../../human-resources/hr-learning-design-questionnaires.md)
- [分发和计划调查表](../../../human-resources/hr-learning-distribute-questionnaires.md)
- [查看和评估调查表的结果](../../../human-resources/hr-learning-evaluate-questionnaire-results.md)
