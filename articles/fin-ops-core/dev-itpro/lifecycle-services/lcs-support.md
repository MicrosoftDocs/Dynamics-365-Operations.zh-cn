...
### <a name="finance-and-operations-apps-support"></a>Finance and Operations 应用程序支持
...
<li>使用 Finance and Operations 应用程序时出现的问题。</li>
</ul>
...
<tr class="odd">
<td>获取有关 Finance and Operations 应用程序许可问题的帮助。</td>
