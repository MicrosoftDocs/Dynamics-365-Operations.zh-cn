...
description: 本文介绍从 Dynamics 365 for Finance and Operations 和早期版本中已经删除或曾经计划删除的功能。
author: sericks007
ms.date: 02/16/2021
ms.topic: article
ms.prod: ''
...
> [!IMPORTANT]
> 本文不再更新。 若要查看已经从财务和运营应用删除或弃用的功能的当前列表，请搜索与您在使用的应用有关的 **“已删除或弃用的功能”** 内容。

本文介绍从 Dynamics 365 for Finance and Operations 和该产品的早期版本已经删除或弃用的功能。
...
### <a name="blocklist-report-it--feature-reference-it-00001"></a>阻止列表报表 (IT) – 功能引用 IT-00001
...
| **影响的产品区域**         | Payroll |
| **部署选项**              | 所有 |
| **状态**                         | 已弃用：我们计划从 2024 年 7 月 31 日开始不再向美国工资单客户提供税更新。 此功能将保留在产品中，但是不再通过增强让此功能保持最新，并且将根据具体案例评估所有产品缺陷。 |

>[!NOTE]
> 这表示对原定 2021 年 10 月 1 日的停止日期进行了更改。 有关详细信息，请参阅 [Microsoft Dynamics 365 for Finance and Operations 中的美国工资单功能将停止税更新](https://aka.ms/financepayrollfaq)。
...
| **被另一个功能取代？**   | 否。 将始终启用用于支持具有多个融资来源且基于项目的销售订单的功能。   |
...
| **影响的产品区域**         | 产品信息管理 |
| **部署选项**              | 所有  |
| **状态**                         | 从具有平台更新 24 的 Finance and Operations 10.0.0 起移除。|
...
| **影响的产品区域**         | Visual Studio 开发工具 |
| **部署选项**              | 所有 |
| **状态**                         | 已弃用：在财务和运营应用版本 10.0.11 的平台更新中，此警告已成为编译时错误。 |
...
| **被另一个功能取代？**   | 否。 但是，我们计划在 2018 年春季之后恢复此功能，以利用新的建议服务。   |
...
|------------|--------------------|
| **弃用/移除的原因** | 有限使用                                                                            |
| **被另一个功能取代？**   | 否。 工具在未来版本中将被电子申报配置所取代。 |
| **影响的产品区域**         | 总帐                                                                           |
| **状态**                         | 已弃用：尚未确定此功能的移除日期。                           |
...
| **被另一个功能取代？**   | 否。 付款格式不再使用，被比利时的 ISO20022 贷方转帐付款格式所取代。 |
| **影响的产品区域**         | 应付帐款     |
| **状态**                         | 已弃用：尚未确定此功能的移除日期。    |
...
| **被另一个功能取代？**   | 否。 目标通过经理自助服务门户对经理可见，并且可由经理进行更改和查看。 |
| **影响的产品区域**         | 人力资本管理       |
| **状态**                         | 从 Dynamics 365 for Operations 版本 1611 开始移除。    |
...
| **被另一个功能取代？**   | 否。 在某些特定情况下，用户可以使用通用电子申报工具配置报表。 |
| **影响的产品区域**         | 会计帐簿    |
| **状态**                         | 已弃用：尚未确定此功能的移除日期。   |
