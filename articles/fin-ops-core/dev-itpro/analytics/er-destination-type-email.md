...
---
# <a name="EmailDestinationType">电子邮件目标</a>
...
[![配置电子邮件源帐户](./media/ER_Destinations-EmailDefineAddressSourceAttributes.png)](./media/ER_Destinations-EmailDefineAddressSourceAttributes.png)
