...
本文说明如何从配置服务的全局知识库下载[电子报告 (ER) 配置](general-electronic-reporting.md#Configuration)。 有关详细信息，请参阅 [Microsoft Dynamics 365 Finance - Regulatory Services、Configuration service](/business-applications-release-notes/october18/dynamics365-finance-operations/regulatory-service-configuration)。
