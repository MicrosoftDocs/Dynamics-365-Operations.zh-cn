...
description: 本文描述薪酬 Power BI 内容。 说明如何访问报表，并提供有关所用数据模型的信息。
author: jcart1106
ms.date: 12/19/2017
ms.topic: article
ms.prod: ''
