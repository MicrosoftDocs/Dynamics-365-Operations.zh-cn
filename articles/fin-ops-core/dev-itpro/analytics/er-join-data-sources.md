...
| 示例 **ER 模型映射** 配置文件，为示例实现 ER 数据模型。 | [Mapping to learn JOIN data sources.version.1.1.xml](https://user-images.githubusercontent.com/19827601/115923048-86b10400-a432-11eb-9e57-c37a02effcb4.png)|
