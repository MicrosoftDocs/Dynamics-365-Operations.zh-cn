---
title: 报表设计器界面
description: 本文介绍如何在 Report designer 内导航，以及如何使用各种选项以满足您的特定要求。
author: aprilolson
ms.date: 11/22/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9802734"
---
# <a name="report-designer-interface"></a>报表设计器界面

[!include [banner](../includes/banner.md)]

本文介绍如何在 Report designer 内导航，以及如何使用各种选项以满足您的特定要求。

## <a name="report-designer-menu-commands"></a>Report designer 菜单命令
...
| 舍入调整                    | 打开 **化整调整** 对话框，您可以在此对话框中指定化整的参数。 可从行定义中获取此命令。 |
...
| 列宽          | 打开 **列宽** 对话框，您可以在此对话框中设置所选列的宽度。 可从行定义、列定义或报告树定义获取此命令。 |
...
| 命令 | Description                                                              |
|---------|--------------------------------------------------------------------------|
| 帮助    | 打开 Financial Reporting 的帮助文章页。 |
|         |                                                                          |

## <a name="report-designer-toolbar-buttons"></a>Report designer 工具栏按钮
