...
本主题提供 Finance and Operations 应用与 Common Data Service 之间的双写入集成的常规故障排除信息。
...
4. 运行 **PackageDeployer.exe** 以选择 Common Data Service 环境并安装解决方案。

    ![“工具”文件夹的内容](media/paste_copied_files.png)

## <a name="enable-and-view-the-plug-in-trace-log-in-common-data-service-to-view-error-details"></a>在 Common Data Service 中启用和查看插件跟踪日志以查看错误详细信息
