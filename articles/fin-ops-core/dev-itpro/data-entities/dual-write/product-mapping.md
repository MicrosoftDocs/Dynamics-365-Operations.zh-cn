...
-----------------------|--------------------------------|---
[所有产品](mapping-reference.md#138) | msdyn_globalproducts | 所有产品表都包含 Finance and Operations 应用中可用的所有产品，包括已发放产品和未发放产品。
...
[已发布产品 V2](mapping-reference.md#189) | msdyn\_sharedproductdetails | **msdyn\_sharedproductdetails** 表包含来自 Finance and Operations 应用的列，这些列定义产品，并包含产品的财务和管理信息。
