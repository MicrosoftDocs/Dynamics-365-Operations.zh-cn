...
## <a name="initial-synchronization-of-units-data-matching-between-finance-and-operations-and-dataverse"></a>财务和运营与 Dataverse 之间的单位数据匹配的初始同步
...
为了唯一标识 Dynamics 365 Finance 和 Dataverse 中的产品之间的产品，使用了集成密钥。
