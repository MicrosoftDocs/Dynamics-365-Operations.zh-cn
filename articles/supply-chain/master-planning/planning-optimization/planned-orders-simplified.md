...
**计划订单简化** 页面主要提供确认功能。 它显示为所选计划生成的所有计划订单，就像标准 **计划订单** 页面一样。 因此，它可以用作优化的备选项，用于查看主计划运行的结果。

要打开 **计划订单简化** 页面，请转到 **主计划 \> 主计划 \> 计划订单简化**。 您可以使用此页面完成以下任务：
...
- 确认单个或多个计划订单。
- 更改单个或多个计划订单的计划订单状态。
- 无缝打开单个计划订单的计划订单详细信息，以查看订单的完整详细信息。
- 使用已保存视图创建自定义视图。

标准 **计划订单** 页面支持其他场景（如拆分）。
