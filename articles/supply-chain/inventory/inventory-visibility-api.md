...
| /api/environment/{environmentId}/onhand/indexquery | 获取 | [使用过帐方法查询](#query-with-post-method) |
| /api/environment/{environmentId}/onhand/indexquery | 过帐 | [使用获取方法查询](#query-with-get-method) |
