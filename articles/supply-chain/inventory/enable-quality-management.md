---
title: 启用质量和不符合项管理
description: 本文概述了在 Microsoft Dynamics 365 Supply Chain Management 中设置和配置质量和不符合项管理功能的流程。
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
本文概述了在 Microsoft Dynamics 365 Supply Chain Management 中设置和配置质量和不符合项管理功能的流程。
