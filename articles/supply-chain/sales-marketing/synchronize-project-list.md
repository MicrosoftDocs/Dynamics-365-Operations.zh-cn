...
description: 本文介绍用于同步 Dynamics 365 Supply Chain Management 与 Dynamics 365 Field Service 的项目的模板和基础任务。
author: Henrikan
ms.date: 03/13/2019
ms.topic: article
ms.prod: ''
...
本文介绍用于同步 Dynamics 365 Supply Chain Management 与 Dynamics 365 Field Service 的项目的模板和基础任务。
