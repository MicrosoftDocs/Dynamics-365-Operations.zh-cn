...
[![数据集成中的模板映射，库存调整（Field Service 到 Supply Chain Management）：库存调整。](./media/FSAdj1.png)](./media/FSAdj1.png)
...
[![数据集成中的模板映射，库存转移（Field Service 到 Supply Chain Management）：库存转移。](./media/FSTrans1.png)](./media/FSTrans1.png)
