...
description: 本文介绍用于将产品从 Dynamics 365 Supply Chain Management 同步到 Dynamics 365 Sales 的模板和基础任务。
author: Henrikan
ms.date: 06/10/2019
ms.topic: article
ms.prod: ''
...
本文介绍用于将产品直接从 Dynamics 365 Supply Chain Management 同步到 Dynamics 365 Sales 的模板和基础任务。
