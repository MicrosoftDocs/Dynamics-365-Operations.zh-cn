...
# <a name="delivery-schedules"></a><span data-ttu-id="dc59c-103">交货计划</span><span class="sxs-lookup"><span data-stu-id="dc59c-103">Delivery schedules</span></span>

[!include [banner](../includes/banner.md)]

<span data-ttu-id="dc59c-104">当您为单个销售订单、销售报价单或采购订单使用多个交货时，可利用交货计划跟踪订单行数量。</span><span class="sxs-lookup"><span data-stu-id="dc59c-104">Delivery schedules allow you to track order line quantity when you are using multiple deliveries for a single sales order, sales quotation, or purchase order.</span></span>

<span data-ttu-id="dc59c-105">在请求在多个装运中交付订单或报价单上的数量时，使用交货计划。</span><span class="sxs-lookup"><span data-stu-id="dc59c-105">Use a delivery schedule when the total quantity on an order or quotation line must be delivered in multiple shipments.</span></span> <span data-ttu-id="dc59c-106">单独的装运由交货行表示。</span><span class="sxs-lookup"><span data-stu-id="dc59c-106">Individual shipments are represented by delivery lines.</span></span> <span data-ttu-id="dc59c-107">两个或多个交货行构成了一个交货计划。</span><span class="sxs-lookup"><span data-stu-id="dc59c-107">Two or more delivery lines make up one delivery schedule.</span></span> <span data-ttu-id="dc59c-108">交货行可以有不同的交货日期、数量、交货方式以及站点和仓库等存储维度。</span><span class="sxs-lookup"><span data-stu-id="dc59c-108">The delivery lines can have different delivery dates, quantities, modes of delivery, and storage dimensions, such as site and warehouse.</span></span>  

<span data-ttu-id="dc59c-109">**交货计划示例**</span><span class="sxs-lookup"><span data-stu-id="dc59c-109">**Example of a delivery schedule**</span></span>

|                                   |                                          |
|-----------------------------------|------------------------------------------|
| <span data-ttu-id="dc59c-110">总订单（原始订单行）</span><span class="sxs-lookup"><span data-stu-id="dc59c-110">Total order (original order line)</span></span> | <span data-ttu-id="dc59c-111">600 把椅子</span><span class="sxs-lookup"><span data-stu-id="dc59c-111">600 chairs</span></span>                               |
| <span data-ttu-id="dc59c-112">请求的交货计划</span><span class="sxs-lookup"><span data-stu-id="dc59c-112">Requested delivery schedule</span></span>       | <span data-ttu-id="dc59c-113">每月 100 把椅子</span><span class="sxs-lookup"><span data-stu-id="dc59c-113">100 chairs per month</span></span>                     |
| <span data-ttu-id="dc59c-114">请求的交货时间范围</span><span class="sxs-lookup"><span data-stu-id="dc59c-114">Requested time frame for delivery</span></span> | <span data-ttu-id="dc59c-115">6 个月，在每个月的第一天</span><span class="sxs-lookup"><span data-stu-id="dc59c-115">6 months, on the first day of each month</span></span> |
...
-   <span data-ttu-id="dc59c-133">浏览列表页和报表</span><span class="sxs-lookup"><span data-stu-id="dc59c-133">Browse list pages and reports</span></span>

<span data-ttu-id="dc59c-134">当您确认销售报价单时，生成的销售订单显示整个交货计划，甚至是具有多个交货的订单行。</span><span class="sxs-lookup"><span data-stu-id="dc59c-134">When you confirm sales quotations, the resulting sales orders show the whole delivery schedule, even the order lines that have multiple deliveries.</span></span> <span data-ttu-id="dc59c-135">此外，整个交货计划都显示在所有主要页面上，如销售订单、销售报价单和采购订单。</span><span class="sxs-lookup"><span data-stu-id="dc59c-135">In addition, the whole delivery schedule is shown on all the major pages, such as sales orders, sales quotations, and purchase orders.</span></span>
