...
ms.locfileid: "7860709"
---
# <a name="saleshistorycleanupperformanceimprovements"></a>销售历史记录清除性能改进
...
## <a name="turn-on-the-saleshistorycleanupperformanceimprovements-feature"></a>打开销售历史记录清理性能改进功能
