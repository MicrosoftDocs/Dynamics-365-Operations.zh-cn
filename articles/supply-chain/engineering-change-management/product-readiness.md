...
当您根据工程类别创建新产品时，您将同时创建 *已发布产品* 和相关的 *共享产品*。 解决已发布产品的就绪策略的方式取决于您的系统是否启用了 *产品就绪情况检查* 功能（请参阅本主题后面的[标准产品的就绪情况检查](#standard-products)一节了解有关此功能以及如何打开或关闭它的详细信息）。
