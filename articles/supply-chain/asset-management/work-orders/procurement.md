...
**工作订单采购申请列表** 页（**资产管理** > **采购** > **工作订单采购申请**）显示与工作订单关联的采购申请的列表。 在此页面上选择工作订单作业时，可以使用 **工作订单采购申请** 操作窗格选项卡上 **显示** 组中的按钮来执行各个操作：
...
**工作订单采购** 列表页（**资产管理** > **采购** > **工作订单采购申请**）显示与工作订单关联的采购订单的列表。 在此页面上选择工作订单作业时，可以使用操作窗格的 **工作订单采购** 选项卡上 **显示** 组中的按钮来执行各个操作：
