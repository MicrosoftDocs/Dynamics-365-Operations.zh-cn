---
title: 工作订单和固定资产
description: 本文介绍资产管理中的工作订单和固定资产。
...
在资产管理中，可将资产与固定资产关联，还可以为这些资产创建工作订单。 如果使用此功能，则可在财务和运营应用内 **项目管理与核算** 和 **固定资产** 模块中获取固定资产、关联的投资项目和为投资项目登记的所有成本的完整概览。
