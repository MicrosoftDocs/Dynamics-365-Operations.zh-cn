---
title: 根据维护请求创建工作订单
description: 本文说明如何在资产管理中根据维护请求创建工作订单。
...
创建了维护请求之后，可将其轻松转化为工作订单。 本文介绍处理维护请求，同时更新多个维护请求，然后同时为多个维护请求创建一个工作订单的最快方法。 在 **有效维护请求** 或 **我的功能位置维护请求** 页，也可以一次处理一个维护请求，并将一个维护请求转化为工作订单。
