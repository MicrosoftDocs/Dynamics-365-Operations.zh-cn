---
title: 客户拥有资产维护工作的计费
description: 本文说明如何创建、处理以及为完成的客户拥有资产维护工作计费。
...
若要使用此处指定的示例记录和值完成此场景，使用的系统中必须已安装标准[演示数据](../../../fin-ops-core/fin-ops/get-started/demo-data.md)。 开始前，必须选择 **USMF** 法人。
