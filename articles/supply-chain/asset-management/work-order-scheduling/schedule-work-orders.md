...
工作订单的所需工时数的定义方法是预测工时数之和减去过帐工时数。 如果需要更多时间，必须相应调整预测。 在**资产管理** > **常用** > **工作订单** > **所有工作订单**或**有效工作订单**中，可以查看或编辑工作订单的预测，方法是在**工作订单**选项卡上选择工作订单，然后单击**预测**。创建工作订单并估计之后，下一步完成工作订单是分配所需维护工人和工具。
