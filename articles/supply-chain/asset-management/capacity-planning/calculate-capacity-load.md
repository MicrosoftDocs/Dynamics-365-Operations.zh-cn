---
title: 计算产能负荷
description: 本文介绍如何在资产管理中计算产能负荷。
...
1. 单击 **资产管理** > **查询** > **产能负荷**，或 **资产管理** > **工作订单池** > **所有工作订单池** / **有效的工作订单池** > 在列表中选择工作订单池 > **产能负荷按钮** 按钮，或 **资产管理** > **维护停机时间活动** > **活动所有维护停机时间活动** / **有效的维护停机时间活动** > 在列表中选择维护活动 > **产能负荷** 按钮。
