...
## <a name="associate-product-lifecycle-states-to-released-products"></a><span data-ttu-id="790f4-115">将产品生命周期状态关联到发布的产品</span><span class="sxs-lookup"><span data-stu-id="790f4-115">Associate product lifecycle states to released products</span></span>  

<span data-ttu-id="790f4-116">有多种方式将产品生命周期状态关联到发布的产品或产品变型。</span><span class="sxs-lookup"><span data-stu-id="790f4-116">There are multiple ways to associate a product lifecycle state to released products or product variants.</span></span>

-  <span data-ttu-id="790f4-117">在创建新发布产品时，自动分配默认的**产品生命周期状态**。</span><span class="sxs-lookup"><span data-stu-id="790f4-117">On creation of a new released product, the default **Product lifecycle state** is automatically assigned.</span></span> 
-  <span data-ttu-id="790f4-118">在将产品发布到法人时，自动分配默认的**产品生命周期状态**。</span><span class="sxs-lookup"><span data-stu-id="790f4-118">On release of a product to a legal entity, the default **Product lifecycle state** is automatically assigned.</span></span> 
-  <span data-ttu-id="790f4-119">在将产品变型发布到法人时，与该法人中的已发布产品变型关联的**产品生命周期状态**自动分配到新的变型。</span><span class="sxs-lookup"><span data-stu-id="790f4-119">On release of a product variant to a legal entity, the **Product lifecycle state** associated to the released product master in this legal entity is automatically assigned to the new variant.</span></span> 

<span data-ttu-id="790f4-120">您可以使用以下方式手动更新产品生命周期状态：</span><span class="sxs-lookup"><span data-stu-id="790f4-120">You can manually update the product lifecycle state by using:</span></span> 

-    <span data-ttu-id="790f4-121">**已发布产品**列表页或**详细信息视图**。</span><span class="sxs-lookup"><span data-stu-id="790f4-121">The **Released products** list page or **Details view**.</span></span> 
-  <span data-ttu-id="790f4-122">**已发布的产品变型**列表页或**详细信息视图**。</span><span class="sxs-lookup"><span data-stu-id="790f4-122">The **Released product variants** list page or **Details view**.</span></span> 
-  <span data-ttu-id="790f4-123">基于需求查找过时的产品或产品变型并关联生命周期状态。</span><span class="sxs-lookup"><span data-stu-id="790f4-123">Find the obsolete products or product variants based on demand and associate a lifecycle state.</span></span>  

<span data-ttu-id="790f4-124">有关如何关联产品生命周期状态的详细信息，请播放或阅读以下两个任务指南。</span><span class="sxs-lookup"><span data-stu-id="790f4-124">For detailed information about how to associate product lifecycle states, play or read the following two task guides.</span></span>

-  <span data-ttu-id="790f4-125">要将产品生命周期状态关联到已发布的基础产品，请播放或阅读任务指南**对已发布的基础产品分配产品生命周期状态**。</span><span class="sxs-lookup"><span data-stu-id="790f4-125">To associate a product lifecycle state to a released product master, play or read the task guide **Assign a product lifecycle state to a released product master**.</span></span> 

-  <span data-ttu-id="790f4-126">要将产品生命周期状态关联到发布产品，请播放或阅读任务指南**对已发布的产品分配产品生命周期状态**。</span><span class="sxs-lookup"><span data-stu-id="790f4-126">To associate a product lifecycle state to a release product, play or read the task guide **Assign a product lifecycle state to a released product**.</span></span> 

## <a name="impact-on-master-planning"></a><span data-ttu-id="790f4-127">对主计划的影响</span><span class="sxs-lookup"><span data-stu-id="790f4-127">Impact on master planning</span></span> 

<span data-ttu-id="790f4-128">产品生命周期状态只有一个控制标志：**对于计划有效**。</span><span class="sxs-lookup"><span data-stu-id="790f4-128">The product lifecycle state has only one control flag: **Is active for planning**.</span></span> <span data-ttu-id="790f4-129">默认情况下对所有创建的产品生命周期状态设置为**是**，但可以更改为**否**。</span><span class="sxs-lookup"><span data-stu-id="790f4-129">By default, this is set to **Yes** for all created product lifecycle states, but it can be changed to **No**.</span></span> <span data-ttu-id="790f4-130">设置为**否**时，关联的已发布产品或已发布产品变型为：</span><span class="sxs-lookup"><span data-stu-id="790f4-130">When set to **No**, the associated released products or released product variants are:</span></span> 

-  <span data-ttu-id="790f4-131">从主计划排除。</span><span class="sxs-lookup"><span data-stu-id="790f4-131">Excluded from master planning.</span></span> 
-  <span data-ttu-id="790f4-132">从物料清单级别计算中排除。</span><span class="sxs-lookup"><span data-stu-id="790f4-132">Excluded from BOM-level calculation.</span></span> 

<span data-ttu-id="790f4-133">有关如何使用产品生命周期状态从主计划和物料清单级别计算中排除产品的详细信息，请播放或阅读任务指南**创建产品生命周期状态以从主计划中排除产品**。</span><span class="sxs-lookup"><span data-stu-id="790f4-133">For detailed information about how to use product lifecycle state to exclude products from master planning and BOM-level calculation, play or read the task guide **Create a product lifecycle state to exclude products from Master planning**.</span></span>
...
-  <span data-ttu-id="790f4-153">产品或产品变型基于您在选择对话框中输入的天数提前几天创建。</span><span class="sxs-lookup"><span data-stu-id="790f4-153">The product or product variant was created some days ago based on the number of days that you enter in the selection dialog box.</span></span> 
-  <span data-ttu-id="790f4-154">没有针对该产品或产品变型的开放生产订单（= 状态 < 已结束）。</span><span class="sxs-lookup"><span data-stu-id="790f4-154">There are no open production orders (= status < ended) for the product or product variant.</span></span> 
-  <span data-ttu-id="790f4-155">没有针对该产品或产品变型的开放库存交易记录（= 状态发货 ReservPhysical 到 QuotationIssue 或状态收货已登记到 QuotationReceipt）。</span><span class="sxs-lookup"><span data-stu-id="790f4-155">There are no open inventory transactions (= status issue ReservPhysical to QuotationIssue or status receipt Registrered to QuotationReceipt) for the product or product variant.</span></span> 
-  <span data-ttu-id="790f4-156">在过去几天内没有针对该产品或产品变型的库存交易记录。</span><span class="sxs-lookup"><span data-stu-id="790f4-156">There are no inventory transactions within the last number of days for the product or product variant.</span></span> 
-  <span data-ttu-id="790f4-157">没有针对该产品或产品变型的未来需求或供应预测。</span><span class="sxs-lookup"><span data-stu-id="790f4-157">There is no future demand or supply forecast for the product or product variant.</span></span>  
-  <span data-ttu-id="790f4-158">在物料覆盖范围中没有针对该产品或产品变型设定最低存货水平。</span><span class="sxs-lookup"><span data-stu-id="790f4-158">No minimum stock level has been set in item coverage for the product or product variant.</span></span> 
-  <span data-ttu-id="790f4-159">没有针对该产品或产品变型的有效固定数量看板规则。</span><span class="sxs-lookup"><span data-stu-id="790f4-159">No active fixed quantity kanban rule for the product or product variant.</span></span>  
-  <span data-ttu-id="790f4-160">没有针对该产品或产品变型的服务订单行。</span><span class="sxs-lookup"><span data-stu-id="790f4-160">No service order line for the product or product variant.</span></span> 
-  <span data-ttu-id="790f4-161">没有针对该产品或产品变型的活跃或未来销售或购买协议行。</span><span class="sxs-lookup"><span data-stu-id="790f4-161">No active or future sales or purchase agreement lines for the product or product variant.</span></span> 
-  <span data-ttu-id="790f4-162">产品或产品变型在与对于计划有效的产品或变型的未过期的已核准的物料清单版本关联的物料清单中不使用。</span><span class="sxs-lookup"><span data-stu-id="790f4-162">The product or product variant is not used in a BOM that is associated with a non-expired approved BOM version for a product or variant that is active for planning.</span></span>

## <a name="related-topics"></a><span data-ttu-id="790f4-163">相关主题</span><span class="sxs-lookup"><span data-stu-id="790f4-163">Related topics</span></span>

-  [<span data-ttu-id="790f4-164">创建新产品生命周期状态（任务指南）</span><span class="sxs-lookup"><span data-stu-id="790f4-164">Create a new product lifecycle state (Task guide)</span></span>](tasks/new-product-lifecycle-state.md)
-  [<span data-ttu-id="790f4-165">创建默认产品生命周期状态（任务指南）</span><span class="sxs-lookup"><span data-stu-id="790f4-165">Create a default product lifecycle state (Task guide)</span></span>](tasks/default-product-lifecycle-state.md)
-  [<span data-ttu-id="790f4-166">对已发布的基础产品分配产品生命周期状态（任务指南）</span><span class="sxs-lookup"><span data-stu-id="790f4-166">Assign a product lifecycle state to a released product master (Task guide)</span></span>](tasks/product-lifecycle-state-released-product-master.md)
-  [<span data-ttu-id="790f4-167">对已发布的产品分配产品生命周期状态（任务指南）</span><span class="sxs-lookup"><span data-stu-id="790f4-167">Assign a product lifecycle state to a released product (Task guide)</span></span>](tasks/product-lifecycle-state-released-product.md)
-  [<span data-ttu-id="790f4-168">查找过时的产品变型并分配产品生命周期状态（任务指南）</span><span class="sxs-lookup"><span data-stu-id="790f4-168">Find obsolete product variants and assign a product lifecycle state (Task guide)</span></span>](tasks/obsolete-product-variants.md)
-  [<span data-ttu-id="790f4-169">创建产品生命周期状态以从主计划中排除产品（任务指南）</span><span class="sxs-lookup"><span data-stu-id="790f4-169">Create a product lifecycle state to exclude products from Master planning (Task guide)</span></span>](tasks/exclude-products-master-planning.md)
