...
description: 本文介绍 Dynamics 365 Supply Chain Management 10.0.11 中的新增功能或更改的功能。
author: kamaybac
ms.date: 04/17/2020
ms.topic: article
ms.prod: ''
...
本文列出了 Microsoft Dynamics 365 Supply Chain Management 10.0.11 中的新增或更改的功能。 此版本的构建版本号为 10.0.464，并以下面的形式提供：
...
Microsoft Dynamics 365 Supply Chain Management 10.0.11 中包含平台更新。 要了解详细信息，请参阅[财务和运营应用版本 10.0.11 的平台更新（2020 年 7 月）](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-35.md)。
