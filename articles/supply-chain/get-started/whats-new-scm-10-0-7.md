...
此主题介绍了 Microsoft Dynamics 365 Supply Chain Management 10.0.7 中的新增功能或更改的功能。 此版本的构建版本号为 10.0.283，并以下面的形式提供：

- 预览版本在 2019 年 10 月。
- 正式发布（自行更新）在 2019 年 11 月。
- 自动更新在 2020 年 1 月。 

有关版本 10.0.7 的详细信息，请参阅[其他资源](whats-new-scm-10-0-7.md#additional-resources)。
