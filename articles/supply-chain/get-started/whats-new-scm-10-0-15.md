...
此主题列出了 Microsoft Dynamics 365 Supply Chain Management 版本 10.0.15 中的新增或更改的功能。 此版本的构建版本号为 10.0.644，并以下面的形式提供：
...
Microsoft Dynamics 365 Supply Chain Management 10.0.15 中包含平台更新。 若要了解详细信息，请参阅 [Finance and Operations 应用版本 10.0.15 的平台更新（2020 年 10 月）](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-15.md)。
