...
description: 本文介绍 Dynamics 365 Supply Chain Management 10.0.15 中的新增功能或更改的功能。
author: kamaybac
ms.date: 10/13/2020
ms.topic: article
ms.prod: ''
...
本文列出了 Microsoft Dynamics 365 Supply Chain Management 版本 10.0.15 中的新增或更改的功能。 此版本的构建版本号为 10.0.644，并以下面的形式提供：
...
Microsoft Dynamics 365 Supply Chain Management 10.0.15 中包含平台更新。 要了解详细信息，请参阅[财务和运营应用版本 10.0.15 的平台更新（2020 年 10 月）](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-15.md)。

### <a name="bug-fixes"></a>缺陷修复

有关 10.0.15 中各更新内的缺陷修复的信息，请登录 Lifecycle Services (LCS)，然后查看[知识库文章](https://fix.lcs.dynamics.com/Issue/Details?bugId=514518&dbType=3&qc=8fbe12733a7e1aa197e91fb11530f69fa89b9b39c08d89a19873f755c9430988)。
