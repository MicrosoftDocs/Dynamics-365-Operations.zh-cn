...
description: 本文介绍 Dynamics 365 Supply Chain Management 10.0.8 中的新增功能或更改的功能。
author: kamaybac
ms.date: 01/23/2020
ms.topic: article
ms.prod: ''
...
本文列出了 Microsoft Dynamics 365 Supply Chain Management 10.0.8 中的新增或更改的功能。 此版本的构建版本号为 10.0.319，并以下面的形式提供：
