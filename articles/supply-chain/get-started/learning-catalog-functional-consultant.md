...
| [使用 Success by Design for Dynamics 365 解决方案](/learn/paths/use-success-design/) | FastTrack for Dynamics 365 旨在帮助客户和合作伙伴成功部署 Dynamics 365 解决方案。 若要提供此服务，解决方案架构师应使用 Success by Design。 此学习路径讨论 Success by Design 概念。 | 自由、自定进度的在线学习路径 | 12 小时 |
| [实施财务和运营应用](/learn/paths/implement-finance-operations/) | 学习管理成功的财务和运营实施项目最重要的元素和最佳实践。 从计划和设计项目方法的第一步、使用 FastTrack 服务、开发策略、数据管理等等，一直到上线后维护和监视运营的最佳方法。 | 自由、自定进度的在线学习路径 | 11.5 小时 |
...
| 内容 | 说明 | 格式 | 长度 |
|---------|-------------|--------|--------|
| [在 Dynamics 365 Supply Chain Management 中配置和管理产品和库存](/learn/paths/configure-manage-products-inventory-dyn365-supply-chain-mgmt/) | 产品信息是跨所有行业的供应链和零售应用程序的核心。 在不同的业务解决方案模块中，需要产品的特定信息和配置以管理与产品、产品系列、物料清单和产品类别有关的业务流程。 库存报告通过多种方式向您显示库存量，并说明如何提高库存投入的效率。 主计划将帮助您基于预先确定的因素简化计划，让您可以高效地计划需要购买、运输或生产哪些材料。 | 自由、自定进度的在线学习路径 | 14 小时 |
| [在 Dynamics 365 Supply Chain Management 中配置和管理采购和供应商](/learn/paths/configure-manage-procurement-vendors-dyn365-supply-chain-mgmt/) | 查找供应商和与供货商合作，采购产品，以及确保货物和服务的质量全部都是会影响公司声誉和成功的重要因素的过程。 | 自由、自定进度的在线学习路径 | 14 小时 |
| [在 Dynamics 365 Supply Chain Management 中配置和管理销售和客户](/learn/paths/configure-manage-sales-customers-dyn365-supply-chain-mgmt/) | 与客户合作、了解销售流程的生命周期以及制定销售协议的过程都是影响公司成功的重要因素。 | 自由、自定进度的在线学习路径 | 7 小时 |
| [Dynamics 365 Supply Chain Management 中的主计划](/learn/paths/master-planning-supply-chain-management/) | 主计划允许公司标识和平衡满足将来目标所需的原材料和产能。 主计划评估当前可用的原材料和产能，以及完成生产所需的原材料和产能。 例如，它标识必须进行哪些制造、采购、转移或留出安全库存才能完成生产。 | 自由、自定进度的在线学习路径 | 5 小时 |
| [在 Dynamics 365 for Finance and Operations 中配置和使用仓库管理](/learn/paths/configure-work-warehouse-management-dyn365-supply-chain-mgmt/) | Dynamics 365 Supply Chain Management 中的仓库管理可根据您的单独需要帮助组织和简化仓库流程，还可以提供对您的仓库和工具的见解来帮助提高客户满意度和降低成本。 | 自由、自定进度的在线学习路径 | 8.5 小时 |
