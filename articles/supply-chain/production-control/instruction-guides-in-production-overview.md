...
- **Common Data Service 子域** - 此字段应该已显示一个值。 此字段保留创建指南的 Common Data Service 环境的子域。 子域是 URL 的第一部分，通常以您的组织命名。 例如，如果您的 Common Data Service URL 是“contoso.crm4.dynamics.com”，您应该在此处输入 *contoso* 。 此值用于构成指南的地址，并将编码为 QR 码。
