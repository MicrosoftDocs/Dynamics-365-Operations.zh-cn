...
description: 本文在 Dynamics 365 for Finance and Operations 中提供 lean manufacturing 功能的概览和描述。
...
ms.locfileid: "1562384"
---
# <a name="lean-manufacturing-overview"></a>Lean manufacturing 概览

[!include [banner](../includes/banner.md)]

本文在 Microsoft Dynamics 365 for Finance and Operations 中提供 lean manufacturing 功能的概览和描述。
