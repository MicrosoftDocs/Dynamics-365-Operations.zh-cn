...
您可以在**默认订单设置**页面上定义默认订单设置。 要打开此页面，请转到**计划**上的**产品信息管理** &gt; **产品** &gt; **已发布产品** &gt; **选择已发布产品** &gt;。 您也可以转到**管理库存** &gt; **订单设置** &gt; **默认订单设置**。
...
要创建特定站点的订单设置，选择**新建**。 在**详细信息视图**中，在**适用于以下对象的设置** &gt; **站点**字段中填写站点。 在**网格视图**中，在**站点**一列中填写站点。 新规则将自动获取高于零的新等级值。 您可以视需要创建任意数量的特定站点的规则，然后为所有特定站点的规则分配相同的等级，表示它们同等重要。 
