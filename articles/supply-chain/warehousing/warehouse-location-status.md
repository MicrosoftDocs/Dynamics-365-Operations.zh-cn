...
## <a name="turn-the-warehouse-location-status-feature-on-or-off"></a>打开或关闭“仓库位置状态”功能

要使用此功能，必须为您的系统打开它。 从 Supply Chain Management 版本 10.0.29 开始，此功能是强制性的，无法关闭。 如果您运行的版本早于 10.0.29，管理员可以通过在 [功能管理](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md)工作区中搜索 *仓库位置状态* 功能来打开或关闭此功能。
