...
1. 根据要创建的波次类型，执行以下操作之一：
    ...
    - 转到 **仓库管理** \> **出站波次** \> **装运波次** \> **所有波次**。 在操作窗格上，选择 **波次**。
    - 转到 **仓库管理** \> **出站波次** \> **生产波次** \> **所有生产波次**。 在操作窗格上，选择 **生产波次**。
    - 转到 **仓库管理** \> **出站波次** \> **看板波次** \> **所有看板波次**。 在操作窗格上，选择 **创建波次**。
...
1. 根据要处理的波次类型，执行以下操作之一：
    ...
    - 选择 **仓库管理** \> **出站波次** \> **装运波次** \> **所有波次**。 在操作窗格上，选择 **波次**。
    - 选择 **仓库管理** \> **出站波次** \> **生产波次** \> **所有生产波次**。 在操作窗格上，选择 **生产波次**。
    - 选择 **仓库管理** \> **出站波次** \> **看板波次** \> **所有看板波次**。 在操作窗格上，选择 **创建波次**。
...
1. 根据要取消的波次类型，执行以下操作之一：
      ...
      - 转到 **仓库管理** \> **出站波次** \> **装运波次** \> **所有波次**。
      - 转到 **仓库管理** \> **出站波次** \> **生产波次** \> **所有生产波次**。
      - 转到 **仓库管理** \> **出站波次** \> **看板波次** \> **所有看板波次**。
...
要使用此功能，必须为您的系统打开它。 从 Supply Chain Management 版本 10.0.25 开始，此功能默认开启。 从 Supply Chain Management 版本 10.0.29 开始，此功能是强制性的，无法关闭。 如果您运行的版本早于 10.0.29，管理员可以通过在 [功能管理](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md)工作区中搜索 *波次批处理作业详细信息* 功能来打开或关闭此功能。
