...
ms.locfileid: "859751"
---
# <a name="warehouse-mobile-device-display-settings"></a>仓库移动设备显示设置

[!include [banner](../includes/banner.md)]

> [!NOTE]
> 已弃用此功能。 有关详细信息，请参阅[已删除或弃用的功能](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal)。
