...
### <a name="make-sure-that-the-wave-label-method-is-available"></a><span data-ttu-id="44afa-144">确保波次标签方法可用</span><span class="sxs-lookup"><span data-stu-id="44afa-144">Make sure that the wave label method is available</span></span>
...
1. <span data-ttu-id="44afa-159">创建一个具有以下设置的记录：</span><span class="sxs-lookup"><span data-stu-id="44afa-159">Create a record that has the following settings:</span></span>
    ...
    - <span data-ttu-id="44afa-160">**标签布局 ID**：*Carton*</span><span class="sxs-lookup"><span data-stu-id="44afa-160">**Label layout ID:** *Carton*</span></span>
...
1. <span data-ttu-id="44afa-180">在查询编辑器对话框的 **范围** 选项卡上，添加具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-180">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="44afa-181">**表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-181">**Table:** *Work lines*</span></span>
...
1. <span data-ttu-id="44afa-201">转到 **仓库管理 \> 设置 \> 文档路线布局 \> 波次标签类型**。</span><span class="sxs-lookup"><span data-stu-id="44afa-201">Go to **Warehouse management \> Setup \> Document routing \> Wave label types**.</span></span>
...
1. <span data-ttu-id="44afa-219">在 **波次标签模板详细信息** 快速选项卡上，添加具有以下设置的新行：</span><span class="sxs-lookup"><span data-stu-id="44afa-219">On the **Wave label template details** FastTab, add a new row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="44afa-220">**标签布局 ID**：*Carton*</span><span class="sxs-lookup"><span data-stu-id="44afa-220">**Label layout ID:** *Carton*</span></span>
...
1. <span data-ttu-id="44afa-254">添加两个具有以下设置的销售订单行：</span><span class="sxs-lookup"><span data-stu-id="44afa-254">Add two sales order lines that have the following settings:</span></span>
    ...
    - <span data-ttu-id="44afa-259">销售订单行 2：</span><span class="sxs-lookup"><span data-stu-id="44afa-259">Sales order line 2:</span></span>
        ...
        - <span data-ttu-id="44afa-260">\**物料编号：\*\*\*A0002*</span><span class="sxs-lookup"><span data-stu-id="44afa-260">**Item number:** *A0002*</span></span>
...
- <span data-ttu-id="44afa-280">所有装运 \> 装运详细信息</span><span class="sxs-lookup"><span data-stu-id="44afa-280">All shipments \> Shipment details</span></span>
...
### <a name="make-demo-data-available"></a><span data-ttu-id="44afa-297">提供演示数据</span><span class="sxs-lookup"><span data-stu-id="44afa-297">Make demo data available</span></span>
...
1. <span data-ttu-id="44afa-312">转到 **仓库管理 \> 设置 \> 文档路线布局 \> 波次标签布局**。</span><span class="sxs-lookup"><span data-stu-id="44afa-312">Go to **Warehouse management \> Setup \> Document routing \> Wave label layouts**.</span></span>
...
1. <span data-ttu-id="44afa-333">关闭该页面。</span><span class="sxs-lookup"><span data-stu-id="44afa-333">Close the page.</span></span>
...
1. <span data-ttu-id="44afa-347">在 **主体部分** 的 **标签页脚** 字段中，输入所需页脚的 ZPL 代码。</span><span class="sxs-lookup"><span data-stu-id="44afa-347">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="44afa-348">下面是一个示例。</span><span class="sxs-lookup"><span data-stu-id="44afa-348">Here is an example.</span></span>
...
1. <span data-ttu-id="44afa-364">在操作窗格上，选择 **保存**。</span><span class="sxs-lookup"><span data-stu-id="44afa-364">On the Action Pane, select **Save**.</span></span>
...
1. <span data-ttu-id="44afa-382">添加五个销售订单行：</span><span class="sxs-lookup"><span data-stu-id="44afa-382">Add five sales order lines:</span></span>
...
1. <span data-ttu-id="44afa-404">在“操作窗格”上的 **仓库** 选项卡上，选择 **发放到仓库**。</span><span class="sxs-lookup"><span data-stu-id="44afa-404">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>
    ...
    <span data-ttu-id="44afa-405">将发生以下事件：</span><span class="sxs-lookup"><span data-stu-id="44afa-405">The following events occur:</span></span>
...
<span data-ttu-id="44afa-422">此方案演示端到端流。</span><span class="sxs-lookup"><span data-stu-id="44afa-422">This scenario shows the end-to-end flow.</span></span>
...
### <a name="create-three-wave-label-layouts"></a><span data-ttu-id="44afa-439">创建三个波次标签布局</span><span class="sxs-lookup"><span data-stu-id="44afa-439">Create three wave label layouts</span></span>
...
1. <span data-ttu-id="44afa-445">在操作窗格上，选择 **波次标签行设置**。</span><span class="sxs-lookup"><span data-stu-id="44afa-445">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="44afa-446">**波次标签行设置** 页面将出现。</span><span class="sxs-lookup"><span data-stu-id="44afa-446">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="44afa-447">在这里，您可以配置标签的动态部分。</span><span class="sxs-lookup"><span data-stu-id="44afa-447">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="44afa-448">添加具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-448">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-449">**行 ID**：*WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="44afa-449">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="44afa-450">**行表名称**：*WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="44afa-450">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="44afa-451">**行开始位置**：*0*</span><span class="sxs-lookup"><span data-stu-id="44afa-451">**Row start position:** *0*</span></span>

        <span data-ttu-id="44afa-452">此字段定义行在标签上开始的垂直位置。</span><span class="sxs-lookup"><span data-stu-id="44afa-452">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="44afa-453">**行高度**：*0*</span><span class="sxs-lookup"><span data-stu-id="44afa-453">**Row height:** *0*</span></span>

        <span data-ttu-id="44afa-454">此字段根据 ZPL 标准定义每行的高度（以磅为单位）。</span><span class="sxs-lookup"><span data-stu-id="44afa-454">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="44afa-455">行高度对于水平标签为正，对于垂直标签为负。</span><span class="sxs-lookup"><span data-stu-id="44afa-455">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="44afa-456">在此示例中因为只有一行，所以您可以将此值设置为 *0*（零）。</span><span class="sxs-lookup"><span data-stu-id="44afa-456">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="44afa-457">**每页行数**：*1*</span><span class="sxs-lookup"><span data-stu-id="44afa-457">**Rows per page:** *1*</span></span>

        <span data-ttu-id="44afa-458">此字段定义可以在每个标签上打印的行数。</span><span class="sxs-lookup"><span data-stu-id="44afa-458">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="44afa-459">使用此设置，将为波次标签表中的每个记录打印一个单独的 ZPL 标签。</span><span class="sxs-lookup"><span data-stu-id="44afa-459">This setup will cause a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="44afa-460">关闭该页面。</span><span class="sxs-lookup"><span data-stu-id="44afa-460">Close the page.</span></span>
1. <span data-ttu-id="44afa-461">在操作窗格上，选择 **编辑查询**。</span><span class="sxs-lookup"><span data-stu-id="44afa-461">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="44afa-462">在查询编辑器对话框的 **范围** 选项卡上，添加具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-462">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-463">**表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-463">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-464">**派生表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-464">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-465">**字段**：*工作类型*</span><span class="sxs-lookup"><span data-stu-id="44afa-465">**Field:** *Work type*</span></span>
    - <span data-ttu-id="44afa-466">**条件**：*领料*</span><span class="sxs-lookup"><span data-stu-id="44afa-466">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="44afa-467">此查询可确保在标签上仅打印领料类型的工作行，不打印放置类型的工作行。</span><span class="sxs-lookup"><span data-stu-id="44afa-467">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="44afa-468">如果您希望能够打印提单 ID，请在 **联接** 选项卡上，选择 **工作行** 表，然后将 **装运** 表与其联接。</span><span class="sxs-lookup"><span data-stu-id="44afa-468">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span> 
1. <span data-ttu-id="44afa-469">关闭查询编辑器对话框。</span><span class="sxs-lookup"><span data-stu-id="44afa-469">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="44afa-470">**打印机文本布局** 快速选项卡有三个部分，您可以在其中编写打印机代码：**页眉部分**、**主体部分** 和 **页脚部分**。</span><span class="sxs-lookup"><span data-stu-id="44afa-470">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="44afa-471">在 **页眉部分** 的 **标签页眉** 字段中，输入所需页眉的代码。</span><span class="sxs-lookup"><span data-stu-id="44afa-471">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="44afa-472">例如，如果您使用的是 Zebra 打印机，可以使用以下代码。</span><span class="sxs-lookup"><span data-stu-id="44afa-472">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="44afa-473">在 **主体部分** 的 **标签主体** 字段中，输入所需主体的 ZPL 代码。</span><span class="sxs-lookup"><span data-stu-id="44afa-473">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="44afa-474">下面是一个示例。</span><span class="sxs-lookup"><span data-stu-id="44afa-474">Here is an example.</span></span>
...
1. <span data-ttu-id="44afa-475">在 **主体部分** 的 **标签页脚** 字段中，输入所需页脚的 ZPL 代码。</span><span class="sxs-lookup"><span data-stu-id="44afa-475">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="44afa-476">下面是一个示例。</span><span class="sxs-lookup"><span data-stu-id="44afa-476">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="44afa-477">此设置将打印每个标签的一个副本。</span><span class="sxs-lookup"><span data-stu-id="44afa-477">This setup will print one copy of each label.</span></span> <span data-ttu-id="44afa-478">如果需要更多副本（例如，托盘每一面一个副本），请将页脚中 **\^PQn** 部分的 **n** 值设置为所需的副本数。</span><span class="sxs-lookup"><span data-stu-id="44afa-478">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="44afa-479">例如，每个标签要打印四个副本，请指定 **\^PQ4**。</span><span class="sxs-lookup"><span data-stu-id="44afa-479">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="44afa-480">第一个标签现在可以使用了。</span><span class="sxs-lookup"><span data-stu-id="44afa-480">The first label is now ready to use.</span></span>
1. <span data-ttu-id="44afa-481">创建具有以下设置的第二个布局记录：</span><span class="sxs-lookup"><span data-stu-id="44afa-481">Create a second layout record that has the following settings:</span></span>

    - <span data-ttu-id="44afa-482">**标签布局 ID**：*Pallet*</span><span class="sxs-lookup"><span data-stu-id="44afa-482">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="44afa-483">**描述**：*托盘*</span><span class="sxs-lookup"><span data-stu-id="44afa-483">**Description:** *Pallet*</span></span>

1. <span data-ttu-id="44afa-484">在操作窗格上，选择 **保存**。</span><span class="sxs-lookup"><span data-stu-id="44afa-484">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="44afa-485">在操作窗格上，选择 **波次标签行设置**。</span><span class="sxs-lookup"><span data-stu-id="44afa-485">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="44afa-486">**波次标签行设置** 页面将出现。</span><span class="sxs-lookup"><span data-stu-id="44afa-486">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="44afa-487">在这里，您可以配置标签的动态部分。</span><span class="sxs-lookup"><span data-stu-id="44afa-487">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="44afa-488">添加具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-488">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-489">**行 ID**：*WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="44afa-489">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="44afa-490">**行表名称**：*WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="44afa-490">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="44afa-491">**行开始位置**：*0*</span><span class="sxs-lookup"><span data-stu-id="44afa-491">**Row start position:** *0*</span></span>

        <span data-ttu-id="44afa-492">此字段定义行在标签上开始的垂直位置。</span><span class="sxs-lookup"><span data-stu-id="44afa-492">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="44afa-493">**行高度**：*0*</span><span class="sxs-lookup"><span data-stu-id="44afa-493">**Row height:** *0*</span></span>

        <span data-ttu-id="44afa-494">此字段根据 ZPL 标准定义每行的高度（以磅为单位）。</span><span class="sxs-lookup"><span data-stu-id="44afa-494">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="44afa-495">行高度对于水平标签为正，对于垂直标签为负。</span><span class="sxs-lookup"><span data-stu-id="44afa-495">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="44afa-496">在此示例中因为只有一行，所以您可以将此值设置为 *0*（零）。</span><span class="sxs-lookup"><span data-stu-id="44afa-496">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="44afa-497">**每页行数**：*1*</span><span class="sxs-lookup"><span data-stu-id="44afa-497">**Rows per page:** *1*</span></span>

        <span data-ttu-id="44afa-498">此字段定义可以在每个标签上打印的行数。</span><span class="sxs-lookup"><span data-stu-id="44afa-498">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="44afa-499">使用此设置，将为波次标签表中的每个记录打印一个单独的 ZPL 标签。</span><span class="sxs-lookup"><span data-stu-id="44afa-499">This setup causes a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="44afa-500">关闭该页面。</span><span class="sxs-lookup"><span data-stu-id="44afa-500">Close the page.</span></span>
1. <span data-ttu-id="44afa-501">在操作窗格上，选择 **编辑查询**。</span><span class="sxs-lookup"><span data-stu-id="44afa-501">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="44afa-502">在查询编辑器对话框的 **范围** 选项卡上，添加具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-502">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-503">**表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-503">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-504">**派生表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-504">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-505">**字段**：*工作类型*</span><span class="sxs-lookup"><span data-stu-id="44afa-505">**Field:** *Work type*</span></span>
    - <span data-ttu-id="44afa-506">**条件**：*领料*</span><span class="sxs-lookup"><span data-stu-id="44afa-506">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="44afa-507">此查询可确保在标签上仅打印领料类型的工作行，不打印放置类型的工作行。</span><span class="sxs-lookup"><span data-stu-id="44afa-507">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="44afa-508">如果您希望能够打印提单 ID，请在 **联接** 选项卡上，选择 **工作行** 表，然后将 **装运** 表与其联接。</span><span class="sxs-lookup"><span data-stu-id="44afa-508">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span>
1. <span data-ttu-id="44afa-509">关闭查询编辑器对话框。</span><span class="sxs-lookup"><span data-stu-id="44afa-509">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="44afa-510">**打印机文本布局** 快速选项卡有三个部分，您可以在其中编写打印机代码：**页眉部分**、**主体部分** 和 **页脚部分**。</span><span class="sxs-lookup"><span data-stu-id="44afa-510">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="44afa-511">在 **页眉部分** 的 **标签页眉** 字段中，输入所需页眉的代码。</span><span class="sxs-lookup"><span data-stu-id="44afa-511">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="44afa-512">例如，如果您使用的是 Zebra 打印机，可以使用以下代码。</span><span class="sxs-lookup"><span data-stu-id="44afa-512">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="44afa-513">在 **主体部分** 的 **标签主体** 字段中，输入所需主体的 ZPL 代码。</span><span class="sxs-lookup"><span data-stu-id="44afa-513">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="44afa-514">下面是一个示例。</span><span class="sxs-lookup"><span data-stu-id="44afa-514">Here is an example.</span></span>
...
1. <span data-ttu-id="44afa-515">在 **主体部分** 的 **标签页脚** 字段中，输入所需页脚的 ZPL 代码。</span><span class="sxs-lookup"><span data-stu-id="44afa-515">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="44afa-516">下面是一个示例。</span><span class="sxs-lookup"><span data-stu-id="44afa-516">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="44afa-517">此设置将打印每个标签的一个副本。</span><span class="sxs-lookup"><span data-stu-id="44afa-517">This setup will print one copy of each label.</span></span> <span data-ttu-id="44afa-518">如果需要更多副本（例如，托盘每一面一个副本），请将页脚中 **\^PQn** 部分的 **n** 值设置为所需的副本数。</span><span class="sxs-lookup"><span data-stu-id="44afa-518">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="44afa-519">例如，每个标签要打印四个副本，请指定 **\^PQ4**。</span><span class="sxs-lookup"><span data-stu-id="44afa-519">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="44afa-520">第二个标签现在可以使用了。</span><span class="sxs-lookup"><span data-stu-id="44afa-520">The second label is now ready to use.</span></span>
1. <span data-ttu-id="44afa-521">创建具有以下设置的第三个布局记录：</span><span class="sxs-lookup"><span data-stu-id="44afa-521">Create a third layout record that has the following settings:</span></span>

    - <span data-ttu-id="44afa-522">**标签布局 ID**：*Break*</span><span class="sxs-lookup"><span data-stu-id="44afa-522">**Label layout ID:** *Break*</span></span>
    - <span data-ttu-id="44afa-523">**描述**：*中断标签*</span><span class="sxs-lookup"><span data-stu-id="44afa-523">**Description:** *Break label*</span></span>

1. <span data-ttu-id="44afa-524">在操作窗格上，选择 **保存**。</span><span class="sxs-lookup"><span data-stu-id="44afa-524">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="44afa-525">**打印机文本布局** 快速选项卡有三个部分，您可以在其中编写打印机代码：**页眉部分**、**主体部分** 和 **页脚部分**。</span><span class="sxs-lookup"><span data-stu-id="44afa-525">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="44afa-526">在 **页眉部分** 的 **标签页眉** 字段中，输入所需页眉的 ZPL 代码。</span><span class="sxs-lookup"><span data-stu-id="44afa-526">In the **Header section** section, in the **Label header** field, enter ZPL code for the required header.</span></span> <span data-ttu-id="44afa-527">下面是一个示例。</span><span class="sxs-lookup"><span data-stu-id="44afa-527">Here is an example.</span></span>
...
1. <span data-ttu-id="44afa-528">这次，不需要人工。</span><span class="sxs-lookup"><span data-stu-id="44afa-528">This time, no body is required.</span></span> <span data-ttu-id="44afa-529">因此，只需在 **页脚部分** 部分输入所需文本。</span><span class="sxs-lookup"><span data-stu-id="44afa-529">Therefore, just enter the required text in the **Footer section** section.</span></span> <span data-ttu-id="44afa-530">下面是一个示例。</span><span class="sxs-lookup"><span data-stu-id="44afa-530">Here is an example.</span></span>

    ```plaintext
    ^XZ
    ```

    <span data-ttu-id="44afa-531">第三个标签现在可以使用了。</span><span class="sxs-lookup"><span data-stu-id="44afa-531">The third label is now ready to use.</span></span>

    > [!NOTE]
    > <span data-ttu-id="44afa-532">第三个标签是中断标签，将用作标签卷之间的分界。</span><span class="sxs-lookup"><span data-stu-id="44afa-532">This third label is a break label that will be used as a divider between label rolls.</span></span>

### <a name="create-two-wave-label-types"></a><span data-ttu-id="44afa-533">创建两个波次标签类型</span><span class="sxs-lookup"><span data-stu-id="44afa-533">Create two wave label types</span></span>

1. <span data-ttu-id="44afa-534">转到 **仓库管理 \> 设置 \> 文档路线布局 \> 波次标签类型**。</span><span class="sxs-lookup"><span data-stu-id="44afa-534">Go to **Warehouse management \> Setup \> Document routing \> Wave label types**.</span></span>
1. <span data-ttu-id="44afa-535">创建一个具有以下设置的记录：</span><span class="sxs-lookup"><span data-stu-id="44afa-535">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="44afa-536">**标签类型**：*货箱*</span><span class="sxs-lookup"><span data-stu-id="44afa-536">**Label type:** *Carton*</span></span>
    - <span data-ttu-id="44afa-537">**描述**：*货箱*</span><span class="sxs-lookup"><span data-stu-id="44afa-537">**Description:** *Carton*</span></span>

1. <span data-ttu-id="44afa-538">创建具有以下设置的第二个记录：</span><span class="sxs-lookup"><span data-stu-id="44afa-538">Create a second record that has the following settings:</span></span>

    - <span data-ttu-id="44afa-539">**标签类型**：*托盘*</span><span class="sxs-lookup"><span data-stu-id="44afa-539">**Label type:** *Pallet*</span></span>
    - <span data-ttu-id="44afa-540">**描述**：*托盘*</span><span class="sxs-lookup"><span data-stu-id="44afa-540">**Description:** *Pallet*</span></span>

### <a name="set-up-unit-sequence-groups"></a><span data-ttu-id="44afa-541">设置单位序列组</span><span class="sxs-lookup"><span data-stu-id="44afa-541">Set up unit sequence groups</span></span>

1. <span data-ttu-id="44afa-542">转到 **仓库管理 \> 设置 \> 仓库 \> 单位序列组**。</span><span class="sxs-lookup"><span data-stu-id="44afa-542">Go to **Warehouse management \> Setup \> Warehouse \> Unit sequence groups**.</span></span>
1. <span data-ttu-id="44afa-543">选择或创建一个 **Ea Box PL** 组。</span><span class="sxs-lookup"><span data-stu-id="44afa-543">Select or create an **Ea Box PL** group.</span></span>
1. <span data-ttu-id="44afa-544">对于 **箱** 行，将 **波次级别类型** 字段设置为 *货箱*。</span><span class="sxs-lookup"><span data-stu-id="44afa-544">For the **Box** line, set the **Wave level type** field to *Carton*.</span></span>
1. <span data-ttu-id="44afa-545">对于 **托盘** 行，将 **波次级别类型** 字段设置为 *托盘*。</span><span class="sxs-lookup"><span data-stu-id="44afa-545">For the **PL** line, set the **Wave level type** field to *Pallet*.</span></span>

### <a name="create-wave-label-templates"></a><span data-ttu-id="44afa-546">创建波次标签模板</span><span class="sxs-lookup"><span data-stu-id="44afa-546">Create wave label templates</span></span>

1. <span data-ttu-id="44afa-547">转到 **仓库管理 \> 设置 \> 文档路线布局 \> 波次标签模板**。</span><span class="sxs-lookup"><span data-stu-id="44afa-547">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
1. <span data-ttu-id="44afa-548">创建具有以下设置的标签模板：</span><span class="sxs-lookup"><span data-stu-id="44afa-548">Create a label template that has the following settings:</span></span>

    - <span data-ttu-id="44afa-549">**标签模板名称**：*货箱标签*</span><span class="sxs-lookup"><span data-stu-id="44afa-549">**Label template name:** *Carton labels*</span></span>
    - <span data-ttu-id="44afa-550">**描述**：*货箱标签*</span><span class="sxs-lookup"><span data-stu-id="44afa-550">**Description:** *Carton labels*</span></span>
    - <span data-ttu-id="44afa-551">**波次步骤代码**：*Carton*</span><span class="sxs-lookup"><span data-stu-id="44afa-551">**Wave step code:** *Carton*</span></span>
    - <span data-ttu-id="44afa-552">**仓库**：*62*</span><span class="sxs-lookup"><span data-stu-id="44afa-552">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="44afa-553">在 **常规** 快速选项卡上，在 **波次标签类型** 字段中，选择一个值，如 *货箱*。</span><span class="sxs-lookup"><span data-stu-id="44afa-553">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Carton*.</span></span>
1. <span data-ttu-id="44afa-554">在 **波次标签模板详细信息** 快速选项卡上，添加具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-554">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-555">**标签布局 ID**：*Carton*</span><span class="sxs-lookup"><span data-stu-id="44afa-555">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="44afa-556">**打印机名称：** 选择适当的 ZPL 打印机。</span><span class="sxs-lookup"><span data-stu-id="44afa-556">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="44afa-557">**运行查询**：*是*（此设置是可选的，但建议使用此设置以获得最佳性能。）</span><span class="sxs-lookup"><span data-stu-id="44afa-557">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="44afa-558">在操作窗格上，选择 **保存**。</span><span class="sxs-lookup"><span data-stu-id="44afa-558">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="44afa-559">可选：如果要设置客户特定的标签设计，则必须创建查询来查找客户的帐户。</span><span class="sxs-lookup"><span data-stu-id="44afa-559">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="44afa-560">在 **波次标签模板详细信息** 快速选项卡上，选择 **编辑查询**。</span><span class="sxs-lookup"><span data-stu-id="44afa-560">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="44afa-561">然后，在查询编辑器对话框的 **范围** 选项卡上，添加具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-561">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-562">**表**：*装运*</span><span class="sxs-lookup"><span data-stu-id="44afa-562">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="44afa-563">**派生表**：*装运*</span><span class="sxs-lookup"><span data-stu-id="44afa-563">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="44afa-564">**字段**：*帐号*</span><span class="sxs-lookup"><span data-stu-id="44afa-564">**Field:** *Account number*</span></span>
    - <span data-ttu-id="44afa-565">**条件：** 输入相关的客户帐号。</span><span class="sxs-lookup"><span data-stu-id="44afa-565">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="44afa-566">完成后，选择 **确定** 关闭查询编辑器对话框。</span><span class="sxs-lookup"><span data-stu-id="44afa-566">When you've finished, select **OK** to close the query editor dialog box.</span></span>

1. <span data-ttu-id="44afa-567">在操作窗格上，选择 **编辑查询** 打开整个标签模板的查询编辑器对话框。</span><span class="sxs-lookup"><span data-stu-id="44afa-567">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="44afa-568">在查询编辑器对话框的 **排序** 选项卡上，添加具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-568">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-569">**表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-569">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-570">**派生表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-570">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-571">**字段**：*参考负荷行 ID（记录 ID）*</span><span class="sxs-lookup"><span data-stu-id="44afa-571">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="44afa-572">**搜索方向**：*升序*</span><span class="sxs-lookup"><span data-stu-id="44afa-572">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="44afa-573">再添加一个具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-573">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-574">**表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-574">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-575">**派生表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-575">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-576">**字段**：*装运 ID*</span><span class="sxs-lookup"><span data-stu-id="44afa-576">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="44afa-577">**搜索方向**：*升序*</span><span class="sxs-lookup"><span data-stu-id="44afa-577">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="44afa-578">选择 **确定** 关闭查询编辑器对话框。</span><span class="sxs-lookup"><span data-stu-id="44afa-578">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="44afa-579">一个消息框将提示您确认分组重置操作。</span><span class="sxs-lookup"><span data-stu-id="44afa-579">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="44afa-580">选择 **是** 继续。</span><span class="sxs-lookup"><span data-stu-id="44afa-580">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="44afa-581">在操作窗格上，选择 **波次标签模板组**。</span><span class="sxs-lookup"><span data-stu-id="44afa-581">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="44afa-582">在 **波次标签模板组** 对话框中，对于 **参考字段名称** 字段设置为 *装运 ID* 的行，设置以下值：</span><span class="sxs-lookup"><span data-stu-id="44afa-582">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="44afa-583">**打印中断标签：** 选择此复选框。</span><span class="sxs-lookup"><span data-stu-id="44afa-583">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="44afa-584">**标签布局 ID：** 选择一个中断标签。</span><span class="sxs-lookup"><span data-stu-id="44afa-584">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="44afa-585">（例如，选择您在此方案中先前创建的 *中断* 标签布局。）</span><span class="sxs-lookup"><span data-stu-id="44afa-585">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="44afa-586">**打印机名称：** 选择中断标签的打印机。</span><span class="sxs-lookup"><span data-stu-id="44afa-586">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="44afa-587">（通常，出于分割标签券的目的，您应该选择在 **波次标签模板详细信息** 上选择的同一台打印机。</span><span class="sxs-lookup"><span data-stu-id="44afa-587">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="44afa-588">但也可能是其他情况。）</span><span class="sxs-lookup"><span data-stu-id="44afa-588">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="44afa-589">对于将 **参考字段名称** 字段设置为 *参考负荷行 ID* 的行，选择 **标签生成 ID** 复选框。</span><span class="sxs-lookup"><span data-stu-id="44afa-589">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="44afa-590">无论工作分组设置如何，此设置都会在整个波次中为每个负荷行创建一个标签序列（“货箱 1/X”）。</span><span class="sxs-lookup"><span data-stu-id="44afa-590">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="44afa-591">此标签序列可以打印在标签布局上。</span><span class="sxs-lookup"><span data-stu-id="44afa-591">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="44afa-592">此外，不同装运的标签将由选定的中断标签分隔。</span><span class="sxs-lookup"><span data-stu-id="44afa-592">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

1. <span data-ttu-id="44afa-593">选择 **确定** 关闭 **波次标签模板组** 对话框。</span><span class="sxs-lookup"><span data-stu-id="44afa-593">Select **OK** to close the **Wave label template group** dialog box.</span></span>
1. <span data-ttu-id="44afa-594">再创建一个具有以下设置的标签模板：</span><span class="sxs-lookup"><span data-stu-id="44afa-594">Create a second label template that has the following settings:</span></span>

    - <span data-ttu-id="44afa-595">**标签模板名称**：*托盘标签*</span><span class="sxs-lookup"><span data-stu-id="44afa-595">**Label template name:** *Pallet labels*</span></span>
    - <span data-ttu-id="44afa-596">**描述**：*托盘标签*</span><span class="sxs-lookup"><span data-stu-id="44afa-596">**Description:** *Pallet labels*</span></span>
    - <span data-ttu-id="44afa-597">**波次步骤代码**：*Pallet*</span><span class="sxs-lookup"><span data-stu-id="44afa-597">**Wave step code:** *Pallet*</span></span>
    - <span data-ttu-id="44afa-598">**仓库**：*62*</span><span class="sxs-lookup"><span data-stu-id="44afa-598">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="44afa-599">在 **常规** 快速选项卡上，在 **波次标签类型** 字段中，选择一个值，如 *托盘*。</span><span class="sxs-lookup"><span data-stu-id="44afa-599">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Pallet*.</span></span>
1. <span data-ttu-id="44afa-600">在 **波次标签模板详细信息** 快速选项卡上，添加具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-600">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-601">**标签布局 ID**：*Pallet*</span><span class="sxs-lookup"><span data-stu-id="44afa-601">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="44afa-602">**打印机名称：** 选择适当的 ZPL 打印机。</span><span class="sxs-lookup"><span data-stu-id="44afa-602">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="44afa-603">**运行查询**：*是*（此设置是可选的，但建议使用此设置以获得最佳性能。）</span><span class="sxs-lookup"><span data-stu-id="44afa-603">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="44afa-604">在操作窗格上，选择 **保存**。</span><span class="sxs-lookup"><span data-stu-id="44afa-604">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="44afa-605">可选：如果要设置客户特定的标签设计，则必须创建查询来查找客户的帐户。</span><span class="sxs-lookup"><span data-stu-id="44afa-605">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="44afa-606">在 **波次标签模板详细信息** 快速选项卡上，选择 **编辑查询**。</span><span class="sxs-lookup"><span data-stu-id="44afa-606">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="44afa-607">然后，在查询编辑器对话框的 **范围** 选项卡上，添加具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-607">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-608">**表**：*装运*</span><span class="sxs-lookup"><span data-stu-id="44afa-608">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="44afa-609">**派生表**：*装运*</span><span class="sxs-lookup"><span data-stu-id="44afa-609">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="44afa-610">**字段**：*帐号*</span><span class="sxs-lookup"><span data-stu-id="44afa-610">**Field:** *Account number*</span></span>
    - <span data-ttu-id="44afa-611">**条件：** 输入相关的客户帐号。</span><span class="sxs-lookup"><span data-stu-id="44afa-611">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="44afa-612">完成后，选择 **确定** 关闭查询编辑器对话框。</span><span class="sxs-lookup"><span data-stu-id="44afa-612">When you've finished, select **OK** to close the query editor dialog box.</span></span> 

1. <span data-ttu-id="44afa-613">在操作窗格上，选择 **编辑查询** 打开整个标签模板的查询编辑器对话框。</span><span class="sxs-lookup"><span data-stu-id="44afa-613">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="44afa-614">在查询编辑器对话框的 **排序** 选项卡上，添加具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-614">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-615">**表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-615">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-616">**派生表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-616">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-617">**字段**：*参考负荷行 ID（记录 ID）*</span><span class="sxs-lookup"><span data-stu-id="44afa-617">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="44afa-618">**搜索方向**：*升序*</span><span class="sxs-lookup"><span data-stu-id="44afa-618">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="44afa-619">再添加一个具有以下设置的行：</span><span class="sxs-lookup"><span data-stu-id="44afa-619">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="44afa-620">**表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-620">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-621">**派生表**：*工作行*</span><span class="sxs-lookup"><span data-stu-id="44afa-621">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="44afa-622">**字段**：*装运 ID*</span><span class="sxs-lookup"><span data-stu-id="44afa-622">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="44afa-623">**搜索方向**：*升序*</span><span class="sxs-lookup"><span data-stu-id="44afa-623">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="44afa-624">选择 **确定** 关闭查询编辑器对话框。</span><span class="sxs-lookup"><span data-stu-id="44afa-624">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="44afa-625">一个消息框将提示您确认分组重置操作。</span><span class="sxs-lookup"><span data-stu-id="44afa-625">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="44afa-626">选择 **是** 继续。</span><span class="sxs-lookup"><span data-stu-id="44afa-626">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="44afa-627">在操作窗格上，选择 **波次标签模板组**。</span><span class="sxs-lookup"><span data-stu-id="44afa-627">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="44afa-628">在 **波次标签模板组** 对话框中，对于 **参考字段名称** 字段设置为 *装运 ID* 的行，设置以下值：</span><span class="sxs-lookup"><span data-stu-id="44afa-628">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="44afa-629">**打印中断标签：** 选择此复选框。</span><span class="sxs-lookup"><span data-stu-id="44afa-629">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="44afa-630">**标签布局 ID：** 选择一个中断标签。</span><span class="sxs-lookup"><span data-stu-id="44afa-630">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="44afa-631">（例如，选择您在此方案中先前创建的 *中断* 标签布局。）</span><span class="sxs-lookup"><span data-stu-id="44afa-631">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="44afa-632">**打印机名称：** 选择中断标签的打印机。</span><span class="sxs-lookup"><span data-stu-id="44afa-632">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="44afa-633">（通常，出于分割标签券的目的，您应该选择在 **波次标签模板详细信息** 上选择的同一台打印机。</span><span class="sxs-lookup"><span data-stu-id="44afa-633">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="44afa-634">但也可能是其他情况。）</span><span class="sxs-lookup"><span data-stu-id="44afa-634">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="44afa-635">对于将 **参考字段名称** 字段设置为 *参考负荷行 ID* 的行，选择 **标签生成 ID** 复选框。</span><span class="sxs-lookup"><span data-stu-id="44afa-635">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="44afa-636">无论工作分组设置如何，此设置都会在整个波次中为每个负荷行创建一个标签序列（“货箱 1/X”）。</span><span class="sxs-lookup"><span data-stu-id="44afa-636">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="44afa-637">此标签序列可以打印在标签布局上。</span><span class="sxs-lookup"><span data-stu-id="44afa-637">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="44afa-638">此外，不同装运的标签将由选定的中断标签分隔。</span><span class="sxs-lookup"><span data-stu-id="44afa-638">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="44afa-639">配置编号规则扩展</span><span class="sxs-lookup"><span data-stu-id="44afa-639">Configure number sequence extensions</span></span>

<span data-ttu-id="44afa-640">编号规则扩展控制特定编号规则的 GS1 符合性。</span><span class="sxs-lookup"><span data-stu-id="44afa-640">Number sequence extensions control the GS1 compliance of specific number sequences.</span></span> <span data-ttu-id="44afa-641">此配置对于当前方案是可选的。</span><span class="sxs-lookup"><span data-stu-id="44afa-641">This configuration is optional for the current scenario.</span></span> <span data-ttu-id="44afa-642">有关详细信息和配置说明，请参阅[配置编号规则扩展](../warehousing/configure-number-sequence-extensions.md)。</span><span class="sxs-lookup"><span data-stu-id="44afa-642">For more information and configuration instructions, see [Configure number sequence extensions](../warehousing/configure-number-sequence-extensions.md).</span></span>

### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="44afa-643">创建销售订单并将其下达到仓库</span><span class="sxs-lookup"><span data-stu-id="44afa-643">Create a sales order and release it to the warehouse</span></span>

1. <span data-ttu-id="44afa-644">转到 **销售和营销 \> 销售订单 \> 所有销售订单**。</span><span class="sxs-lookup"><span data-stu-id="44afa-644">Go to **Sales and marketing \> Sales order \> All sales orders**.</span></span>
1. <span data-ttu-id="44afa-645">创建具有以下设置的销售订单：</span><span class="sxs-lookup"><span data-stu-id="44afa-645">Create a sales order that has the following settings:</span></span>

    - <span data-ttu-id="44afa-646">**客户帐户**：*US-001*</span><span class="sxs-lookup"><span data-stu-id="44afa-646">**Customer account:** *US-001*</span></span>
    - <span data-ttu-id="44afa-647">**仓库**：*62*</span><span class="sxs-lookup"><span data-stu-id="44afa-647">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="44afa-648">添加两个销售订单行：</span><span class="sxs-lookup"><span data-stu-id="44afa-648">Add two sales order lines:</span></span>

    - <span data-ttu-id="44afa-649">销售订单行 1：</span><span class="sxs-lookup"><span data-stu-id="44afa-649">Sales order line 1:</span></span>

        - <span data-ttu-id="44afa-650">\**物料编号：\*\*\*A0001*</span><span class="sxs-lookup"><span data-stu-id="44afa-650">**Item number:** *A0001*</span></span>
        - <span data-ttu-id="44afa-651">**数量：** *9024*</span><span class="sxs-lookup"><span data-stu-id="44afa-651">**Quantity:** *9024*</span></span>
        - <span data-ttu-id="44afa-652">**单位**：*个* (9024 个 = 376 箱 = 47 PL)</span><span class="sxs-lookup"><span data-stu-id="44afa-652">**Unit:** *ea* (9024 ea = 376 Box = 47 PL)</span></span>

    - <span data-ttu-id="44afa-653">销售订单行 2：</span><span class="sxs-lookup"><span data-stu-id="44afa-653">Sales order line 2:</span></span>

        - <span data-ttu-id="44afa-654">\**物料编号：\*\*\*A0002*</span><span class="sxs-lookup"><span data-stu-id="44afa-654">**Item number:** *A0002*</span></span>
        - <span data-ttu-id="44afa-655">**数量：** *9016*</span><span class="sxs-lookup"><span data-stu-id="44afa-655">**Quantity:** *9016*</span></span>
        - <span data-ttu-id="44afa-656">**单位**：*个* (9016 个 = 322 箱 = 46 PL)</span><span class="sxs-lookup"><span data-stu-id="44afa-656">**Unit:** *ea* (9016 ea = 322 Box = 46 PL)</span></span>

    > [!NOTE]
    > <span data-ttu-id="44afa-657">此处提供的物料和数量仅是示例。</span><span class="sxs-lookup"><span data-stu-id="44afa-657">The items and quantities that are provided here are only examples.</span></span> <span data-ttu-id="44afa-658">它们必须使用您先前定义的单位序列组，必须为它们定义从 *个* 到 *箱* 再到 *PL* 的适当单位转换，并且它们在仓库 *62* 中必须有存货。</span><span class="sxs-lookup"><span data-stu-id="44afa-658">They must use the unit sequence group that you defined earlier, appropriate unit conversions from *ea* to *Box* to *PL* must be defined for them, and they must have stock in warehouse *62*.</span></span> <span data-ttu-id="44afa-659">有关详细信息，请参阅[度量单位和库存策略](unit-measure-stocking-policies.md)。</span><span class="sxs-lookup"><span data-stu-id="44afa-659">For more information, see [Unit of measure and stocking policies](unit-measure-stocking-policies.md).</span></span>

1. <span data-ttu-id="44afa-660">选择销售订单行 1。</span><span class="sxs-lookup"><span data-stu-id="44afa-660">Select sales order line 1.</span></span> <span data-ttu-id="44afa-661">然后，在 **销售订单行** 部分的 **库存** 菜单中，选择 **预留**。</span><span class="sxs-lookup"><span data-stu-id="44afa-661">Then, in the **Sales order line** section, on the **Inventory** menu, select **Reservations**.</span></span>
1. <span data-ttu-id="44afa-662">在 **预留** 页的操作窗格中，选择 **预留批次**，然后关闭页面。</span><span class="sxs-lookup"><span data-stu-id="44afa-662">On the **Reservation** page, on the Action Pane, select **Reserve lot**, and then close the page.</span></span>
1. <span data-ttu-id="44afa-663">对销售订单行 2 重复步骤 4 和 5。</span><span class="sxs-lookup"><span data-stu-id="44afa-663">Repeat steps 4 and 5 for sales order line 2.</span></span>
1. <span data-ttu-id="44afa-664">在“操作窗格”上的 **仓库** 选项卡上，选择 **发放到仓库**。</span><span class="sxs-lookup"><span data-stu-id="44afa-664">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>

    <span data-ttu-id="44afa-665">将发生以下事件：</span><span class="sxs-lookup"><span data-stu-id="44afa-665">The following events occur:</span></span> 

    - <span data-ttu-id="44afa-666">系统使用包含标签打印步骤的模板来处理创建的装运。</span><span class="sxs-lookup"><span data-stu-id="44afa-666">The system processes the created shipment by using the template that includes the label printing step.</span></span> <span data-ttu-id="44afa-667">标签布局将用于定义标签的格式，结果将是在标签模板中选择的打印机上打印的标签。</span><span class="sxs-lookup"><span data-stu-id="44afa-667">The label layout will be used to define the format of the label, and the result will be a label that is printed on the printer that is selected in the label template.</span></span>
    - <span data-ttu-id="44afa-668">波次标签将生成并打印。</span><span class="sxs-lookup"><span data-stu-id="44afa-668">Wave labels are generated and printed.</span></span> <span data-ttu-id="44afa-669">标签数量将等于货箱数量（在此示例中，行 1 是 376 箱标签，行 2 是 322 箱标签，行 1 是 47 PL 标签，行 2 是 47 PL 标签，以及两个具有装运 ID 的中断标签）。</span><span class="sxs-lookup"><span data-stu-id="44afa-669">The number of labels will equal the number of cartons (in this example, 376 Box labels for line 1, 322 Box labels for line 2, 47 PL labels for line 1, 47 PL labels for line 2, and two break labels that have the shipment ID).</span></span>
    - <span data-ttu-id="44afa-670">将为装运生成新提单 ID。</span><span class="sxs-lookup"><span data-stu-id="44afa-670">A new bill of lading ID is generated for the shipments.</span></span> <span data-ttu-id="44afa-671">如果您配置了数字序列扩展，波次标签 ID 将采用 **SSCC-18** 数字格式。</span><span class="sxs-lookup"><span data-stu-id="44afa-671">If you configured the number sequence extensions, the wave label IDs will follow the **SSCC-18** number format.</span></span> 

<span data-ttu-id="44afa-672">您可以从以下页面查看和重新打印波次标签：</span><span class="sxs-lookup"><span data-stu-id="44afa-672">You can view and reprint wave labels from the following pages:</span></span>

- <span data-ttu-id="44afa-673">所有装运 \> 装运详细信息</span><span class="sxs-lookup"><span data-stu-id="44afa-673">All shipments \> Shipment details</span></span>
- <span data-ttu-id="44afa-674">所有负荷 \> 负荷详细信息</span><span class="sxs-lookup"><span data-stu-id="44afa-674">All loads \> Load details</span></span>
- <span data-ttu-id="44afa-675">所有波次</span><span class="sxs-lookup"><span data-stu-id="44afa-675">All waves</span></span>
- <span data-ttu-id="44afa-676">波次标签</span><span class="sxs-lookup"><span data-stu-id="44afa-676">Wave labels</span></span>
- <span data-ttu-id="44afa-677">波次标签历史记录</span><span class="sxs-lookup"><span data-stu-id="44afa-677">Wave label history</span></span>

<span data-ttu-id="44afa-678">对于这些页面中的大多数页面，可以通过在“操作窗格”的 **装运** 选项卡上的 **相关信息** 组中选择 **波次标签** 来查找相关功能。</span><span class="sxs-lookup"><span data-stu-id="44afa-678">For most of these pages, you can find the relevant function by selecting **Wave labels** in the **Related information** group on the **Shipments** tab of the Action Pane.</span></span>
