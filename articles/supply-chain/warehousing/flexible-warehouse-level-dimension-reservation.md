...
## <a name="inventory-reservation-hierarchy"></a><span data-ttu-id="a48b8-107">库存预留层次结构</span><span class="sxs-lookup"><span data-stu-id="a48b8-107">Inventory reservation hierarchy</span></span>
...
## <a name="flexible-reservation-for-batch-tracked-items"></a><span data-ttu-id="a48b8-121">灵活地预留批次跟踪物料</span><span class="sxs-lookup"><span data-stu-id="a48b8-121">Flexible reservation for batch-tracked items</span></span>
...
<span data-ttu-id="a48b8-163">以下示例显示了端到端流。</span><span class="sxs-lookup"><span data-stu-id="a48b8-163">The following example shows the end-to-end flow.</span></span>
...
1. <span data-ttu-id="a48b8-177">使用以下值设置产品的三个主数据参数：</span><span class="sxs-lookup"><span data-stu-id="a48b8-177">Set the product's three master data parameters by using these values:</span></span>
    ...
    - <span data-ttu-id="a48b8-178">在**存储维度组**字段中，选择 **Ware**。</span><span class="sxs-lookup"><span data-stu-id="a48b8-178">In the **Storage dimension group** field, select **Ware**.</span></span>
...
### <a name="turn-on-flexible-license-plate-reservation"></a><span data-ttu-id="a48b8-282">开启“灵活牌照预留”</span><span class="sxs-lookup"><span data-stu-id="a48b8-282">Turn on flexible license plate reservation</span></span>
...
- <span data-ttu-id="a48b8-298">引用（仅支持*销售订单*值。）</span><span class="sxs-lookup"><span data-stu-id="a48b8-298">Reference (Only the *Sales order* value is supported.)</span></span>
...
1. <span data-ttu-id="a48b8-330">在**新建已发布产品**对话框中，设置以下值：</span><span class="sxs-lookup"><span data-stu-id="a48b8-330">In the **New released product** dialog box, set the following values:</span></span>
    ...
    - <span data-ttu-id="a48b8-331">**产品编号**：*Item1*</span><span class="sxs-lookup"><span data-stu-id="a48b8-331">**Product number:** *Item1*</span></span>
...
1. <span data-ttu-id="a48b8-344">调整下表中指定的新物料的现有库存量。</span><span class="sxs-lookup"><span data-stu-id="a48b8-344">Adjust the on-hand inventory of the new items as specified in the following table.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="a48b8-370">您必须创建两个牌照并使用允许混合物料的位置，如 *FL-010* 和 *FL-011*。</span><span class="sxs-lookup"><span data-stu-id="a48b8-370">You must create the two license plates and use locations that allow for mixed items, such as *FL-010* and *FL-011*.</span></span>
...
1. <span data-ttu-id="a48b8-390">选择**在 Microsoft Office 中打开**，选择**每个牌照的订单承诺预留**，然后下载文件。</span><span class="sxs-lookup"><span data-stu-id="a48b8-390">Select **Open in Microsoft Office**, select **Order-committed reservations per license plate**, and download the file.</span></span>
...
1. <span data-ttu-id="a48b8-419">在移动设备上，使用已选中**按牌照处理**复选框的菜单项完成领料和放置工作。</span><span class="sxs-lookup"><span data-stu-id="a48b8-419">On the mobile device, finish picking and putting the work by using a menu item where the **Handle by license plate** check box is selected.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="a48b8-420">**按牌照处理**功能可帮助您处理整个牌照。</span><span class="sxs-lookup"><span data-stu-id="a48b8-420">The **Handle by license plate** functionality helps you process the whole license plate.</span></span> <span data-ttu-id="a48b8-421">如果必须处理牌照的一部分，则无法使用此功能。</span><span class="sxs-lookup"><span data-stu-id="a48b8-421">If you must process part of the license plate, you can't use this functionality.</span></span>
    >
    > <span data-ttu-id="a48b8-422">我们建议您为每个牌照生成单独的工作。</span><span class="sxs-lookup"><span data-stu-id="a48b8-422">We recommend that you have separate work generated for each license plate.</span></span> <span data-ttu-id="a48b8-423">要达到此目的，使用**工作模板**页上的**工作标题分行符**功能。</span><span class="sxs-lookup"><span data-stu-id="a48b8-423">To achieve this result, use the **Work header breaks** feature on the **Work template** page.</span></span>

    <span data-ttu-id="a48b8-424">牌照 *LP02* 现在已为销售订单行领取，并放到*货架门*位置。</span><span class="sxs-lookup"><span data-stu-id="a48b8-424">License plate *LP02* is now picked for sales order lines and put to the *Baydoor* location.</span></span> <span data-ttu-id="a48b8-425">此时，可以将其装载并发往客户。</span><span class="sxs-lookup"><span data-stu-id="a48b8-425">At this point, it's ready to be loaded and dispatched to the customer.</span></span>

## <a name="exception-handling-of-warehouse-work-that-has-order-committed-batch-numbers"></a><span data-ttu-id="a48b8-426">具有订单承诺批号的仓库工作的异常处理</span><span class="sxs-lookup"><span data-stu-id="a48b8-426">Exception handling of warehouse work that has order-committed batch numbers</span></span>

<span data-ttu-id="a48b8-427">领取订单承诺批号的仓库工作与常规工作一样，都要接受相同的标准仓库异常处理和操作。</span><span class="sxs-lookup"><span data-stu-id="a48b8-427">Warehouse work for picking order-committed batch numbers is subject to the same standard warehouse exception handling and actions as regular work.</span></span> <span data-ttu-id="a48b8-428">通常，未结工作或工作行可以被取消，可以因为用户货位已满而中断，可以存在领料短缺，并可以由于移动而更新。</span><span class="sxs-lookup"><span data-stu-id="a48b8-428">In general, the open work or work line can be canceled, it can be interrupted because a user location is full, it can be short-picked, and it can be updated because of a movement.</span></span> <span data-ttu-id="a48b8-429">同样，已领取的已完成工作的数量可以减少，或工作可以冲销。</span><span class="sxs-lookup"><span data-stu-id="a48b8-429">Likewise, the picked quantity of work that has already been completed can be reduced, or the work can be reversed.</span></span>

<span data-ttu-id="a48b8-430">以下关键规则应用于所有这些异常处理操作：为客户预留的批号永远不能替换为其他批号，但是可以通过用户手动更新或系统自动更新来更改其存储维度（货位和牌照）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-430">The following key rule is applied to all these exception handling actions: the batch number that was reserved for the customer can never be replaced with a different batch number, but its storage dimensions (location and license plate) can be changed through either a manual update by the user or an automatic update by the system.</span></span> <span data-ttu-id="a48b8-431">自动更新基于对存储维度的随机分配，其与在自动预留特定批次但未指定存储维度时应用的方法相同。</span><span class="sxs-lookup"><span data-stu-id="a48b8-431">The automatic update is based on the same random assignment of storage dimensions that applied when a specific batch was automatically reserved but no storage dimensions were specified.</span></span>

### <a name="example-scenario"></a><span data-ttu-id="a48b8-432">示例场景</span><span class="sxs-lookup"><span data-stu-id="a48b8-432">Example scenario</span></span>

<span data-ttu-id="a48b8-433">这种情形的一个示例是：之前完成的工作未通过使用**减少领料数量**功能领取。</span><span class="sxs-lookup"><span data-stu-id="a48b8-433">An example of this scenario is a situation where previously completed work is being unpicked by using the **Reduce picked quantity** function.</span></span> <span data-ttu-id="a48b8-434">本示例假定您已经完成[示例方案：批号分配](#Example-batch-allocation)中所述的步骤。</span><span class="sxs-lookup"><span data-stu-id="a48b8-434">This example assumes that you've already completed the steps that are described in [Example scenario: Batch number allocation](#Example-batch-allocation).</span></span> <span data-ttu-id="a48b8-435">与该示例具有连续性。</span><span class="sxs-lookup"><span data-stu-id="a48b8-435">It continues from that example.</span></span>

1. <span data-ttu-id="a48b8-436">转到**仓库管理** \> **负荷** \> **有效负荷**。</span><span class="sxs-lookup"><span data-stu-id="a48b8-436">Go to **Warehouse management** \> **Loads** \> **Active loads**.</span></span>
2. <span data-ttu-id="a48b8-437">选择创建的与销售订单的装运相关的负荷。</span><span class="sxs-lookup"><span data-stu-id="a48b8-437">Select the load that was created in connection with the shipment of your sales order.</span></span>
3. <span data-ttu-id="a48b8-438">从**负荷订单行**快速选项卡，选择**减少领料数量**。</span><span class="sxs-lookup"><span data-stu-id="a48b8-438">From the **Load order lines** FastTab, select **Reduce picked quantity**.</span></span>
4. <span data-ttu-id="a48b8-439">在**减少领料数量**页面，在**移到货位**字段中，选择 **FL-001**。</span><span class="sxs-lookup"><span data-stu-id="a48b8-439">On the **Reduce picked quantity** page, in the **Move to location** field, select **FL-001**.</span></span>
5. <span data-ttu-id="a48b8-440">在**移到牌照**字段中，选择 **LP33**。</span><span class="sxs-lookup"><span data-stu-id="a48b8-440">In the **Move to license plate** field, select **LP33**.</span></span>
6. <span data-ttu-id="a48b8-441">在网格中，在**要取消领料的库存数量**字段中，输入 **10**。</span><span class="sxs-lookup"><span data-stu-id="a48b8-441">In the grid, in the **Inventory quantity to unpick** field, enter **10**.</span></span>
7. <span data-ttu-id="a48b8-442">选择**确定**。</span><span class="sxs-lookup"><span data-stu-id="a48b8-442">Select **OK**.</span></span>

<span data-ttu-id="a48b8-443">这是取消领料操作的结果：</span><span class="sxs-lookup"><span data-stu-id="a48b8-443">Here are the results of the unpicking action:</span></span>

- <span data-ttu-id="a48b8-444">先前结束的工作的状态设置为**已取消**。</span><span class="sxs-lookup"><span data-stu-id="a48b8-444">The status of the previously closed work is set to **Canceled**.</span></span>
- <span data-ttu-id="a48b8-445">为批号 **B11** 的取消领料的数量 **10** 创建了**库存变动**类型的新工作。</span><span class="sxs-lookup"><span data-stu-id="a48b8-445">New work of the **Inventory movement** type is created for the unpicked quantity of **10** for batch number **B11**.</span></span> <span data-ttu-id="a48b8-446">此工作代表从 **Baydoor** 货位到 **FL-001** 货位中的牌照 **LP33** 的移动。</span><span class="sxs-lookup"><span data-stu-id="a48b8-446">This work represents the movement from the **Baydoor** location to license plate **LP33** in location **FL-001**.</span></span> <span data-ttu-id="a48b8-447">状态设置为**已结束**。</span><span class="sxs-lookup"><span data-stu-id="a48b8-447">The status is set to **Closed**.</span></span>
- <span data-ttu-id="a48b8-448">系统将重新预留最初订购的批号，并分配货位和牌照 ID。</span><span class="sxs-lookup"><span data-stu-id="a48b8-448">The system re-reserves the batch number that was originally ordered, and assigns the location and license plate IDs.</span></span> <span data-ttu-id="a48b8-449">（此流程等效于为给定批号的订单行运行**预留行**功能）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-449">(This process is equivalent to running the **Reserve line** function for the order line for a given batch number).</span></span> <span data-ttu-id="a48b8-450">结果是，批次 **B11** 在**批次预留**页的**提交到源行的批号**快速选项卡上显示为已提交，**预留**字段包含批号 **B11** 的数量 **10**。</span><span class="sxs-lookup"><span data-stu-id="a48b8-450">As a result, batch **B11** is shown as committed on the **Batch numbers committed to source line** FastTab of the **Batch reservation** page, and the **Reservation** field contains a quantity of **10** for batch number **B11**.</span></span> <span data-ttu-id="a48b8-451">此外，**货位**字段设置为 **FL-001**，**牌照**字段设置为 **LP11**。</span><span class="sxs-lookup"><span data-stu-id="a48b8-451">Additionally, the **Location** field is set to **FL-001**, and the **License plate** field is set to **LP11**.</span></span> <span data-ttu-id="a48b8-452">（如果这些字段不可见，您可以将它们添加到网格中。）</span><span class="sxs-lookup"><span data-stu-id="a48b8-452">(You can add these fields to the grid if they aren't visible.)</span></span>

<span data-ttu-id="a48b8-453">下表提供了显示系统如何处理特定仓库操作的订单承诺批次预留的概览。</span><span class="sxs-lookup"><span data-stu-id="a48b8-453">The following tables provide an overview that shows how the system handles order-committed batch reservation for specific warehouse actions.</span></span> <span data-ttu-id="a48b8-454">为了解释表中的内容，假定每个仓库操作都在源于订单承诺批次预留的现有仓库工作的上下文中运行，或者每个仓库操作的执行都会影响该类型的工作。</span><span class="sxs-lookup"><span data-stu-id="a48b8-454">To interpret the content in the tables, assume that each warehouse action is run in the context of existing warehouse work that originates from an order-committed batch reservation, or that execution of each warehouse action affects work of that type.</span></span>

> [!NOTE]
> <span data-ttu-id="a48b8-455">在这些表中，“批次数量可用”列指示，除为当前的订单承诺预留已预留的数量，或由源于该类型预留的仓库工作已预留的数量之外，批次数量是否可用。</span><span class="sxs-lookup"><span data-stu-id="a48b8-455">In these tables, the "Batch quantity is available" column indicates whether a batch quantity is available in addition to the quantity that is either already reserved for the current order-committed reservations or already reserved by the warehouse work that originates from reservations of that type.</span></span>

#### <a name="override-the-pick-location-on-the-open-work"></a><span data-ttu-id="a48b8-456">覆盖未结工作上的领料货位</span><span class="sxs-lookup"><span data-stu-id="a48b8-456">Override the pick location on the open work</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="a48b8-457">关键设置参数</span><span class="sxs-lookup"><span data-stu-id="a48b8-457">Key setup parameter</span></span></th>
<th><span data-ttu-id="a48b8-458">批次数量可用</span><span class="sxs-lookup"><span data-stu-id="a48b8-458">Batch quantity is available</span></span></th>
<th><span data-ttu-id="a48b8-459">关键用户步骤</span><span class="sxs-lookup"><span data-stu-id="a48b8-459">Key user steps</span></span></th>
<th><span data-ttu-id="a48b8-460">仓库工作</span><span class="sxs-lookup"><span data-stu-id="a48b8-460">Warehouse work</span></span></th>
<th><span data-ttu-id="a48b8-461">订单承诺批次预留</span><span class="sxs-lookup"><span data-stu-id="a48b8-461">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="a48b8-462"><strong>允许领料货位覆盖</strong>在工作人员上已启用。</span><span class="sxs-lookup"><span data-stu-id="a48b8-462">The <strong>Allow pick location override</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="a48b8-463">是</span><span class="sxs-lookup"><span data-stu-id="a48b8-463">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-464">开始领料工作时，在仓库应用中选择<strong>替代货位</strong>菜单项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-464">Select the <strong>Override location</strong> menu item on the warehouse app when you start picking work.</span></span></li>
<li><span data-ttu-id="a48b8-465">选择<strong>建议</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-465">Select <strong>Suggest</strong>.</span></span></li>
<li><span data-ttu-id="a48b8-466">根据批次数量的可用性确认建议的新货位。</span><span class="sxs-lookup"><span data-stu-id="a48b8-466">Confirm the new location that is suggested based on batch quantity availability.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="a48b8-467">在当前工作上，将发生以下操作：</span><span class="sxs-lookup"><span data-stu-id="a48b8-467">On the current work, the following actions occur:</span></span>
<ul>
<li><span data-ttu-id="a48b8-468">领料行上的货位已更新为新货位。</span><span class="sxs-lookup"><span data-stu-id="a48b8-468">The location on the pick line is updated to the new location.</span></span> <span data-ttu-id="a48b8-469">（如果货位是由牌照控制的，将为工作库存交易记录分配一个随机牌照，工作人员可以从任何具有可用数量的牌照领料。）</span><span class="sxs-lookup"><span data-stu-id="a48b8-469">(If the location is license plate–controlled, a random license plate is assigned to the work inventory transaction, and the worker can pick from any license plate that has available quantity.)</span></span></li>
<li><span data-ttu-id="a48b8-470">如果在新货位的一个以上牌照中找到数量，原始领料行将拆分成多行以匹配每个牌照。</span><span class="sxs-lookup"><span data-stu-id="a48b8-470">If the quantity is found on more than one license plate in the new location, the original pick line is split into multiple lines to match each license plate.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="a48b8-471">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-471">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-472">无</span><span class="sxs-lookup"><span data-stu-id="a48b8-472">No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-473">开始领料工作时，在仓库应用中选择<strong>替代货位</strong>菜单项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-473">Select the <strong>Override location</strong> menu item on the warehouse app when you start picking work.</span></span></li>
<li><span data-ttu-id="a48b8-474">手动输入货位。</span><span class="sxs-lookup"><span data-stu-id="a48b8-474">Manually enter a location.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="a48b8-475"><strong>覆盖货位</strong>操作无法执行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-475">The <strong>Override location</strong> action isn't possible.</span></span> <span data-ttu-id="a48b8-476">操作失败，并引发错误。</span><span class="sxs-lookup"><span data-stu-id="a48b8-476">It fails, and an error is thrown.</span></span></td>
<td><span data-ttu-id="a48b8-477">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-477">Not applicable</span></span></td>
</tr>
</tbody>
</table>

#### <a name="full-button--split-a-work-line-because-of-overflow-on-the-user-location"></a><span data-ttu-id="a48b8-478">“全部”按钮 – 工作行由于用户货位存在溢出被拆分</span><span class="sxs-lookup"><span data-stu-id="a48b8-478">Full button – Split a work line because of overflow on the user location</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="a48b8-479">关键设置参数</span><span class="sxs-lookup"><span data-stu-id="a48b8-479">Key setup parameter</span></span></th>
<th><span data-ttu-id="a48b8-480">批次数量可用</span><span class="sxs-lookup"><span data-stu-id="a48b8-480">Batch quantity is available</span></span></th>
<th><span data-ttu-id="a48b8-481">关键用户步骤</span><span class="sxs-lookup"><span data-stu-id="a48b8-481">Key user steps</span></span></th>
<th><span data-ttu-id="a48b8-482">仓库工作</span><span class="sxs-lookup"><span data-stu-id="a48b8-482">Warehouse work</span></span></th>
<th><span data-ttu-id="a48b8-483">订单承诺批次预留</span><span class="sxs-lookup"><span data-stu-id="a48b8-483">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="a48b8-484"><strong>允许拆分工作</strong>选项在移动设备菜单项上启用。</span><span class="sxs-lookup"><span data-stu-id="a48b8-484">The <strong>Allow splitting of work</strong> option is enabled on the mobile device menu item.</span></span></td>
<td><span data-ttu-id="a48b8-485">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-485">Not applicable</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-486">执行领料工作时，在仓库应用中选择<strong>完全</strong>菜单项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-486">Select the <strong>Full</strong> menu item on the warehouse app when you process picking work.</span></span></li>
<li><span data-ttu-id="a48b8-487">在<strong>领料数量</strong>字段中，输入需要领料的部分数量来指示全部产能。</span><span class="sxs-lookup"><span data-stu-id="a48b8-487">In the <strong>Pick Qty</strong> field, enter a partial quantity of the required pick to indicate the full capacity.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="a48b8-488">在当前工作上，数量更新为必须领料的剩余数量。</span><span class="sxs-lookup"><span data-stu-id="a48b8-488">On the current work, the quantity is updated to the remaining quantity that must be picked.</span></span></li>
<li><span data-ttu-id="a48b8-489">领料数量的新工作已创建并结束。</span><span class="sxs-lookup"><span data-stu-id="a48b8-489">New work for the picked quantity is created and closed.</span></span></li>
</ul></td>
<td><span data-ttu-id="a48b8-490">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-490">Not applicable</span></span></td>
</tr>
</tbody>
</table>

#### <a name="reduce-the-picked-quantity-of-completed-work-from-a-load"></a><span data-ttu-id="a48b8-491">减少已完成工作的领料数量（从负荷）</span><span class="sxs-lookup"><span data-stu-id="a48b8-491">Reduce the picked quantity of completed work (from a load)</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="a48b8-492">关键设置参数</span><span class="sxs-lookup"><span data-stu-id="a48b8-492">Key setup parameter</span></span></th>
<th><span data-ttu-id="a48b8-493">批次数量可用</span><span class="sxs-lookup"><span data-stu-id="a48b8-493">Batch quantity is available</span></span></th>
<th><span data-ttu-id="a48b8-494">关键用户步骤</span><span class="sxs-lookup"><span data-stu-id="a48b8-494">Key user steps</span></span></th>
<th><span data-ttu-id="a48b8-495">仓库工作</span><span class="sxs-lookup"><span data-stu-id="a48b8-495">Warehouse work</span></span></th>
<th><span data-ttu-id="a48b8-496">订单承诺批次预留</span><span class="sxs-lookup"><span data-stu-id="a48b8-496">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="a48b8-497">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-497">Not applicable</span></span></td>
<td><span data-ttu-id="a48b8-498">是</span><span class="sxs-lookup"><span data-stu-id="a48b8-498">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-499">从负荷行打开<strong>减少领料数量</strong>页面。</span><span class="sxs-lookup"><span data-stu-id="a48b8-499">Open the <strong>Reduce picked quantity</strong> page from the load line.</span></span></li>
<li><span data-ttu-id="a48b8-500">输入要取消领料的全部数量。</span><span class="sxs-lookup"><span data-stu-id="a48b8-500">Enter the full quantity to unpick.</span></span></li>
<li><span data-ttu-id="a48b8-501">选择“移至”货位/牌照。</span><span class="sxs-lookup"><span data-stu-id="a48b8-501">Select a "move to" location/license plate.</span></span></li>
</ol>
</td>
<td>
<ul> 
<li><span data-ttu-id="a48b8-502">与负荷行关联的工作被取消。</span><span class="sxs-lookup"><span data-stu-id="a48b8-502">Work that is associated with the load line is canceled.</span></span></li>
<li><span data-ttu-id="a48b8-503">库存变动的新工作已创建并结束。</span><span class="sxs-lookup"><span data-stu-id="a48b8-503">New work for the inventory movement is created and closed.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="a48b8-504">为同一批次重新预留了数量。</span><span class="sxs-lookup"><span data-stu-id="a48b8-504">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="a48b8-505">系统随机分配数量可用的货位和牌照（如果货位是由牌照控制的）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-505">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-506">否</span><span class="sxs-lookup"><span data-stu-id="a48b8-506">No</span></span></td>
<td><span data-ttu-id="a48b8-507">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-507">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-508">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-508">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-509">已为同一批次，以及取消领料期间输入的同一货位和牌照（如果货位是由牌照控制的）重新预留了数量。</span><span class="sxs-lookup"><span data-stu-id="a48b8-509">The quantity is re-reserved for the same batch, and for the same location and license plate (if the location is license plate–controlled) that were entered during unpicking.</span></span></td>
</tr>
</tbody>
</table>

#### <a name="move-an-item-within-a-warehouse"></a><span data-ttu-id="a48b8-510">在仓库内移动物料</span><span class="sxs-lookup"><span data-stu-id="a48b8-510">Move an item within a warehouse</span></span>

> [!NOTE]
> <span data-ttu-id="a48b8-511">此仓库操作仅适用于**工作创建流程**类型的移动，不适用于模板移动。</span><span class="sxs-lookup"><span data-stu-id="a48b8-511">This warehouse action is applicable only to movement of the **Work creation process** type, not to movement by template.</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="a48b8-512">关键设置参数</span><span class="sxs-lookup"><span data-stu-id="a48b8-512">Key setup parameter</span></span></th>
<th><span data-ttu-id="a48b8-513">批次数量可用</span><span class="sxs-lookup"><span data-stu-id="a48b8-513">Batch quantity is available</span></span></th>
<th><span data-ttu-id="a48b8-514">关键用户步骤</span><span class="sxs-lookup"><span data-stu-id="a48b8-514">Key user steps</span></span></th>
<th><span data-ttu-id="a48b8-515">仓库工作</span><span class="sxs-lookup"><span data-stu-id="a48b8-515">Warehouse work</span></span></th>
<th><span data-ttu-id="a48b8-516">订单承诺批次预留</span><span class="sxs-lookup"><span data-stu-id="a48b8-516">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="a48b8-517"><strong>允许包含关联工作的库存移动</strong>选项在工作人员上启用。</span><span class="sxs-lookup"><span data-stu-id="a48b8-517">The <strong>Allow movement of inventory with associated work</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="a48b8-518">是</span><span class="sxs-lookup"><span data-stu-id="a48b8-518">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-519">在仓库应用中开始移动。</span><span class="sxs-lookup"><span data-stu-id="a48b8-519">Start a movement on the warehouse app.</span></span></li>
<li><span data-ttu-id="a48b8-520">输入“起始”和“目标”货位。</span><span class="sxs-lookup"><span data-stu-id="a48b8-520">Enter "from" and "to" locations.</span></span></li>
</ol></td>
<td>
<ul>
<li><span data-ttu-id="a48b8-521">在受移动影响的所有现有工作上，领料货位将更新为新的“目标”货位。</span><span class="sxs-lookup"><span data-stu-id="a48b8-521">On all existing work that is affected by the move, the pick location is updated to the new "to" location.</span></span></li>
<li><span data-ttu-id="a48b8-522">库存变动的新工作已创建并结束。</span><span class="sxs-lookup"><span data-stu-id="a48b8-522">New work for the inventory movement is created and closed.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="a48b8-523">受从给定货位的数量移动影响的所有现有预留已为同一批次重新预留。</span><span class="sxs-lookup"><span data-stu-id="a48b8-523">All existing reservations that are affected by the quantity movement from the given location are re-reserved for the same batch.</span></span> <span data-ttu-id="a48b8-524">系统随机分配数量可用的货位和牌照（如果货位是由牌照控制的）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-524">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-525">否</span><span class="sxs-lookup"><span data-stu-id="a48b8-525">No</span></span></td>
<td><span data-ttu-id="a48b8-526">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-526">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-527">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-527">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-528">受从给定货位的数量移动影响的所有现有预留已为同一批次，以及新的“目标”货位和牌照（如果货位是由牌照控制的）重新预留。</span><span class="sxs-lookup"><span data-stu-id="a48b8-528">All existing reservations that are affected by the quantity movement from the given location are re-reserved for the same batch, and for the new "to" location and license plate (if the location is license plate–controlled).</span></span></td>
</tr>
</tbody>
</table>

#### <a name="reverse-the-picked-quantity-of-completed-work-from-a-load-or-a-wave"></a><span data-ttu-id="a48b8-529">冲销已完成工作的领料数量（从负荷或波次）</span><span class="sxs-lookup"><span data-stu-id="a48b8-529">Reverse the picked quantity of completed work (from a load or a wave)</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="a48b8-530">关键设置参数</span><span class="sxs-lookup"><span data-stu-id="a48b8-530">Key setup parameter</span></span></th>
<th><span data-ttu-id="a48b8-531">批次数量可用</span><span class="sxs-lookup"><span data-stu-id="a48b8-531">Batch quantity is available</span></span></th>
<th><span data-ttu-id="a48b8-532">关键用户步骤</span><span class="sxs-lookup"><span data-stu-id="a48b8-532">Key user steps</span></span></th>
<th><span data-ttu-id="a48b8-533">仓库工作</span><span class="sxs-lookup"><span data-stu-id="a48b8-533">Warehouse work</span></span></th>
<th><span data-ttu-id="a48b8-534">订单承诺批次预留</span><span class="sxs-lookup"><span data-stu-id="a48b8-534">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='6'><span data-ttu-id="a48b8-535">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-535">Not applicable</span></span></td>
<td><span data-ttu-id="a48b8-536">是</span><span class="sxs-lookup"><span data-stu-id="a48b8-536">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-537">打开<strong>冲销工作</strong>页面。</span><span class="sxs-lookup"><span data-stu-id="a48b8-537">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="a48b8-538">在请求页面上，选择<strong>将物料留在当前货位</strong>选项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-538">On the request page, select the <strong>Leave items at current location</strong> option.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="a48b8-539">与负荷关联的所有工作被取消。</span><span class="sxs-lookup"><span data-stu-id="a48b8-539">All work that is associated with the load is canceled.</span></span></td>
<td><span data-ttu-id="a48b8-540">为同一批次重新预留了数量。</span><span class="sxs-lookup"><span data-stu-id="a48b8-540">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="a48b8-541">系统随机分配数量可用的货位和牌照（如果货位是由牌照控制的）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-541">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-542">否</span><span class="sxs-lookup"><span data-stu-id="a48b8-542">No</span></span></td>
<td><span data-ttu-id="a48b8-543">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-543">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-544">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-544">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-545">数量已为同一批次以及在冲销后保留数量的货位和牌照重新预留。</span><span class="sxs-lookup"><span data-stu-id="a48b8-545">The quantity is re-reserved for the same batch, and for the location and license plate where the quantity was left upon reversal.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-546">是</span><span class="sxs-lookup"><span data-stu-id="a48b8-546">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-547">打开<strong>冲销工作</strong>页面。</span><span class="sxs-lookup"><span data-stu-id="a48b8-547">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="a48b8-548">在请求页面上，选择<strong>将物料分配给此货位</strong>选项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-548">On the request page, select the <strong>Assign items to this location</strong> option.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="a48b8-549">当前工作被取消。</span><span class="sxs-lookup"><span data-stu-id="a48b8-549">The current work is canceled.</span></span></li>
<li><span data-ttu-id="a48b8-550">库存变动的新工作已创建并结束。</span><span class="sxs-lookup"><span data-stu-id="a48b8-550">New work for the inventory movement is created and closed.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="a48b8-551">为同一批次重新预留了数量。</span><span class="sxs-lookup"><span data-stu-id="a48b8-551">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="a48b8-552">系统随机分配数量可用的货位和牌照（如果货位是由牌照控制的）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-552">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-553">否</span><span class="sxs-lookup"><span data-stu-id="a48b8-553">No</span></span></td>
<td><span data-ttu-id="a48b8-554">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-554">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-555">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-555">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-556">数量已为同一批次以及在冲销后向其分配数量的货位和牌照重新预留。</span><span class="sxs-lookup"><span data-stu-id="a48b8-556">The quantity is re-reserved for the same batch, and for the location and license plate that the quantity was assigned to upon reversal.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-557">是/否</span><span class="sxs-lookup"><span data-stu-id="a48b8-557">Yes/No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-558">打开<strong>冲销工作</strong>页面。</span><span class="sxs-lookup"><span data-stu-id="a48b8-558">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="a48b8-559">在请求页面上，选择<strong>将物料移到此货位</strong>选项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-559">On the request page, select the <strong>Move items to this location</strong> option.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="a48b8-560">不支持冲销。</span><span class="sxs-lookup"><span data-stu-id="a48b8-560">Reversal isn't supported.</span></span></td>
<td><span data-ttu-id="a48b8-561">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-561">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-562">是/否</span><span class="sxs-lookup"><span data-stu-id="a48b8-562">Yes/No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-563">打开<strong>冲销工作</strong>页面。</span><span class="sxs-lookup"><span data-stu-id="a48b8-563">Open the <strong>Reverse work</strong> page.</span></span></li>
<li><span data-ttu-id="a48b8-564">在请求页面上，选择<strong>根据货位指令移动物料</strong>选项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-564">On the request page, select the <strong>Move items based on location directives</strong> option.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="a48b8-565">不支持冲销。</span><span class="sxs-lookup"><span data-stu-id="a48b8-565">Reversal isn't supported.</span></span> </td>
<td><span data-ttu-id="a48b8-566">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-566">Not applicable</span></span></td>
</tr>
</tbody>
</table>

#### <a name="short-pick-a-quantity--register-the-quantity-as-physically-not-found-at-the-locationlicense-plate-while-you-perform-picking-work"></a><span data-ttu-id="a48b8-567">领料短缺数量 – 登记在执行领料工作时，在货位/牌照上实际未找到的数量</span><span class="sxs-lookup"><span data-stu-id="a48b8-567">Short-pick a quantity – Register the quantity as physically not found at the location/license plate while you perform picking work</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="a48b8-568">关键设置参数</span><span class="sxs-lookup"><span data-stu-id="a48b8-568">Key setup parameter</span></span></th>
<th><span data-ttu-id="a48b8-569">批次数量可用</span><span class="sxs-lookup"><span data-stu-id="a48b8-569">Batch quantity is available</span></span></th>
<th><span data-ttu-id="a48b8-570">关键用户步骤</span><span class="sxs-lookup"><span data-stu-id="a48b8-570">Key user steps</span></span></th>
<th><span data-ttu-id="a48b8-571">仓库工作</span><span class="sxs-lookup"><span data-stu-id="a48b8-571">Warehouse work</span></span></th>
<th><span data-ttu-id="a48b8-572">订单承诺批次预留</span><span class="sxs-lookup"><span data-stu-id="a48b8-572">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="a48b8-573">设置<strong>领料短缺</strong>类型的工作异常，其中，<strong>物料重新分配</strong> = <strong>无</strong>，<strong>调整库存</strong> = <strong>是</strong>，<strong>删除预留</strong> = <strong>否</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-573">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>None</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>No</strong>.</span></span></td>
<td><span data-ttu-id="a48b8-574">是</span><span class="sxs-lookup"><span data-stu-id="a48b8-574">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-575">执行领料工作时，在仓库应用中选择<strong>领料不足</strong>菜单项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-575">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="a48b8-576">在<strong>领料数量</strong>字段中，输入<strong>0</strong>（零）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-576">In the <strong>Pick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="a48b8-577">在<strong>原因</strong>字段中，输入<strong>未重新分配</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-577">In the <strong>Reason</strong> field, enter <strong>No reallocation</strong>.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="a48b8-578">当前工作已结束，领料数量为 0（零）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-578">The current work is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="a48b8-579"><strong>盘点</strong>类型和<strong>已售出</strong>发货类型的库存交易记录已创建来表示调整。</span><span class="sxs-lookup"><span data-stu-id="a48b8-579">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="a48b8-580">为同一批次重新预留了数量。</span><span class="sxs-lookup"><span data-stu-id="a48b8-580">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="a48b8-581">系统随机分配数量可用的货位和牌照（如果货位是由牌照控制的）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-581">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-582">否</span><span class="sxs-lookup"><span data-stu-id="a48b8-582">No</span></span></td>
<td><span data-ttu-id="a48b8-583">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-583">See the previous row.</span></span></td>
<td>
<ul>
<li><span data-ttu-id="a48b8-584">领料短缺操作失败，并引发错误。</span><span class="sxs-lookup"><span data-stu-id="a48b8-584">The short-picking action fails, and an error is thrown.</span></span></li>
<li><span data-ttu-id="a48b8-585">当前工作保持未结状态。</span><span class="sxs-lookup"><span data-stu-id="a48b8-585">The current work remains open.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="a48b8-586">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-586">Not applicable</span></span></td>
</tr>
<tr>
<td rowspan='2'><span data-ttu-id="a48b8-587">设置<strong>领料短缺</strong>类型的工作异常，其中，<strong>物料重新分配</strong> = <strong>无</strong>，<strong>调整库存</strong> = <strong>是</strong>，<strong>删除预留</strong> = <strong>是</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-587">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>None</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>Yes</strong>.</span></span></td>
<td><span data-ttu-id="a48b8-588">是</span><span class="sxs-lookup"><span data-stu-id="a48b8-588">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-589">执行领料工作时，在仓库应用中选择<strong>领料不足</strong>菜单项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-589">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="a48b8-590">在<strong>领料数量</strong>字段中，输入<strong>0</strong>（零）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-590">In the <strong>Pick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="a48b8-591">在<strong>原因</strong>字段中，输入<strong>未重新分配</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-591">In the <strong>Reason</strong> field, enter <strong>No reallocation</strong>.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="a48b8-592">当前工作已结束，领料数量为 0（零）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-592">The current work is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="a48b8-593"><strong>盘点</strong>类型和<strong>已售出</strong>发货类型的库存交易记录已创建来表示调整。</span><span class="sxs-lookup"><span data-stu-id="a48b8-593">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="a48b8-594">受领料短缺货位的数量调整影响的所有现有预留已为同一批次重新预留。</span><span class="sxs-lookup"><span data-stu-id="a48b8-594">All existing reservations that are affected by the quantity adjustment in the short-picked location are re-reserved for the same batch.</span></span> <span data-ttu-id="a48b8-595">系统随机分配数量可用的货位和牌照（如果货位是由牌照控制的）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-595">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-596">否</span><span class="sxs-lookup"><span data-stu-id="a48b8-596">No</span></span></td>
<td><span data-ttu-id="a48b8-597">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-597">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-598">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-598">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-599">受领料短缺货位的数量调整影响的所有现有预留已删除。</span><span class="sxs-lookup"><span data-stu-id="a48b8-599">All existing reservations that are affected by the quantity adjustment in the short-picked location are removed.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-600">设置<strong>领料短缺</strong>类型的工作异常，其中，<strong>物料重新分配</strong> = <strong>手动</strong>，<strong>调整库存</strong> = <strong>是</strong>，<strong>删除预留</strong> = <strong>否/是</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-600">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Manual</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>No/Yes</strong>.</span></span> <span data-ttu-id="a48b8-601">此外，<strong>允许手动重新分配物料</strong>选项在工作人员上启用。</span><span class="sxs-lookup"><span data-stu-id="a48b8-601">Additionally, the <strong>Allow manual item reallocation</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="a48b8-602">是</span><span class="sxs-lookup"><span data-stu-id="a48b8-602">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-603">执行领料工作时，在仓库应用中选择<strong>领料不足</strong>菜单项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-603">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="a48b8-604">在<strong>领料短缺数量</strong>字段中，输入<strong>0</strong>（零）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-604">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="a48b8-605">在<strong>原因</strong>字段中，选择<strong>手动重新分配领料短缺</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-605">In the <strong>Reason</strong> field, select <strong>Short Picking with manual reallocation</strong>.</span></span></li>
<li><span data-ttu-id="a48b8-606">在列表中选择货位/牌照。</span><span class="sxs-lookup"><span data-stu-id="a48b8-606">Select the location/license plate in the list.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="a48b8-607">在当前工作上，将发生以下操作：</span><span class="sxs-lookup"><span data-stu-id="a48b8-607">On the current work, the following actions occur:</span></span>
<ul>
<li><span data-ttu-id="a48b8-608">领料行已关闭，领料数量为 0（零）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-608">The pick line is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="a48b8-609">放置行被取消。</span><span class="sxs-lookup"><span data-stu-id="a48b8-609">The put line is canceled.</span></span></li>
<li><span data-ttu-id="a48b8-610">新领料行创建。</span><span class="sxs-lookup"><span data-stu-id="a48b8-610">A new pick line is created.</span></span> <span data-ttu-id="a48b8-611">它使用用户选择的货位/牌照。</span><span class="sxs-lookup"><span data-stu-id="a48b8-611">It uses the location/license plate that the user selected.</span></span></li>
<li><span data-ttu-id="a48b8-612">新放置行创建。</span><span class="sxs-lookup"><span data-stu-id="a48b8-612">A new put line is created.</span></span></li>
</ul>
</li>
<li><span data-ttu-id="a48b8-613"><strong>盘点</strong>类型和<strong>已售出</strong>发货类型的库存交易记录已创建来表示调整。</span><span class="sxs-lookup"><span data-stu-id="a48b8-613">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="a48b8-614">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-614">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-615">设置<strong>领料短缺</strong>类型的工作异常，其中，<strong>物料重新分配</strong> = <strong>手动</strong>，<strong>调整库存</strong> = <strong>是</strong>，<strong>删除预留</strong> = <strong>否</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-615">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Manual</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>No</strong>.</span></span> <span data-ttu-id="a48b8-616">此外，<strong>允许手动重新分配物料</strong>选项在工作人员上启用。</span><span class="sxs-lookup"><span data-stu-id="a48b8-616">Additionally, the <strong>Allow manual item reallocation</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="a48b8-617">无</span><span class="sxs-lookup"><span data-stu-id="a48b8-617">No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-618">执行领料工作时，在仓库应用中选择<strong>领料不足</strong>菜单项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-618">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="a48b8-619">在<strong>领料短缺数量</strong>字段中，输入<strong>0</strong>（零）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-619">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="a48b8-620">在<strong>原因</strong>字段中，选择<strong>手动重新分配领料短缺</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-620">In the <strong>Reason</strong> field, select <strong>Short Picking with manual reallocation</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="a48b8-621">领料短缺操作失败，并引发错误。</span><span class="sxs-lookup"><span data-stu-id="a48b8-621">The short-picking action fails, and an error is thrown.</span></span></td>
<td><span data-ttu-id="a48b8-622">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-622">Not applicable</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-623">设置<strong>领料短缺</strong>类型的工作异常，其中，<strong>物料重新分配</strong> = <strong>手动</strong>，<strong>调整库存</strong> = <strong>是</strong>，<strong>删除预留</strong> = <strong>是</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-623">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Manual</strong>, <strong>Adjust inventory</strong> = <strong>Yes</strong>, and <strong>Remove reservations</strong> = <strong>Yes</strong>.</span></span> <span data-ttu-id="a48b8-624">此外，<strong>允许手动重新分配物料</strong>选项在工作人员上启用。</span><span class="sxs-lookup"><span data-stu-id="a48b8-624">Additionally, the <strong>Allow manual item reallocation</strong> option is enabled on the worker.</span></span></td>
<td><span data-ttu-id="a48b8-625">无</span><span class="sxs-lookup"><span data-stu-id="a48b8-625">No</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-626">执行领料工作时，在仓库应用中选择<strong>领料不足</strong>菜单项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-626">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="a48b8-627">在<strong>领料短缺数量</strong>字段中，输入<strong>0</strong>（零）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-627">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="a48b8-628">在<strong>原因</strong>字段中，选择<strong>手动重新分配领料短缺</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-628">In the <strong>Reason</strong> field, select <strong>Short Picking with manual reallocation</strong>.</span></span></li>
<li><span data-ttu-id="a48b8-629">在列表中选择货位/牌照。</span><span class="sxs-lookup"><span data-stu-id="a48b8-629">Select the location/license plate in the list.</span></span></li>
</ol>
</td>
<td>
<ul>
<li><span data-ttu-id="a48b8-630">在当前工作上，将发生以下操作：</span><span class="sxs-lookup"><span data-stu-id="a48b8-630">On the current work, the following actions occur:</span></span>
<ul>
<li><span data-ttu-id="a48b8-631">领料行已关闭，领料数量为 0（零）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-631">The pick line is closed, and the picked quantity is 0 (zero).</span></span></li>
<li><span data-ttu-id="a48b8-632">放置行被取消。</span><span class="sxs-lookup"><span data-stu-id="a48b8-632">The put line is canceled.</span></span></li>
</ul>
</li>
<li><span data-ttu-id="a48b8-633"><strong>盘点</strong>类型和<strong>已售出</strong>发货类型的库存交易记录已创建来表示调整。</span><span class="sxs-lookup"><span data-stu-id="a48b8-633">An inventory transaction of the <strong>Counting</strong> type and the <strong>Sold</strong> issue type is created to represent the adjustment.</span></span></li>
</ul>
</td>
<td><span data-ttu-id="a48b8-634">受领料短缺货位/牌照的数量调整影响的所有现有预留已删除。</span><span class="sxs-lookup"><span data-stu-id="a48b8-634">All existing reservations that are affected by the quantity adjustment in the short-picked location/license plate are removed.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-635">设置<strong>领料短缺</strong>类型的工作异常，其中，<strong>物料重新分配</strong> = <strong>自动</strong>，<strong>调整库存</strong> = <strong>是/否</strong>，<strong>删除预留</strong> = <strong>是/否</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-635">A work exception of the <strong>Short pick</strong> type is set up, where <strong>Item reallocation</strong> = <strong>Automatic</strong>, <strong>Adjust inventory</strong> = <strong>Yes/No</strong>, and <strong>Remove reservations</strong> = <strong>Yes/No</strong>.</span></span></td>
<td><span data-ttu-id="a48b8-636">不适用</span><span class="sxs-lookup"><span data-stu-id="a48b8-636">Not applicable</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-637">执行领料工作时，在仓库应用中选择<strong>领料不足</strong>菜单项。</span><span class="sxs-lookup"><span data-stu-id="a48b8-637">Select the <strong>Shortpick</strong> menu item on the warehouse app when you run picking work.</span></span></li>
<li><span data-ttu-id="a48b8-638">在<strong>领料短缺数量</strong>字段中，输入<strong>0</strong>（零）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-638">In the <strong>Shortpick Quantity</strong> field, enter <strong>0</strong> (zero).</span></span></li>
<li><span data-ttu-id="a48b8-639">在<strong>原因</strong>字段中，选择<strong>自动重新分配领料短缺</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-639">In the <strong>Reason</strong> field, select <strong>Short Picking with automatic reallocation</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="a48b8-640">不支持涉及自动重新分配的领料短缺。</span><span class="sxs-lookup"><span data-stu-id="a48b8-640">Short-picking that involves automatic reallocation isn't supported.</span></span></td>
<td><span data-ttu-id="a48b8-641">不支持涉及自动重新分配的领料短缺。</span><span class="sxs-lookup"><span data-stu-id="a48b8-641">Short-picking that involves automatic reallocation isn't supported.</span></span></td>
</tr>
</tbody>
</table>

#### <a name="change-the-inventory-status"></a><span data-ttu-id="a48b8-642">更改库存状态</span><span class="sxs-lookup"><span data-stu-id="a48b8-642">Change the inventory status</span></span>

> [!NOTE]
> <span data-ttu-id="a48b8-643">可以从多个入口点执行此仓库操作。</span><span class="sxs-lookup"><span data-stu-id="a48b8-643">This warehouse action can be performed from multiple entry points.</span></span> <span data-ttu-id="a48b8-644">此处显示的示例使用**按货位显示的现有量**页面的**库存状态更改**操作。</span><span class="sxs-lookup"><span data-stu-id="a48b8-644">The example that is shown here uses **Inventory status change** action on the **On-hand by location** page.</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="a48b8-645">关键设置参数</span><span class="sxs-lookup"><span data-stu-id="a48b8-645">Key setup parameter</span></span></th>
<th><span data-ttu-id="a48b8-646">批次数量可用</span><span class="sxs-lookup"><span data-stu-id="a48b8-646">Batch quantity is available</span></span></th>
<th><span data-ttu-id="a48b8-647">关键用户步骤</span><span class="sxs-lookup"><span data-stu-id="a48b8-647">Key user steps</span></span></th>
<th><span data-ttu-id="a48b8-648">仓库工作</span><span class="sxs-lookup"><span data-stu-id="a48b8-648">Warehouse work</span></span></th>
<th><span data-ttu-id="a48b8-649">订单承诺批次预留</span><span class="sxs-lookup"><span data-stu-id="a48b8-649">Order-committed batch reservation</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan='2'><span data-ttu-id="a48b8-650">在<strong>仓库</strong>选项卡上，在<strong>仓库</strong>记录中，<strong>删除预留和标记</strong>字段设置为<strong>预留</strong>或<strong>标记和预留</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-650">On the <strong>Warehouse</strong> tab, in the <strong>Warehouse</strong> record, the <strong>Remove reservations and markings</strong> field is set to <strong>Reservations</strong> or <strong>Markings and reservations</strong>.</span></span></td>
<td><span data-ttu-id="a48b8-651">是</span><span class="sxs-lookup"><span data-stu-id="a48b8-651">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-652">选择特定位置。</span><span class="sxs-lookup"><span data-stu-id="a48b8-652">Select a specific location.</span></span></li>
<li><span data-ttu-id="a48b8-653">选择具有特定物料、货位和牌照的行（如果货位是由牌照控制的）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-653">Select a line that has a specific item, location, and license plate (if the location is license plate–controlled).</span></span></li>
<li><span data-ttu-id="a48b8-654">选择<strong>库存状态更改</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-654">Select <strong>Inventory status change</strong>.</span></span></li>
<li><span data-ttu-id="a48b8-655">将<strong>库存状态</strong>字段设置为<strong>锁定</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-655">Set the <strong>Inventory status</strong> field to <strong>Blocking</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="a48b8-656">为工作预留的数量不允许库存状态更改。</span><span class="sxs-lookup"><span data-stu-id="a48b8-656">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td>
<ul>
<li><span data-ttu-id="a48b8-657">为同一批次重新预留了数量。</span><span class="sxs-lookup"><span data-stu-id="a48b8-657">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="a48b8-658">系统随机分配数量可用的货位和牌照（如果货位是由牌照控制的）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-658">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></li>
<li><span data-ttu-id="a48b8-659"><strong>库存状态更改</strong>的两个库存交易记录已创建，来表示库存状态维度的更改。</span><span class="sxs-lookup"><span data-stu-id="a48b8-659">Two inventory transactions of the <strong>Inventory status change</strong> type are created to represent the change in the inventory status dimension.</span></span></li>
<li><span data-ttu-id="a48b8-660"><strong>库存锁定</strong>类型和<strong>实际预留</strong>发货类型的库存交易记录已创建，来表示锁定数量的预留。</span><span class="sxs-lookup"><span data-stu-id="a48b8-660">An inventory transaction of the <strong>Inventory blocking</strong> type and the <strong>Reserved physical</strong> issue type is created to represent the reservation of the blocked quantity.</span></span></li>
</ul>
</td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-661">否</span><span class="sxs-lookup"><span data-stu-id="a48b8-661">No</span></span></td>
<td><span data-ttu-id="a48b8-662">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-662">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-663">为工作预留的数量不允许库存状态更改。</span><span class="sxs-lookup"><span data-stu-id="a48b8-663">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td>
<ul>
<li><span data-ttu-id="a48b8-664">预留被删除。</span><span class="sxs-lookup"><span data-stu-id="a48b8-664">The reservation is removed.</span></span></li>
<li><span data-ttu-id="a48b8-665"><strong>库存状态更改</strong>的两个库存交易记录已创建，来表示库存状态维度的更改。</span><span class="sxs-lookup"><span data-stu-id="a48b8-665">Two inventory transactions of the <strong>Inventory status change</strong> type are created to represent the change in the inventory status dimension.</span></span></li>
<li><span data-ttu-id="a48b8-666"><strong>库存锁定</strong>类型和<strong>实际预留</strong>发货类型的库存交易记录已创建，来表示锁定数量的预留。</span><span class="sxs-lookup"><span data-stu-id="a48b8-666">An inventory transaction of the <strong>Inventory blocking</strong> type and the <strong>Reserved physical</strong> issue type is created to represent the reservation of the blocked quantity.</span></span></li>
</ul>
</td>
</tr>
<tr>
<td rowspan='2'><span data-ttu-id="a48b8-667">在<strong>仓库</strong>选项卡上，在<strong>仓库</strong>记录中，<strong>删除预留和标记</strong>字段设置为<strong>无</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-667">On the <strong>Warehouse</strong> tab, in the <strong>Warehouse</strong> record, the <strong>Remove reservations and markings</strong> field is set to <strong>None</strong>.</span></span></td>
<td><span data-ttu-id="a48b8-668">是</span><span class="sxs-lookup"><span data-stu-id="a48b8-668">Yes</span></span></td>
<td>
<ol>
<li><span data-ttu-id="a48b8-669">选择特定位置。</span><span class="sxs-lookup"><span data-stu-id="a48b8-669">Select a specific location.</span></span></li>
<li><span data-ttu-id="a48b8-670">选择具有特定物料、货位和牌照的行（如果货位是由牌照控制的）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-670">Select a line that has a specific item, location, and license plate (if the location is license plate–controlled).</span></span></li>
<li><span data-ttu-id="a48b8-671">选择<strong>库存状态更改</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-671">Select <strong>Inventory status change</strong>.</span></span></li>
<li><span data-ttu-id="a48b8-672">将<strong>库存状态</strong>字段设置为<strong>锁定</strong>。</span><span class="sxs-lookup"><span data-stu-id="a48b8-672">Set the <strong>Inventory status</strong> field to <strong>Blocking</strong>.</span></span></li>
</ol>
</td>
<td><span data-ttu-id="a48b8-673">为工作预留的数量不允许库存状态更改。</span><span class="sxs-lookup"><span data-stu-id="a48b8-673">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td><span data-ttu-id="a48b8-674">为同一批次重新预留了数量。</span><span class="sxs-lookup"><span data-stu-id="a48b8-674">The quantity is re-reserved for the same batch.</span></span> <span data-ttu-id="a48b8-675">系统随机分配数量可用的货位和牌照（如果货位是由牌照控制的）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-675">The system randomly assigns a location and license plate (if the location is license plate–controlled) where the quantity is available.</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="a48b8-676">否</span><span class="sxs-lookup"><span data-stu-id="a48b8-676">No</span></span></td>
<td><span data-ttu-id="a48b8-677">查看上一行。</span><span class="sxs-lookup"><span data-stu-id="a48b8-677">See the previous row.</span></span></td>
<td><span data-ttu-id="a48b8-678">为工作预留的数量不允许库存状态更改。</span><span class="sxs-lookup"><span data-stu-id="a48b8-678">Inventory status changes aren't allowed for quantities that are reserved for work.</span></span></td>
<td><span data-ttu-id="a48b8-679">不允许库存状态更改。</span><span class="sxs-lookup"><span data-stu-id="a48b8-679">Inventory status changes aren't allowed.</span></span></td>
</tr>
</tbody>
</table>

## <a name="limitations"></a><span data-ttu-id="a48b8-680">限制</span><span class="sxs-lookup"><span data-stu-id="a48b8-680">Limitations</span></span>

- <span data-ttu-id="a48b8-681">灵活的仓库级维度预留功能不支持以下功能：</span><span class="sxs-lookup"><span data-stu-id="a48b8-681">The flexible warehouse-level dimension reservation functionality doesn't support the following features:</span></span>

    - <span data-ttu-id="a48b8-682">实际称重管理</span><span class="sxs-lookup"><span data-stu-id="a48b8-682">Catch weight management</span></span>
    - <span data-ttu-id="a48b8-683">允许实际负库存</span><span class="sxs-lookup"><span data-stu-id="a48b8-683">Physical negative inventory</span></span>
    - <span data-ttu-id="a48b8-684">按订购的供应预留</span><span class="sxs-lookup"><span data-stu-id="a48b8-684">Reservation against ordered supply</span></span>
    - <span data-ttu-id="a48b8-685">转移单和原材料领料</span><span class="sxs-lookup"><span data-stu-id="a48b8-685">Transfer orders and raw material picking</span></span>

- <span data-ttu-id="a48b8-686">按指令单位包装的集装箱合并规则有局限性。</span><span class="sxs-lookup"><span data-stu-id="a48b8-686">The container consolidation rule for packing by directive unit has limitations.</span></span> <span data-ttu-id="a48b8-687">对于订单承诺预留，我们建议您不要在**按指令单位包装**字段已启用的情况下使用集装箱生成模板。</span><span class="sxs-lookup"><span data-stu-id="a48b8-687">For order-committed reservations, we recommend that you not use container build templates where the **Pack by directive unit** field is enabled.</span></span> <span data-ttu-id="a48b8-688">在当前的设计中，创建仓库工作时不使用货位指令。</span><span class="sxs-lookup"><span data-stu-id="a48b8-688">In the current design, location directives aren't used when warehouse work is created.</span></span> <span data-ttu-id="a48b8-689">因此，在集装化波次步骤期间，仅应用单位序列组中的最低单位（库存单位）。</span><span class="sxs-lookup"><span data-stu-id="a48b8-689">Therefore, only the lowest unit in the unit sequence group (the inventory unit) is applied during the containerization wave step.</span></span>
