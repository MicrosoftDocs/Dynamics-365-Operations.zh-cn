...
零售商通常会选择从折扣中排除一些产品，如新商品或热销商品。 但是，他们可能仍希望应用基于支付方式的折扣。 例如，零售商将 Retail 配置为不允许基于商品的折扣或手动折扣。 但是，如果客户使用首选支付方式支付，Retail 仍将应用基于支付方式的折扣。 要以这种方式设置 Retail，零售商必须转到**产品信息管理 > 产品 > 已发布产品**，选择商品，然后在 **Retail** 快速选项卡上将**禁止所有折扣**和**禁止基于支付方式的折扣**选项设置为**否**，并将**禁止零售折扣**和**禁止手动折扣**选项设置为**是**。
