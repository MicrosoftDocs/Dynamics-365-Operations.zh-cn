...
| 任务                                                | 明细                                                                                                                                                                                                                                                                                                                                                   | 主题                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|-----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 配置零售组件                        | 设置和维护零售运营的信息。 此信息包括商店、税金、产品、礼品卡、促销和折扣。                                                                                                                                                                                                          | [设置和维护零售](https://technet.microsoft.com/library/hh597201.aspx)（Microsoft Dynamics AX 2012 的 TechNet 内容）                                                                                                                                                                                                                                                                                          |
| 配置零售通道导航层次结构。    | 创建零售渠道导航类别层次结构以为您通过在线商店提供的产品设置类别结构。 定义类别层次结构和分配产品、产品属性组以及类别的属性值。 然后，将类别层次结构分配给在线商店。                            | [设置零售层次结构](https://technet.microsoft.com/library/hh580593.aspx)（AX 2012 的 TechNet 内容）[设置属性和属性类型](https://technet.microsoft.com/library/hh227548.aspx)（AX 2012 的 TechNet 内容）[设置零售属性组](https://technet.microsoft.com/library/jj728713.aspx)（AX 2012 的 TechNet 内容） |
...
| 管理价格。                       | 设置和使用价格组，价格组是价格与折扣、与渠道、目录、隶属关系以及会员计划之间的中央链接。 | [使用价格组设置价格](https://technet.microsoft.com/library/hh597169.aspx)（AX 2012 的 TechNet 内容）[设置税](https://technet.microsoft.com/library/hh580571.aspx)（AX 2012 的 TechNet 内容） |
...
## <a name="set-up-data-exchange-between-microsoft-dynamics-365-retail-and-the-online-store"></a>设置 Microsoft Dynamics 365 Retail 与在线商店之间的数据交换

| 任务                                 | 明细                                                                                                                               | 主题                                                                                                                                                                                                                                                                                  |
|--------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 设置渠道集成模板。 | 模板使零售的组件可以彼此通信。 配置数据交换设置之前设置模板。 | [设置实时服务模板](https://technet.microsoft.com/library/hh580631.aspx)（AX 2012 的 TechNet 内容）[设置渠道模板](https://technet.microsoft.com/library/jj677402.aspx)（AX 2012 的 TechNet 内容） |
