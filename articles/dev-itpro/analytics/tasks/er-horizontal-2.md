...
---
# <a name="run-a-format-that-uses-horizontally-expandable-ranges-to-dynamically-add-columns-in-excel-reports-for-electronic-reporting-er"></a>针对电子申报 (ER) 运行使用可水平扩展的范围在 Excel 报表中动态添加列的格式
