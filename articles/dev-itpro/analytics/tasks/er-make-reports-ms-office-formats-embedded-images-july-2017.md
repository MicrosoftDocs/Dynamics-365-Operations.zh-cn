...
---
# <a name="design-configurations-to-generate-reports-in-microsoft-office-formats-with-embedded-images-for-electronic-reporting-er-part-1"></a>针对电子申报 (ER) 设计配置以生成 Microsoft Office 格式的包含嵌入图像的报表（第 1 部分） 
