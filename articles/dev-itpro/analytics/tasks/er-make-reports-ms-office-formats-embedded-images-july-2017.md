...
---
# <a name="make-reports-in-microsoft-office-formats-with-embedded-images-for-electronic-reporting-er--part-1"></a>针对电子申报 (ER) 创建 Microsoft Office 格式的包含嵌入图像的报表（第 1 部分） 
