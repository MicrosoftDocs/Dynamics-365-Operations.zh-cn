...
| 查看所在公司财务见解 | •   会计师 •    会计经理 •    会计主管 • 审计员 •   预算经理 •    首席执行官 •   首席财务官 •   财务总监  |   • 此职责提供对财务见解的访问。 •  默认情况下，有效公司用作筛选器。 不能添加其他法人。            |
...
用户可使用左侧的**筛选器**窗格筛选报表。 此窗格是通过 Power BI Desktop 提供的同一个窗格。
有各种级别的筛选，其中一些可能不可用，具体取决于您在页面（选项卡）中选择的内容或您是否在使用钻取功能：
...
## <a name="what-is-coming-in-future-releases"></a>将来的版本将有哪些更新？
将继续增强使用 Power BI 的新工作区和财务报表。 下面是正在考虑加入将来的版本中的部分新功能：

 - 复制、编辑、删除和创建视觉对象，甚至财务报表                                                  
 - 更多默认报表                                                                                                            
    - 支持更多子分类帐数据                                                                                            
 - 支持报告币种                                                                                                      
 - 为行和列增加自定义计算                                                                                          
 - 将财务报表导出到 Microsoft Excel                                                                     
   - 导出期间保留财务报表的格式。                                                                          
   - 通过创建数据透视表以使用视觉对象中的信息，在 Excel 中分析数据。                                              
 - 区域设置支持                                                                                                                        
 - 可定义报告层次结构，以便定义可在财务报表中用于设计、筛选和安全设置的主科目层次结构或组织层次结构。                                                                    
 - 支持打印

开展相关工作后，将通过路线图网站传达新功能：https://roadmap.dynamics.com/。
