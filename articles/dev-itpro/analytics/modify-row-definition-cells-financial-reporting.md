...
|-------------------------------|----------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|            （无）             |                                                    |                                                                                                                  清除“格式代码”<strong></strong>单元格。                                                                                                                   |
|              TOT              |                       总计                        |                                         标识在<strong>“相关公式/行/单位”</strong>列中使用数学运算符的行。 汇总包含简单运算符，如 <strong>+</strong> 或 <strong>-</strong>。                                         |
|              CAL              |                    计算                     | 标识“相关的公式/行/单位”<strong></strong>列中使用数学运算符的行。 计算包含复杂运算符，如 <strong>+</strong>、<strong>-</strong>、<strong>\</strong><em>、**/</em><em> 和 **IF/THEN/ELSE</em>* 语句。 |
|              DES              |                    说明                     |                                                                                                             标识报表上的标题行或空行。                                                                                                              |
...
|            BXB BXC            |                     加框行                      |                                                                            围绕以下报表行绘制一个框：从“BXB”<strong></strong>行开始，到“BXC”<strong></strong>行结束。                                                                            |
