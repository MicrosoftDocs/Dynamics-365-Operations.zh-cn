...
在选择如何访问 Dynamics 365 for Finance and Operations 时，中国客户有两个选项。

- 由世纪互联在中国运营的服务 - 世纪互联在中国运营并提供 Dynamics 365 for Finance and Operations 服务。 此选项提供与全球服务同样的一致 Dynamics 365 Finance and Operations 体验。 此选项同时可满足希望使用由在中国境内存储数据的本地公司提供的联机服务的客户的要求。 为了遵守中国法律，这些服务有可能会有所更改。

- 由 Microsoft 运营的服务 - 此选项适用于希望使用 Microsoft 管理和提供的服务的 Dynamics 365 for Finance and Operations 客户。 无论是新客户还是现有客户，只要客户通过企业协议购买了 Microsoft Azure、Dynamics 365 和 Office，Office 365 和/或 Dynamics 365 就可以在租户中共存。
...
-   由于依赖项不可用，以下 **Microsoft Dynamics Lifecycle Services (LCS)** 功能的用户体验将有所不同或者将不可用：
    ...
    -   **服务和支持请求**可以通过 LCS 访问，但世纪互联是服务运营商。 有关详细信息，请参阅[由 21Vianet 在中国运营的 Dynamics 365 Finance and Operations 的支持](../lifecycle-services/21vianet-support.md)。
...
-   [嵌入式 PowerApps](../../fin-and-ops/get-started/embed-power-apps.md) 和与 Microsoft PowerApps 和 Microsoft Flow 的连接将不可用。
...
- [Dynamics 365 for Finance and Operations 支持 - 由世纪互联运营](../lifecycle-services/21vianet-support.md)
