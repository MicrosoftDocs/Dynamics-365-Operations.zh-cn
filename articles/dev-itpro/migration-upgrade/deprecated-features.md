...
## <a name="features-that-have-been-deprecated-in-dynamics-365-for-finance-and-operations-enterprise-edition-july-2017-with-platform-update-8"></a>在具有平台更新 8 的 Dynamics 365 for Finance and Operations Enterprise Edition（2017 年 7 月）中已经弃用的功能
...
|----------------------------------|-------------------------------------------------|
| **弃用原因**       | 重复的功能。                        |
| **被另一个功能取代？** | 是。 此功能已经由 Finance and Operations - Warehousing 取代。 有关设置和先决条件的详细信息，请参阅 [安装和配置 Microsoft Dynamics 365 for Finance and Operations - Warehousing](../../supply-chain/warehousing/install-configure-warehousing-app.md)。 |
| **受影响的模块**             | 仓库管理，运输管理 |
...
## <a name="features-that-have-been-deprecated-in-dynamics-ax-70-releases"></a>在 Dynamics AX 7.0 版本中已弃用的功能
