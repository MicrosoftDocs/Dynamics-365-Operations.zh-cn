---
title: 可折叠模块
description: 本文介绍手风琴模块和如何将其添加到 Microsoft Dynamics 365 Commerce 中的站点页。
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9279148"
---
# <a name="accordion-module"></a>可折叠模块

[!include [banner](includes/banner.md)]

本文介绍手风琴模块和如何将其添加到 Microsoft Dynamics 365 Commerce 中的站点页。
...
1. 在 **选择模块** 对话框中，选择 **手风琴** 模块，然后选择 **确定**。
...
1. 在 **选择模块** 对话框中，选择 **手风琴项** 模块，然后选择 **确定**。
