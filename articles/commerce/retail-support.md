...
本文说明如何获取 Dynamics 365 Commerce 的帮助。

## <a name="contact-support"></a>联系技术支持

如果有与 Commerce 有关的技术问题，请按照本文中的信息联系 Microsoft。

### <a name="commerce-support"></a>商业支持

要获取 Commerce 的支持，请使用下表中的资源。 这些资源按照我们建议你在执行故障排除时应遵守的顺序排列。
...
<tr>
<td>使用问题搜索工具。</td>
<td>在 <a href="https://lcs.dynamics.com/">LCS</a> 中，可使用问题搜索快速搜索报告的问题的 Microsoft 知识库 (KB) 文章、修补程序和解决办法。 可查看正在或已经为特定功能区域修复报告的哪些问题。 有关详细信息，请参阅<a href="https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/lifecycle-services/issue-search-lcs">问题搜索（Lifecycle Services，LCS）</a>。</td>
</tr>
<tr>
<td>使用云助力的支持工具。</td>
