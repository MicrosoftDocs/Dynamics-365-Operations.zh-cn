---
title: 创建新的通讯簿
description: 本文介绍如何在 Microsoft Dynamics 365 Commerce 中创建通讯簿。
author: samjarawan
ms.date: 01/27/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9281473"
---
# <a name="create-new-address-book"></a>创建新的通讯簿

[!include [banner](includes/banner.md)]

本文介绍如何在 Microsoft Dynamics 365 Commerce 中创建新通讯簿。

出于各种原因，会在 Commerce 中使用通讯簿，包括存储渠道的客户列表和员工列表。 通讯簿可以用于单个渠道，也可以在渠道之间共享。

## <a name="create-a-new-address-book"></a>创建新的通讯簿
