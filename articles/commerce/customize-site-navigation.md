---
title: 自定义站点导航
description: 本文介绍如何创建自定义的在线导航层次结构，以便组织产品以在 Microsoft Dynamics 365 Commerce 站点中进行浏览。
...
ms.locfileid: "8863453"
---
# <a name="customize-site-navigation"></a>自定义站点导航

[!include [banner](includes/banner.md)]

本文介绍如何创建自定义的在线导航层次结构，以便组织产品以在 Microsoft Dynamics 365 Commerce 站点中进行浏览。
