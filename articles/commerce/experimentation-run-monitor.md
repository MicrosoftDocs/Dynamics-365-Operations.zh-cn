...
本主题介绍了如何在第三方应用中运行和监视试验，以及如何更改变体（如果需要）。 在完成本主题中的步骤之前，您需要在 Commerce 中[发布](experimentation-preview-publish.md)试验。 下图显示了在 Dynamics 365 Commerce 中的电子商务网站上设置和运行试验所涉及的所有步骤。 其他步骤在单独的主题中介绍。
...
1. 从下拉菜单中选择要更新的变体。
1. 进行所需更改，然后预览和发布变体。 有关详细信息，请参阅[预览和发布试验](experimentation-preview-publish.md)。
