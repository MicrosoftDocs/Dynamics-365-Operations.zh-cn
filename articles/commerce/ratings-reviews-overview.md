...
将在销售点 (POS) 和呼叫中心渠道中显示平均评分信息。 因此，销售助理可将其用于帮助用户做出决定。 评分和评价还可以充当反馈机制，供零售商用于提高产品质量，从而提高销售额。

Dynamics 365 Commerce 中的评分和评价功能是全渠道解决方案，在平台中本机提供。 评分和评价解决方案基于 Microsoft Azure 生成，可提供高度的可伸缩性和可靠性。
