...
ms.locfileid: "6019753"
---
# <a name="learning-catalog-for-dynamics-365-commerce-administrators"></a>Dynamics 365 Commerce 管理员学习目录

您是否需要全天候保持系统和数据的流动、调配和安全？

以下目录的组织方式为从核心知识到具体领域，从最基础到最高级。 如果内容存在多种格式，我们会告知您，这样您就可以选择最符合您的需要的培训格式。 此目录仅包含特定于 Dynamics 365 Commerce 的功能。 有关与其他 Finance and Operations 应用共享的功能的培训，请参阅 [Dynamics 365 Finance 学习目录](../../finance/get-started/learning-catalog-administrator.md)。
