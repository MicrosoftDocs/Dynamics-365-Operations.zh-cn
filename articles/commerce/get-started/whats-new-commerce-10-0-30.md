...
| 见解  |  将销售点 (POS) 操作见解事件流式传输到您的 Application Insights 帐户。 | [在 Application Insights 中访问日志](../dev-itpro/retail-component-events-diagnostics-troubleshooting.md#enable-diagnostic-events-in-application-insights)   |  IT 专业人员/开发人员选择加入   |
