---
title: 标签模块
description: 本文介绍选项卡模块和如何将其添加到 Microsoft Dynamics 365 Commerce 中的站点页。
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8873106"
---
# <a name="tab-module"></a>标签模块

[!include [banner](includes/banner.md)]

本文介绍选项卡模块和如何将其添加到 Microsoft Dynamics 365 Commerce 中的站点页。
