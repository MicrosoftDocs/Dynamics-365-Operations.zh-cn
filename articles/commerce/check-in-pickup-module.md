---
title: 提货模块签入
description: 本文介绍提货登记模块，并说明如何在 Microsoft Dynamics 365 Commerce 中配置此模块。
...
---
# <a name="check-in-for-pickup-module"></a>提货模块签入

[!include [banner](includes/banner.md)]

本文介绍提货登记模块，并说明如何在 Microsoft Dynamics 365 Commerce 中配置此模块。
