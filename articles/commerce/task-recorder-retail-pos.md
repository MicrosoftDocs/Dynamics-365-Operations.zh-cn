...
description: 本文介绍如何在 Retail Modern POS 和 Cloud POS 中使用任务录制器。
author: josaw1
ms.date: 06/19/2017
ms.topic: article
ms.prod: ''
...
本文介绍如何在 Retail Modern POS 和 Cloud POS 中使用任务录制器。
...
1. 单击 **Retail 和 Commerce** &gt; **渠道设置** &gt; **POS 设置** &gt; **收银机**。
2. 单击收银机启用任务录制。
3. 在 **收银机** 选项卡，在 **常规** 快速选项卡，将 **启用任务录制** 选项设置为 **是**。
4. 单击 **保存**。
5. 转到 **Retail 和 Commerce** &gt; **Retail 和 Commerce IT** &gt; **配送计划**。
...
当您在搜索结果中单击任务指南时，可以作为帮助文章查看步骤或将步骤导出到 Word 文档。
