...
本文提供了从 Microsoft Dynamics Lifecycle Services (LCS) 内开发人员虚拟机 (VM) 上的 Microsoft Dynamics 365 Commerce Retail 软件开发套件 (SDK) 中部署德国会计登记服务整合示例的指南。 有关此会计整合示例的详细信息，请参阅[德国会计登记服务整合示例](emea-deu-fi-sample.md)。 
