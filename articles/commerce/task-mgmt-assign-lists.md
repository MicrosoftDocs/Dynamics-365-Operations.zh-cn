---
title: 将任务列表分配给商店或员工
description: 本文介绍如何在 Microsoft Dynamics 365 Commerce 中将任务列表分配给商店或员工。
...
ms.locfileid: "9746186"
---
# <a name="assign-task-lists-to-stores-or-employees"></a>将任务列表分配给商店或员工

[!include [banner](includes/banner.md)]

本文介绍如何在 Microsoft Dynamics 365 Commerce 中将任务列表分配给商店或员工。
...
在开始分配任务的过程之前，确保已按照[创建任务列表并添加任务](task-mgmt-create-lists.md)一文中的步骤创建任务列表。 若要开始分配任务列表流程，请执行以下步骤。
