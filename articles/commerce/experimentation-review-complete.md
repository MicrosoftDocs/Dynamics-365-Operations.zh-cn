...
使用与第三方服务中的试验相关的数据和分析来确定哪种变体产生了最佳结果。 若要将活动站点上的当前内容替换为最佳变体，以供您的网站的所有用户使用，请执行以下操作。 

1. 在站点构建器中，转到**试验**选项卡，然后选择试验。
1. 选择顶部栏上的**完成试验**。
1. 在**完成试验**对话框菜单中，选择**查看试验数据**。 将打开第三方服务，您可以在其中验证指标并确定哪种变体表现最好。
1. 在站点构建器的**完成试验**对话框菜单中，选择最佳变体，然后选择**下一步**。
1. 打开第三方服务并停止试验。
...
虽然不需要在 Commerce 中删除完成的试验，但您可以选择删除它以节省空间或清理工作区。 若要删除试验，请执行以下操作。

1. 在站点构建器中，转到**试验**选项卡，然后选择试验。 
    > [!NOTE]
    > 如果试验仍处于活动状态，请先在第三方服务中停止试验，然后再继续。
1. 在命令栏中选择**取消发布**，以从活动站点中删除变体内容。
1. 在命令栏中选择**删除**以删除试验。
