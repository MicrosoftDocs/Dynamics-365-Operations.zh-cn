---
title: 创建新的产品层次结构
description: 本文介绍如何在 Microsoft Dynamics 365 Commerce 中创建新产品层次结构。
author: samjarawan
ms.date: 01/27/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8887028"
---
# <a name="create-a-new-product-hierarchy"></a>创建新的产品层次结构


[!include [banner](includes/banner.md)]

本文介绍如何在 Microsoft Dynamics 365 Commerce 中创建新产品层次结构。
