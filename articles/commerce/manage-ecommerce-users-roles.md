---
title: 管理电子商务用户和角色
description: 本文介绍如何为用户授予 Microsoft Dynamics 365 Commerce 站点创作环境的访问权限。
...
本文介绍如何为用户授予 Microsoft Dynamics 365 Commerce 站点创作环境的访问权限。
...
在 Commerce 中创建新站点时，系统将请您为 **管理员** 角色提供安全组。 有关此角色授予的权限的概述，请参见本文前面的表。
