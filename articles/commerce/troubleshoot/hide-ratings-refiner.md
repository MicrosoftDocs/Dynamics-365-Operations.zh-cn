...
description: 本文提供有关在未为电子商务站点启用 Microsoft Dynamics 365 Commerce 评分和评价解决方案时如何在搜索结果和类别页面中隐藏评分优化器的故障排除说明。
...
本文提供有关在未为电子商务站点启用 Microsoft Dynamics 365 Commerce 评分和评价解决方案时如何在搜索结果和类别页面中隐藏评分优化器的故障排除说明。
