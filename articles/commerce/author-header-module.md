---
title: 页眉模块
description: 本文介绍页眉模块和如何在 Microsoft Dynamics 365 Commerce 中创建页面页眉。
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8876630"
---
# <a name="header-module"></a>页眉模块

[!include [banner](includes/banner.md)]

本文介绍页眉模块和如何在 Microsoft Dynamics 365 Commerce 中创建页面页眉。
...
1. 在 **选择模块** 对话框中，选择 **Cookie 同意**、**页眉** 和 **促销横幅** 模块，然后选择 **确定**。
...
1. 在 **选择模块** 对话框中，选择 **导航菜单** 模块，然后选择 **确定**。
...
1. 在 **选择模块** 对话框中，选择 **搜索** 模块，然后选择 **确定**。
1. 在搜索模块的属性窗格中，根据需要配置属性。
1. 在标题模块的 **购物车图标** 插槽中，选择省略号 (**...**)，然后选择 **添加模块**。
1. 在 **选择模块** 对话框中，选择 **购物车图标** 模块，然后选择 **确定**。
