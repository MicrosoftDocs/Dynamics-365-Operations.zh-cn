---
title: 考虑 Dynamics 365 Finance 的业务决策者学习目录
description: 查找考虑 Dynamics 365 Finance 的 BDM 和 TDM 的所有培训选项。
author: cstorega
ms.date: 07/27/2020
ms.topic: article
ms.author: cstorega
...
ms.locfileid: "9539629"
---
# <a name="learning-catalog-for-business-decision-makers-considering-dynamics-365-finance"></a>考虑 Dynamics 365 Finance 的业务决策者学习目录
...
| [开始使用 Dynamics 365 Project Operations 中的“费用管理”](/training/modules/get-started-expense-management/) | Dynamics 365 Project Operations 中的“费用管理”模块让组织可以跟踪和管理员工费用。 “费用管理”让您可以存储付款信息，导入信用卡交易并跟踪员工在为组织产生费用时花费的资金。 您还可以使用 Project Operations 设置费用策略、自动化审批以及提供简化的业务流程。 | 自由、自定进度的在线学习路径 | 1 小时 |
