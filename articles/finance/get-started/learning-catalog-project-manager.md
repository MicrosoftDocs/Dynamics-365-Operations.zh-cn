...
| [为公共部门配置 Dynamics 365 Finance](https://docs.microsoft.com/learn/modules/configure-public-sector-dyn365-finance/) | Dynamics 365 Finance 启用对公共部门和私人部门通用的业务流程，例如预算编制、采购、应付帐款和应收帐款任务。 使用公共部门职能可满足为公共部门提供服务的组织的规则、法规和报告要求。 | 自由、自定进度的在线模块 | 1 小时 |
