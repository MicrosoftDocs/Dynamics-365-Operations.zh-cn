...
|--------------|---------------------|-------------------------|----------------|----------------|--------------------|----|----------|-----------|
| 已收到的采购物料的成本 | 140100</br>140101 | 材料库存</br>材料已装运但未开票 | 资产 | 借方 | 是 | P | 已开票的采购物料的成本 | 在过帐采购订单产品收据时使用，帐户抵销科目是未开票的采购支出。 在过帐采购订单发票以后，将自动冲销此帐户中的金额。 |
...
| 产品采购支出 | 600180 | 物料收据 | 支出 | 贷方 | 是 | 周五  | |过帐采购订单发票时使用。 为发票创建了两个凭证，以便在使用标准成本时跟踪采购价格差异。 此帐户抵销科目是采购支出、用于收据过帐且在发票过帐期间冲销的未开票科目。 表示开票时购买的库存的成本，此成本在资产负债表上的库存帐户中未反映。 这是标准成本物料采购中最常见的采购价格差异的损益过帐。|
