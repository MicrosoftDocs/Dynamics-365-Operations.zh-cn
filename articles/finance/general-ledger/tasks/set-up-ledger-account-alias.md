...
1. 转到 **总帐 > 会计科目表 > 科目 > 会计科目别名**，单击 **新建**。
2. 在 **会计科目别名** 字段中，键入一个值。
3. 在 **科目结构** 字段中，选择科目和维度所属的结构。
4. 在列表中的 **公司** 字段中，找到并选择别名适用的公司。
5. 在 **会计科目别名定义** 字段中，指定科目和维度。
    * 在使用快捷方式时，将会填充科目和维度。  
6. 在 **初始焦点** 字段中，选择使用别名时将会出现焦点的维度。
