...
ms.locfileid: "6343878"
---
# <a name="budget-planning"></a>预算计划

[!include [banner](../includes/banner.md)]

此实验室的目的是提供预算计划领域中 Microsoft Dynamics 365 Finance 功能更新的指导性视图。 此实验室的目的是说明预算计划模块的快速配置示例，并显示如何使用此配置完成预算计划。  此实验室专门介绍以下业务流程或任务：
...
*注意：确保选择“另存为”并且选择应存储以便编辑该模板的位置。如果用户在对话框中选择“打开”而不保存，已完成的文件更改在文件关闭时不会保留。* 
...
[![激活。](./media/screenshot28.png)](./media/screenshot28.png)
