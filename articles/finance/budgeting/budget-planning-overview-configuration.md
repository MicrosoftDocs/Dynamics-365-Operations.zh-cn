...
ms.locfileid: "8711734"
---
# <a name="budget-planning-overview"></a>预算计划概览

[!include [banner](../includes/banner.md)]

此主题介绍了预算计划。 其中包含可帮助您配置预算计划和设置预算计划流程的信息。
...
最好的方法是创建预算层次结构每个级别的预算计划工作流。 您然后可以分配包含对应于预算计划工作流的阶段的元素的预算工作流。 在此主题前文中显示的示例架构中，一个预算计划工作流为销售部创建，另一个为总部创建。 预算工作流通过阶段移动预算计划。
