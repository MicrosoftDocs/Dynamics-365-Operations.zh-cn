...
**固定资产参数** 页面上的选项允许您打开或关闭锁定功能。 在 **功能管理工作区** 中启用此功能。
...
**在折旧日记帐中锁定资产帐簿** 参数允许您在折旧日记帐中锁定资产帐簿。 过帐折旧交易时，系统将验证未将同一资产帐簿添加到多个折旧日记帐。 如果有此情况，该资产帐簿将锁定，过帐将停止。 如果资产帐簿 ID 在锁定日记帐中，当完成原始日记帐的过帐后，它将自动解锁。 您也可以手动解锁日记帐。 
