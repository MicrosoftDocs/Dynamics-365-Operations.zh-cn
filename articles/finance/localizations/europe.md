...
- [预付款持有人概览](emea-advance-holders.md)
 ...
 - [给员工的预付款](tasks/advance-payment-employee.md)
- [东欧预付款发票](emea-advance-invoice.md)
- [银行对帐单和付款对帐](emea-bank-reconciliation.md)
...
- ISO20022 文件
  ...
  - [为 ISO20022 银行转帐设置付款方式](tasks/setup-method-payment-iso20022-direct-debit.md)
...
- 增值税 (VAT)
  - [设置增值税 ID](tasks/eur-00015-vat-id.md)
  - [登记供应商增值税 ID](tasks/eur-00015-registration-vendor-vat-id.md)
  - [增值税汇率概述](emea-vat-exchange-rate.md)
