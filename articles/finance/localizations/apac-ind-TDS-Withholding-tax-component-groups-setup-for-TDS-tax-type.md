---
title: 设置 TDS 税务类型的预缴税金组分组
description: 本主题说明如何为从源扣缴税款 (TDS) 税务类型设置预缴税金组分组，如租金和承包商。
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
本主题说明如何为从源扣缴税款 (TDS) 税务类型设置预缴税金组分组，如 **租金** 和 **承包商**。
...
4. 在 **预缴税金组分组** 字段中，为 TDS 组分组输入名称。
5. 在 **描述** 字段中，输入描述。
6. 在 **常规** 快速选项卡上，在 **状态** 字段中，选择 TDS 组分组的居民身份。 选项有 **居民** 和 **非居民**。
7. 在 **地区代码** 字段中，输入应用于 TDS 组分组的地区代码。
8. 关闭该页面。
