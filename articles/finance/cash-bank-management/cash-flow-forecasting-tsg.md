---
title: 现金流预测设置故障排除
description: 本文提供对配置现金流预测时可能有的问题的解答。 可以解决有关现金流设置、现金流更新和现金流 Power BI 的常见问题 (FAQ)。
author: angelad116
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9151392"
---
# <a name="troubleshoot-cash-flow-forecasting-setup"></a>现金流预测设置故障排除

[!include [banner](../includes/banner.md)]

本文提供对配置现金流预测时可能有的问题的解答。 可以解决有关现金流设置、现金流更新和现金流 Power BI 的常见问题 (FAQ)。
