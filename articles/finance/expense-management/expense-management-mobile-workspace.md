...
将此工作区用于与 Dynamics 365 for Unified Ops mobile 应用一起使用。
...
- 拍摄收据照片，并上载到 Dynamics 365 Finance。 你以后可以将该照片附加到支出报表。
...
如果已经为您的组织部署 Finance，系统管理员必须发布**费用管理**移动工作区。 有关说明，请查阅 [发布移动工作区](../../dev-itpro/mobile-apps/publish-mobile-workspace.md)。
