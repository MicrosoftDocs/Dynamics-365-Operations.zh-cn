...
<td><ol>
<li>如果发票行上引用的采购订单行，为采购订单行使用要分配到的科目。</li>
<li>如果在 **供应商发票** 页面的 **交易记录类型** 字段中的 **购置**，在 **固定资产过帐模板** 页中选择 **购置** 时的 **主科目** 字段。</li>
...
<td><ol>
<li>如果发票行上引用的采购订单行，为采购订单行使用要分配到的科目。</li>
<li>如果在 **费用代码** 页面的 **借方类型** 字段中选择了 **会计** 科目，**费用代码** 页的 **借方科目** 字段。</li>
<li>如果在 **费用代码** 页面的 **借方类型** 字段中选择 **物料**，延伸价格的会计分配为采购订单行。</li>
<li>如果在 **费用代码** 页面的 **借方类型** 字段中选择了 **客户/供应商**，**费用代码** 页的 **贷方科目** 字段。</li>
</ol></td>
<td><ol>
<li>如果发票行上引用的采购订单行，为采购订单行使用要分配到的科目。</li>
<li>用于供应商发票行的总价使用来自会计分配的财务维度。</li>
