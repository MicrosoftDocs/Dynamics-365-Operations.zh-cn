...
1. <span data-ttu-id="aa044-107">转到“常规 > 常规 > 会话日期和时间”。</span><span class="sxs-lookup"><span data-stu-id="aa044-107">Go to Common > Common > Session date and time.</span></span>
2. <span data-ttu-id="aa044-108">在“日期”字段中，输入一个日期。</span><span class="sxs-lookup"><span data-stu-id="aa044-108">In the Date field, enter a date.</span></span>
3. <span data-ttu-id="aa044-109">单击“确定”。</span><span class="sxs-lookup"><span data-stu-id="aa044-109">Click OK.</span></span>
