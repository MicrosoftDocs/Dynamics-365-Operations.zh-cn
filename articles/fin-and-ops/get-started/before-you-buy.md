...
若要探索订阅选项，请转到 [Dynamics 365](https://www.microsoft.com/dynamics365/pricing) 定价页。 此页包括若干不同的计划以满足你的组织的需要。
...
Microsoft 云解决方案提供商可以与你密切合作以了解你的公司或组织的需要。 [使用 Microsoft 合作伙伴中心门户查找满足自身需要的合作伙伴](https://partnercenter.microsoft.com/partner/home)。
