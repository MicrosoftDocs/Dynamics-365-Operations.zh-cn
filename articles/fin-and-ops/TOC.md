...
#### [尚未实现的 AX 2012 功能](get-started/ax-2012-features-not-implemented-but-not-deprecated.md)
#### [未在本地部署中实现的功能](get-started/features-not-implemented-on-prem.md)
#### [生命周期策略](../dev-itpro/migration-upgrade/versions-update-policy.md)
#### [平台更新 10（2017 年 8 月）](get-started/whats-new-platform-update-10.md)
#### [Finance and Operations Enterprise Edition（2017 年 7 月）](get-started/whats-new-application-July-2017-update.md)
#### [平台更新 9（2017 年 7 月）](get-started/whats-new-platform-update-9.md)
#### [平台更新 8（2017 年 6 月）](get-started/whats-new-platform-update-8.md)
#### [平台更新 7（2017 年 5 月）](get-started/whats-new-platform-update-7.md)
#### [平台更新 6（2017 年 4 月）](get-started/whats-new-platform-update-6.md)
...
#### [平台更新 3（2016 年 11 月）](get-started/whats-new-platform-update-3.md)
#### [平台更新 2（2016 年 8 月）](get-started/whats-new-platform-update-2.md) 
#### [Dynamics AX 应用程序 7.0.1 版（2016 年 5 月）](get-started/whats-new-changed-application-version-7-0-1-may-2016.md)
#### [平台更新 1（2016 年 5 月）](get-started/whats-new-changed-platform-version-7-1-may-2016.md)
...
##### [创建文档或培训](../dev-itpro/user-interface/task-recorder-training-docs.md)
...
## 成本管理
### Power BI 内容包
#### [成本管理内容包](../dev-itpro/analytics/cost-management-content-pack.md)
### 预先确定的成本
#### [成本计算单](../supply-chain/cost-management/costing-sheets.md)
#### [成本计算版本](../supply-chain/cost-management/costing-versions.md)
#### [通过将成本计算版本用于计划成本来模拟成本变化](../supply-chain/cost-management/simulate-cost-changes-costing-version-planned-costs.md)
...
#### [用于项目控制和项目管理核算的成本类别](../supply-chain/cost-management/cost-categories-used-production-control-project-management-accounting.md)
...
### 标准成本
#### [具有标准成本的物料清单计算](../supply-chain/cost-management/information-used-bom-calculations-standard-costs.md)
...
#### [为新的制造物料更新标准成本](../supply-chain/cost-management/update-standard-costs-new-manufactured-item.md)
...
#### [创建按预算管理的采购订单](../supply-chain/cost-management/tasks/create-purchase-order-governed-by-budget.md)
#### 使用成本计算单计算物料清单
##### [创建成品（仅 2016 年 2 月）](../supply-chain/pim/tasks/create-finished-product-2016-02.md)
##### [创建半成品（仅 2016 年 2 月）](../supply-chain/pim/tasks/create-semi-finished-product-2016-02.md)
##### [创建原材料（仅 2016 年 2 月）](../supply-chain/pim/tasks/create-raw-materials-2016-02.md)
##### [创建物料清单（仅 2016 年 2 月）](../supply-chain/pim/tasks/create-boms-2016-02.md)
##### [创建工艺路线（仅 2016 年 2 月）](../supply-chain/pim/tasks/create-routes-2016-02.md)
##### [通过使用单级结构计算 BOM（仅限 2016 年 2 月）](../supply-chain/cost-management/tasks/calculate-bom-single-level-structure-2016-02.md)
##### [通过使用多级结构计算 BOM（仅限 2016 年 2 月）](../supply-chain/cost-management/tasks/calculate-bom-multilevel-structure-2016-02.md)


## 数据管理和集成

### [数据实体、项目和包](../dev-itpro/data-entities/data-entities.md)
#### [数据实体和包框架](../dev-itpro/data-entities/data-entities-data-packages.md)
...
#### 标准数据实体
##### [数据实体报表](../dev-itpro/data-entities/data-entities-report.md)
##### [数据实体：应付帐款和税](../dev-itpro/data-entities/data-entities-accounts-payable-taxes.md)
##### [数据实体：应收帐款](../dev-itpro/data-entities/data-entities-accounts-receivable.md)
##### [数据实体：银行](../dev-itpro/data-entities/data-entities-bank.md)
##### [数据实体：期初余额](../dev-itpro/data-entities/data-entities-beginning-balances.md)
##### [数据实体：预算计划](../dev-itpro/data-entities/data-entities-budget-plan.md)
##### [数据实体：预算编制](../dev-itpro/data-entities/data-entities-budgeting.md)
##### [数据实体：成本计算](../dev-itpro/data-entities/data-entities-costing.md)
##### [数据实体：费用管理](../dev-itpro/data-entities/data-entities-expense-management.md)
##### [数据实体：固定资产](../dev-itpro/data-entities/data-entities-fixed-assets.md)
##### [数据实体：总帐](../dev-itpro/data-entities/data-entities-general-ledger.md)
##### [数据实体：全球通讯簿](../dev-itpro/data-entities/data-entities-global-address-book.md)
##### [数据实体：人力资源](../dev-itpro/data-entities/data-entities-human-resources.md)
##### [数据实体：库存管理](../dev-itpro/data-entities/data-entities-inventory-management.md)
##### [数据实体：主计划](../dev-itpro/data-entities/data-entities-master-plan.md)
##### [数据实体：采购](../dev-itpro/data-entities/data-entities-procurement-sourcing.md)
##### [数据实体：产品信息管理](../dev-itpro/data-entities/data-entities-product-information-management.md)
##### [数据实体：生产控制](../dev-itpro/data-entities/data-entities-production-control.md)
##### [数据实体：项目会计](../dev-itpro/data-entities/data-entities-project-accounting.md)
##### [数据实体：公共部门](../dev-itpro/data-entities/data-entities-public-sector.md)
##### [数据实体：零售](../dev-itpro/data-entities/data-entities-retail.md)
##### [数据实体：销售和市场营销执行](../dev-itpro/data-entities/data-entities-sales-marketing.md)
##### [数据实体：销售和市场营销售前](../dev-itpro/data-entities/data-entities-sales-marketing-pre-sales.md)
##### [数据实体：系统管理](../dev-itpro/data-entities/data-entities-system-administration.md)
##### [数据实体：工作流](../dev-itpro/data-entities/data-entities-workflow.md)

#### 数据模板
##### [配置数据模板](../dev-itpro/data-entities/configuration-data-templates.md)
###### [在公司间复制配置数据](../dev-itpro/data-entities/copy-configuration.md)

#### [数据导入和导出作业](../dev-itpro/data-entities/data-import-export-job.md)

##### [使用总帐实体导入凭证的最佳实践](../dev-itpro/data-entities/tips-tricks-import-general-journal-entity.md)

#### 数据实体开发
##### [创建新数据实体](../dev-itpro/data-entities/build-consuming-data-entities.md)
##### [数据实体属性](../dev-itpro/data-entities/behavioral-properties-data-entities.md)
##### [创建计算列和虚拟字段](../dev-itpro/data-entities/data-entity-computed-columns-virtual-fields.md)
##### [跨公司行为](../dev-itpro/data-entities/cross-company-behavior.md)
##### [处理国家/地区代码](../dev-itpro/data-entities/countryregion-codes-configuration-keys.md)
##### [继承模式](../dev-itpro/data-entities/support-super-type-sub-type.md)
##### [数据实体向导规则](../dev-itpro/data-entities/data-entity-wizard-rules.md)
##### [元数据属性](../dev-itpro/data-entities/behavioral-properties-data-entities.md)
##### [验证、默认值和未映射的字段](../dev-itpro/data-entities/validations-defaults-unmapped-fields.md)
##### [安全和数据实体](../dev-itpro/data-entities/security-data-entities.md)

### 数据集成
#### [使用数据实体进行数据集成](../dev-itpro/data-entities/data-management-integration-data-entity.md)
##### [开发数据迁移实体](../dev-itpro/data-entities/develop-entity-for-data-migration.md)
##### [开发复合数据实体](../dev-itpro/data-entities/develop-composite-data-entities.md)
##### [配置跨公司财务数据共享](../dev-itpro/data-entities/tasks/configure-financial-cross-company-data-sharing.md)
##### [创建记录模板以加快数据输入](../dev-itpro/data-entities/tasks/create-record-template-facilitate-data-entry.md)
##### [使用记录模板创建新记录](../dev-itpro/data-entities/tasks/use-record-template-new-record.md)
...
##### [查看日记帐分录和交易记录](../financials/general-ledger/view-journal-entries-transactions.md)
...
##### [导入币种汇率](../financials/general-ledger/import-currency-exchange-rates.md)
#### 期间结束关闭
...
#### [会计分配和供应商发票的子分类日记帐分录](../financials/accounts-payable/accounting-distributions-subledger-journal-entries-vendor-invoices.md)
...
#### [生成财务报表](../dev-itpro/analytics/generate-financial-report.md)
...
#### [报表设计器](../dev-itpro/analytics/report-designer-interface.md)

### [成本核算](../financials/cost-accounting/cost-accounting-home-page.md)
#### [开始](../financials/cost-accounting/get-started.md)
##### [成本核算术语](../financials/cost-accounting/terms-cost-accounting.md)
#### [配置基本实体](../financials/cost-accounting/configure-base-entities.md)
##### [货币（网络培训）](https://mbspartner.microsoft.com/AX/CourseModules/1215.md) 
##### [汇率（网络培训）](https://mbspartner.microsoft.com/AX/CourseModules/1215.md) 
##### [会计日历、会计年度和期间](../financials/budgeting/fiscal-calendars-fiscal-years-periods.md)
##### [财务维度](../financials/general-ledger/financial-dimensions.md)
##### [科目结构](../financials/general-ledger/Default-dimensions.md)
##### [创建科目结构（任务指南）](../financials/general-ledger/tasks/create-account-structures.md)
##### [预算编制概览](../financials/budgeting/basic-budgeting-overview-configuration.md)
#### [创建维度并导入维度成员](../financials/cost-accounting/cost-dimension.md) 
##### [成本元素维度](../financials/cost-accounting/cost-elements.md)
##### [创建成本元素（任务指南）](../financials/cost-accounting/tasks/create-cost-elements.md)
##### [成本对象维度](../financials/cost-accounting/cost-objects.md)
##### [创建成本对象（任务指南）](../financials/cost-accounting/tasks/create-cost-objects.md)
##### [将成本元素维度成员映射到一组常用维度成员](../financials/cost-accounting/map-cost-elements-dimension-members.md)
##### [映射成本元素维度（任务指南）](../financials/cost-accounting/tasks/map-cost-element-dimension.md)
...
##### [创建组织报告层次结构（任务指南）](../financials/cost-accounting/tasks/create-an-organization-report-hierarchy.md) 
##### [成本对象控制器的访问权限](../financials/cost-accounting/access-rights-cost-object-controller.md)
##### [配置成本对象控制器的访问权限（任务指南）](../financials/cost-accounting/tasks/configure-access-rights-cost-object-controller.md) 
##### [成本控制移动工作区（视频）](https://youtu.be/imsuTg8rUVk.md)
#### 创建基本设置
##### [定义成本控制单元（任务指南）](../financials/cost-accounting/tasks/define-cost-control-units.md)
##### [创建成本核算分类帐（任务指南）](../financials/cost-accounting/tasks/create-cost-accounting-ledger.md)
##### [统计维度成员和统计度量提供方模板](../financials/cost-accounting/statistical-measure-provider-template.md)
#### [定义分配基础](../financials/cost-accounting/allocation-bases.md)
#### 定义策略
##### [创建成本分摊策略并将其分配到成本控制单元（任务指南）](../financials/cost-accounting/tasks/create-assign-cost-allocation-policy-cost-control-unit.md)
##### [创建成本行为策略并将其分配到成本控制单元（任务指南）](../financials/cost-accounting/tasks/create-assign-cost-behavior-policy-cost-control-unit.md)
##### [创建成本分配策略并将其分配到成本控制单元（任务指南）](../financials/cost-accounting/tasks/create-assign-cost-distribution-policy-cost-control-unit.md)
##### [创建成本累积策略（任务指南）](../financials/cost-accounting/tasks/create-cost-rollup-policy.md)
#### [管理成本核算分类帐的数据源（任务指南）](../financials/cost-accounting/tasks/manage-data-source-cost-accounting-ledger.md)
#### [处理和跟踪源数据（任务指南）](../financials/cost-accounting/tasks/process-trace-source-data.md)
#### 开销计算
...
##### [配置成本控制工作区参数（任务指南）](../financials/cost-accounting/tasks/configure-cost-control-workspace-parameters.md)
##### [使用用于报告的成本控制工作区（视频）](https://youtu.be/imsuTg8rUVk.md)
##### [将条目导出到 Excel（视频）](https://youtu.be/-HKHYdClvx8.md)
##### [使用针对 Microsoft Power BI 报告的内容包](../dev-itpro/analytics/cost-accounting-analysis-content-pack.md)
##### [了解 Microsoft Power BI 中的访问权限列表安全和 RLS](../dev-itpro/analytics/setup-security-cost-accounting-content-pack.md)
...
## [财务申报](../dev-itpro/analytics/financial-reporting-intro.md)
### [生成财务报表](../dev-itpro/analytics/generate-financial-report.md)
### [财务报表组件](../dev-itpro/analytics/financial-report-components.md)
### [报表设计器](../dev-itpro/analytics/report-designer-interface.md)
### [用户首选项](../dev-itpro/analytics/user-preferences-financial-report-designer.md)
### [高级格式选项](../dev-itpro/analytics/advanced-formatting-options-financial-reporting.md)
### [组织报表组件](../dev-itpro/analytics/organize-components-report-designer.md)
### [报表定义](../dev-itpro/analytics/design-financial-report-definitions.md)
### [行定义](../dev-itpro/analytics/row-definitions-financial-reporting.md)
### [列定义](../dev-itpro/analytics/column-definitions-financial-reports.md)
### [修改行定义单元格](../dev-itpro/analytics/modify-row-definition-cells-financial-reporting.md)
### [还原数据库后重置财务申报数据市场](../dev-itpro/analytics/reset-financial-reporting-datamart-after-restore.md)

## [本地化和监管功能](../dev-itpro/lcs-solutions/country-region.md)
### 亚太
#### 澳大利亚
##### [添加报表框并生成澳大利亚营业活动报表 (BAS)](../financials/localizations/tasks/add-bas-report-boxes.md)
...
##### [设置澳大利亚 BAS 的原因代码](../financials/localizations/tasks/set-up-reason-codes-australia-bas.md)
...
#### 马来西亚
##### [生成项目销售的客户贷项（马来西亚）](../financials/localizations/tasks/my-00011-03-customer-credit-note-project-sales.md)
##### [生成项目销售的客户借项（马来西亚）](../financials/localizations/tasks/my-00011-02-customer-debit-note-project-sales-2016-11.md)
##### [商品劳务税](../financials/localizations/apac-mys-gst.md)
##### [GST - 生成所需格式的 GAF 文件（马来西亚）](../financials/localizations/tasks/my-00010-gst-gaf-files-required-format.md)
##### [管理 GST 的客户借项和贷项（马来西亚）](../financials/localizations/tasks/my-00003-manage-customer-debit-note-credit-note-gst.md)
##### [管理 GST 的供应商借项和贷项（马来西亚）](../financials/localizations/tasks/my-00004-manage-vendor-debit-note-credit-note-gst.md)
##### [使用减免条款打印 GST 客户发票（马来西亚）](../financials/localizations/tasks/my-00006-02-print-gst-customer-invoices-relief-clause.md)
##### [打印 GST 税务发票（马来西亚）](../financials/localizations/tasks/my-00005-print-gst-tax-invoices.md)
##### [自用发票（马来西亚）](../financials/localizations/tasks/my-00007-self-billed-invoices.md)
##### [设置 GST 减免条款（马来西亚）](../financials/localizations/tasks/my-00006-01-gst-relief-clauses.md)
#### 新加坡
...
##### [折旧挂起](../financials/localizations/emea-cze-depreciation-suspension-holidays.md)
##### [固定资产折旧](../financials/localizations/emea-cze-fixed-assets-depreciation.md)
##### [半年折旧](../financials/localizations/emea-cze-half-depreciation-fixed-asset-disposal.md)
...
##### [设置电子纳税申报](../dev-itpro/analytics/tasks/setup-electronic-tax-declaration-germany.md)
...
###### [预缴税金（巴西）](../financials/localizations/tasks/br-00009-brazilian-withholding-taxes.md)
...
###### [销售报价单中的税金（巴西）](../financials/localizations/tasks/br-00057-brazilian-taxes-sales-quotation.md)
...
###### [为 GST 税设置调整代码](../financials/localizations/tasks/br-10001-1-set-up-adjustment-codes-icms-tax.md)
...
## [智能](../dev-itpro/analytics/bi-reporting-home-page.md)
### [信息访问和报告](../dev-itpro/analytics/information-access-reporting.md)
### [Power BI 内容](../dev-itpro/analytics/power-bi-home-page.md)
#### [实际与预算](../dev-itpro/analytics/ledger-budgets-power-bi.md)
#### [福利](../dev-itpro/analytics/benefits-power-bi.md)
#### [现金概览](../financials/cash-bank-management/Cash-Overview-Power-BI-content.md)
#### [CFO 概览](../dev-itpro/analytics/CFO-power-bi.md)
#### [薪酬](../dev-itpro/analytics/compensation-power-bi.md)
#### [薪酬福利](../dev-itpro/analytics/compensation-and-benefits-analysis-power-bi-content-pack.md)
#### [成本核算分析](../dev-itpro/analytics/cost-accounting-analysis-content-pack.md)
##### [成本核算分析的安全](../dev-itpro/analytics/setup-security-cost-accounting-content-pack.md)
#### [成本管理](../dev-itpro/analytics/cost-management-content-pack.md)
#### [信用和收款管理](../financials/accounts-receivable/credit-collections-power-bi.md)
#### [员工能力和发展](../dev-itpro/analytics/employee-competencies-and-development-analysis-power-bi-content-pack.md)
#### [员工发展](../dev-itpro/analytics/employee-development-PBI.md) 
#### [财务绩效](../dev-itpro/analytics/financial-performance-power-bi-content-pack.md)
#### [固定资产管理](../financials/fixed-assets/Fixed-asset-management-workspace.md)
#### [学习](../dev-itpro/analytics/learning-power-bi.md)
#### [组织培训](../dev-itpro/analytics/organizational-training-analysis-power-bi-content-pack.md)
#### [实践经理](../dev-itpro/analytics/practice-manager-power-bi.md)
#### [生产绩效](../dev-itpro/analytics/production-performance-power-bi.md)
#### [采购花费分析](../dev-itpro/analytics/purchase-content-pack-for-power-bi.md)
#### [招聘](../dev-itpro/analytics/recruiting-analysis-power-bi-content-pack.md)
#### [零售渠道绩效 ](../dev-itpro/analytics/retail-channel-performance-dashboard-power-bi-data.md)
#### [销售和收益率绩效](../dev-itpro/analytics/sales-profitability-performance-content-pack.md)
#### [供应商付款](../financials/accounts-payable/Vendor-payments-workspace.md)
#### [仓库性能](../dev-itpro/analytics/warehouse-power-bi-content.md)
...
##### [将文档路线选择代理作为 Windows 服务运行](../dev-itpro/analytics/run-document-routing-agent-as-windows-service.md)
#### [帮助防止长时间运行的报表超时](../dev-itpro/analytics/prevent-long-running-reports-timing-out.md)
#### [SQL Server Reporting Services 报表的列表](../dev-itpro/analytics/SSRS-report.md)
#### [创建报告解决方案](../dev-itpro/analytics/create-nextgen-reporting-solutions.md)
#### [安装报表设计模板](../dev-itpro/analytics/install-modern-report-design-templates.md)
#### [扩展报表菜单项 ](../dev-itpro/analytics/extend-report-menu-items.md)
#### [自定义设计方案业务文档 ](../dev-itpro/analytics/custom-designs-business-docs.md)


### [电子申报](../dev-itpro/analytics/general-electronic-reporting.md)
#### [管理配置生命周期](../dev-itpro/analytics/general-electronic-reporting-manage-configuration-lifecycle.md)
#### [创建配置](../dev-itpro/analytics/electronic-reporting-configuration.md)
#### [配置电子申报框架](../dev-itpro/analytics/electronic-reporting-er-configure-parameters.md)
#### [从 Lifecycle Services 下载配置](../dev-itpro/analytics/download-electronic-reporting-configuration-lcs.md)
#### [导入电子申报配置](../dev-itpro/analytics/electronic-reporting-import-ger-configurations.md)
#### [扩展电子申报功能](../dev-itpro/analytics/general-electronic-reporting-formulas-list-extension.md)
#### [电子申报中的配方设计器](../dev-itpro/analytics/general-electronic-reporting-formula-designer.md)
#### [业务文档中使用电子申报工具生成的嵌入图像和形状](../dev-itpro/analytics/electronic-reporting-embed-images-shapes.md)
#### [通过重新应用 Microsoft Excel 模板修改电子申报格式](../dev-itpro/analytics/modify-electronic-reporting-format-reapply-excel-template.md)
#### [目标](../dev-itpro/analytics/electronic-reporting-destinations.md)
#### [利用 Power BI 设置电子申报](../dev-itpro/analytics/general-electronic-reporting-report-configuration-get-data-powerbi.md)
#### [使用电子申报工具生成电子文档并更新申请表数据](../dev-itpro/analytics/generate-electronic-documents-update-application-data.md)
#### 电子申报任务
##### [针对电子申报创建一个配置提供程序，并标记其为当前运行的](../dev-itpro/analytics/tasks/er-configuration-provider-mark-it-active-2016-11.md)
##### [针对电子申报从其他组件定义配置的依赖项](../dev-itpro/analytics/tasks/er-define-dependency-er-configurations-from-other-components-july-2017.md)
##### [针对电子申报定义模型映射并选择数据源](../dev-itpro/analytics/tasks/er-define-model-mapping-select-data-sources-2016-11.md)
##### [针对电子申报设计用于生成 Microsoft Word 格式的报表的配置](../dev-itpro/analytics/tasks/er-design-configuration-word-2016-11.md)
##### [针对电子申报设计特定于域的数据模型](../dev-itpro/analytics/tasks/er-design-domain-specific-data-model-2016-11.md)
##### [针对电子申报设计用于生成 OpenXML 格式的报表的配置](../dev-itpro/analytics/tasks/er-design-reports-openxml-2016-11.md)
##### [针对电子申报配置目标](../dev-itpro/analytics/tasks/er-destinations-2016-11.md)
##### [针对电子申报为数据模型做好在格式输出中使用票据管理文件的准备](../dev-itpro/analytics/tasks/er-document-management-files-1.md)
##### [针对电子申报将数据模型扩展为在格式输出中使用票据管理文件](../dev-itpro/analytics/tasks/er-document-management-files-2.md)
##### [针对电子申报创建在格式输出中使用票据管理文件的格式](../dev-itpro/analytics/tasks/er-document-management-files-3.md)
##### [针对电子申报运行在格式输出中使用票据管理文件的格式](../dev-itpro/analytics/tasks/er-document-management-files-4.md)
##### [针对电子申报修改和运行在格式输出中使用票据管理文件的格式](../dev-itpro/analytics/tasks/er-document-management-files-5.md)
##### [针对电子申报使用格式配置生成付款的电子单据](../dev-itpro/analytics/tasks/er-electronic-payments.md)
##### [针对电子申报将数据模型设计为使用财务维度作为数据源](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-1.md)
##### [针对电子申报将模型映射为使用财务维度作为数据源](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-2.md)
##### [针对电子申报将报表设计为使用财务维度作为数据源](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-3.md)
##### [针对电子申报运行使用财务维度作为数据源的报表](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-4.md)
##### [针对电子申报创建格式配置](../dev-itpro/analytics/tasks/er-format-configuration-2016-11.md)
##### [针对电子申报创建用于盘点和合计的格式](../dev-itpro/analytics/tasks/er-format-counting-summing-1.md)
##### [针对电子申报配置计算以执行盘点和合计](../dev-itpro/analytics/tasks/er-format-counting-summing-2.md)
##### [针对电子申报使用计算以生成用于盘点和合计的输出](../dev-itpro/analytics/tasks/er-format-counting-summing-3.md)
##### [针对电子申报运行执行盘点和合计的格式](../dev-itpro/analytics/tasks/er-format-counting-summing-4.md)
##### [针对电子申报导入配置以生成包含申请表数据更新的文档](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-1-import-configurations.md)
##### [针对电子申报生成包含申请表数据更新的文档](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-2-generate-documents.md)
##### [针对电子申报修改模型和映射以生成包含申请表数据更新的文档](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-3-modify-model-mapping.md)
##### [针对电子申报修改可生成包含申请表数据更新的文档的格式](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-4-modify-format.md)
##### [针对电子申报生成包含申请表数据更新的文档](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-5-generate-documents-application-data-update.md)
##### [针对电子申报设计用于使用可水平扩展的范围在 Excel 报表中动态添加列的格式](../dev-itpro/analytics/tasks/er-horizontal-1.md)
##### [针对电子申报运行使用可水平扩展的范围在 Excel 报表中动态添加列的格式](../dev-itpro/analytics/tasks/er-horizontal-2.md)
##### [针对电子申报从 Lifecycle Services 导入配置](../dev-itpro/analytics/tasks/er-import-configuration-lifecycle-services.md)
##### [针对电子申报创建 Microsoft Office 格式的包含嵌入图像的报表（第 1 部分.md）](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md)
##### [针对电子申报检查配置以创建 Microsoft Office 格式的包含嵌入图像的报表](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-2-review-configurations.md)
##### [针对电子申报生成 Microsoft Office 格式的包含嵌入图像的报表](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-3-generate-reports.md)
##### [针对电子申报管理模型映射配置](../dev-itpro/analytics/tasks/er-manage-model-mapping-configurations-july-2017.md)
##### [针对电子申报将已创建格式的组件映射到数据模型元素](../dev-itpro/analytics/tasks/er-map-components-data-model-elements--2016-11.md)
##### [针对电子申报将数据模型映射到所选的数据源](../dev-itpro/analytics/tasks/er-map-data-model-selected-data-sources-2016-11.md)
##### [针对电子申报通过重新应用 Microsoft Excel 模板修改格式](../dev-itpro/analytics/tasks/er-modify-format-by-reapplying-microsoft-excel-template-july-2017.md)
...
#### [将实体导出到您自己的 Azure SQL 数据库](../dev-itpro/analytics/export-entities-to-your-own-database.md)
...
#### [创建新仓库布局（任务指南）](../supply-chain/inventory/tasks/create-new-warehouse-layout.md)
#### [维护条码类型（任务指南）](../supply-chain/inventory/tasks/maintain-barcode-types.md)
### 库存操作
#### [检查存货可用性（任务指南）](../supply-chain/inventory/tasks/check-availability-stock.md)
#### [初始化仓库中的存货级别（任务指南）](../supply-chain/inventory/tasks/initialize-stock-levels-warehouse.md)
#### [转移仓库内的实际库存（任务指南）](../supply-chain/inventory/tasks/transfer-physical-inventory-within-warehouse.md)
#### [调整仓库中的存货级别（基本仓库.md）（任务指南）](../supply-chain/inventory/tasks/adjust-stock-levels-warehouse-basic-warehousing.md)
#### [创建和维护库存锁定（任务指南）](../supply-chain/inventory/tasks/create-maintain-inventory-blocking.md)
### 库存盘点
#### [盘点仓库中的库存（任务指南）](../supply-chain/inventory/tasks/count-inventory-warehouse.md)
#### [定义库存盘点流程（任务指南）](../supply-chain/inventory/tasks/define-inventory-counting-processes.md)
### 托运库存
#### [托运](../supply-chain/inventory/consignment.md)
#### [设置托运](../supply-chain/inventory/set-up-consignment.md)
#### [根据生产需求更改托运库存的所有权（任务指南）](../supply-chain/inventory/tasks/change-ownership-consignment.md)
#### [创建托运补货订单（任务指南）](../supply-chain/inventory/tasks/create-consignment-replenishment-order.md)
#### [使用供应商协作监控托运库存（任务指南）](../supply-chain/inventory/tasks/monitor-consignment-inventory-vendor-collaboration.md)
### 质量管理
...
#### [创建和处理符合项（任务指南）](../supply-chain/inventory/tasks/create-process-non-conformance.md)
#### [检查货物的质量（任务指南）](../supply-chain/inventory/tasks/inspect-quality-goods.md)
#### [设置管理先决条件（任务指南）](../supply-chain/inventory/tasks/set-up-prerequisites-nonconformance-management.md)
#### [设置质检订单（任务指南）](../supply-chain/inventory/tasks/set-up-quality-orders.md)
### 物料跟踪维度
#### [更正库存跟踪信息（任务指南）](../supply-chain/inventory/tasks/correct-inventory-tracking-information.md)
#### [合并库存批次](../supply-chain/inventory/merge-inventory-batches.md)
#### [跟踪物料和原材料](../supply-chain/inventory/trace-items-raw-materials-inventory-production-sales.md)
#### [在销售流程中登记序列号](../supply-chain/sales-marketing/register-serial-numbers-sales-process.md)
#### [跟踪物料或原材料（任务指南）](../supply-chain/inventory/tasks/trace-item-or-raw-material.md)
...
##### [通过提领看板补货](../supply-chain/warehousing/material-replenishment-withdrawal-kanban.md)
...
#### 升级和迁移
##### [将仓库管理流程从 AX 2012 升级到 Finance and Operations](../supply-chain/warehousing/upgrade-migration-warehouse-management-processes.md)
...
## 主计划
### 创建需求预测
#### [需求预测概览](../supply-chain/master-planning/introduction-demand-forecasting.md)
...
#### [从历史交易记录数据中删除离群值](../supply-chain/master-planning/remove-historical-outliers-calculating-demand-forecast.md)
...
### [移动工作区](../dev-itpro/mobile-apps/mobile-workspaces-released.md)
#### [公司目录](../dev-itpro/mobile-apps/company-directory-mobile-workspace.md)
...
#### [发票审核](../dev-itpro/mobile-apps/invoice-approval-mobile-workspace.md)
#### [我的团队](../dev-itpro/mobile-apps/manager-self-service-mobile-workspace.md)
...
### [发布移动工作区](../dev-itpro/mobile-apps/publish-mobile-workspace.md)


## [Office 集成](../dev-itpro/office-integration/office-integration.md)
### [Office 集成教程](../dev-itpro/office-integration/office-integration-tutorial.md)
### [使用 Excel 加载项](../dev-itpro/office-integration/use-excel-add-in.md)
### [创建“在 Excel 中打开”体验](../dev-itpro/office-integration/office-integration-edit-excel.md)
### [将模板添加到“在 Excel 中打开行”菜单](../dev-itpro/user-interface/add-templates-open-lines-excel-menu.md)
### [自定义“在 Microsoft Office 中打开”菜单](../dev-itpro/office-integration/customize-open-office-menu.md)
### [配置和发送电子邮件](organization-administration/configure-email.md)
### [Office 集成故障排除](../dev-itpro/office-integration/office-integration-troubleshooting.md)
...
##### [使用供应商门户与供应商协作](../supply-chain/procurement/collaborate-vendors-vendor-portal.md)
##### [供应商协作移动工作区](../supply-chain/procurement/vendor-collaboration-mobile-workspace.md)
##### [供应商门户用户安全](../supply-chain/procurement/configure-security-vendor-portal-users.md)
...
#### [创建记录模板](../dev-itpro/data-entities/tasks/create-record-template-facilitate-data-entry.md)
#### [使用记录模板创建新记录](../dev-itpro/data-entities/tasks/use-record-template-new-record.md)
...
## 生产
### [生产流程概览](../supply-chain/production-control/production-process-overview.md)
...
##### [仓库工作策略](../supply-chain/warehousing/warehouse-work-policies.md)
#### 计划生产工序
##### [工序级排产](../supply-chain/production-control/operations-scheduling.md)
##### [作业级排产](../supply-chain/production-control/job-scheduling.md)
##### [用于作业级排产的甘特图](../supply-chain/production-control/visual-scheduling-production.md)
##### [工序级排产选项](../supply-chain/production-control/operation-scheduling-options.md)
#### 执行生产作业
...
##### [反转生产订单状态](../supply-chain/production-control/reverse-production-order-status.md)
...
### 精益生产 
#### [精益生产概览](../supply-chain/production-control/lean-manufacturing-overview.md)
...
##### [运营资源](../supply-chain/production-control/operations-resources.md)
#### 计划看板作业
##### [用于精益生产的可视排产](../supply-chain/production-control/visual-scheduling-lean-manufacturing.md)
##### [用于精益生产的看板作业级排产](../supply-chain/production-control/lean-manufacturing-kanban-job-scheduling.md)
##### [作业级排产](../supply-chain/production-control/job-scheduling.md)
#### 执行看板作业
...
##### [转移具有看板作业的物料（仅 2016 年 2 月）](../supply-chain/production-control/tasks/transfer-materials-kanban-jobs.md)
...
##### [创建精益生产的转包工作单元](../supply-chain/production-control/tasks/create-subcontracted-work-cell-lean-manufacturing.md)
...
##### [使用工序级和作业级排产计划生产订单](../supply-chain/production-control/tasks/schedule-production-order-operations-job-scheduling.md)
...
##### [使用类别层次结构分类产品](../supply-chain/pim/tasks/classify-product-category-hierarchies.md)
...
##### [报告为已完工入库到非牌照控制的库位](../supply-chain/production-control/tasks/report-finished-non-license-plate-controlled-location-2016-11.md)
...
##### [管理度量单位（任务指南）](../supply-chain/pim/tasks/manage-unit-measure.md)


## [产品信息管理](../supply-chain/pim/product-information.md)
### 产品信息
#### 产品类别
##### [创建产品分类的层次结构（任务指南）](../supply-chain/pim/tasks/create-hierarchy-product-classification.md)
##### [使用类别层次结构分类产品（任务指南）](../supply-chain/pim/tasks/classify-product-category-hierarchies.md)
#### 产品定义
##### [产品编号命名法](../supply-chain/pim/product-variant-identification-nomenclature.md)
##### [为预定义的产品变型创建产品编号命名法（任务指南）](../supply-chain/pim/tasks/create-product-number-nomenclature-predefined-variants-2016-11.md)
##### [为配置的产品变型创建产品编号命名法（任务指南）](../supply-chain/pim/tasks/create-product-number-nomenclature-product-variants_2016_11.md)
##### [创建新产品（任务指南）](../supply-chain/pim/tasks/create-new-product.md)
...
##### [向产品添加图像（任务指南）](../supply-chain/pim/tasks/add-image-product.md)
##### [产品信息翻译常见问题](../supply-chain/pim/translations-product-related-information.md)
#### 搜索产品 
##### [在订单输入期间搜索产品](../supply-chain/pim/search-products-product-variants.md)
#### 准备用于计划订单的产品 
...
##### [使用可变权重将变型产品添加到采购订单（任务指南）](../supply-chain/pim/tasks/add-variant-products-purchase-order-variant-weights.md)
##### [创建可配置产品的销售订单（任务指南）](../supply-chain/pim/tasks/create-sales-order-configurable-product.md)
##### [创建销售价选择条件（任务指南）](../supply-chain/pim/tasks/create-sales-price-selection-criteria.md)
##### [为可配置产品设置基于属性的定价（任务指南）](../supply-chain/pim/tasks/set-up-attribute-based-pricing-configurable-products.md)
#### 估计产品成本
##### [物料清单计算](../supply-chain/cost-management/bom-calculations.md)
### 产品配置模型
#### [生成产品配置模型](../supply-chain/pim/build-product-configuration-model.md)
#### [创建基于维度的配置](../supply-chain/pim/dimension-based-product-configuration.md) 
##### [产品维度](../supply-chain/pim/product-dimensions.md)
##### [基于维度的配置](../supply-chain/pim/dimension-based-product-configuration.md)
##### [创建基于维度的基础产品（任务指南）](../supply-chain/pim/tasks/create-dimension-based-product-master.md)
##### [发布基于维度的基础产品（任务指南）](../supply-chain/pim/tasks/release-dimension-based-product-master.md)
##### [完成已发布基础产品的基本设置（任务指南）](../supply-chain/pim/tasks/complete-basic-setup-released-product-master.md)
##### [定义配置组（任务指南）](../supply-chain/pim/tasks/define-configuration-groups.md)
##### [创建基于维度的基础产品的物料清单（任务指南）](../supply-chain/pim/tasks/create-bill-materials-dimension-based-product-master.md)
##### [定义配置工艺路线（任务指南）](../supply-chain/pim/tasks/define-configuration-route.md)
##### [创建配置规则（任务指南）](../supply-chain/pim/tasks/create-configuration-rules.md)
##### [创建基于维度的配置（任务指南）](../supply-chain/pim/tasks/create-dimension-based-configurations.md)
#### 创建基于约束的配置
...
##### [设置配置模型](../supply-chain/pim/set-up-maintain-product-configuration-model.md)
##### [系统定义和用户定义的表约束](../supply-chain/pim/system-defined-user-defined-table-constraints.md)
##### [创建产品模型组件（任务指南）](../supply-chain/pim/tasks/create-product-model-components.md)
##### [创建产品配置模型（任务指南）](../supply-chain/pim/tasks/create-product-configuration-model.md)
##### [将表达式约束添加到产品配置模型（任务指南）](../supply-chain/pim/tasks/add-expression-constraint-product-configuration-model.md)
##### [将计算添加到产品配置模型（任务指南）](../supply-chain/pim/tasks/add-calculation-product-configuration-model.md)
##### [维护产品配置模型的物料清单（任务指南）](../supply-chain/pim/tasks/maintain-bom-product-configuration-model.md)
##### [维护产品模型的工艺路线（任务指南）](../supply-chain/pim/tasks/maintain-route-product-model.md)
##### [审核产品配置模型（任务指南）](../supply-chain/pim/tasks/approve-product-configuration-model.md)
##### [转移产品模型的数据（任务指南）](../supply-chain/pim/tasks/transfer-data-product-models.md)
