...
##### [适用于 Dynamics 365 的 Microsoft FastTrack](get-started/fasttrack-dynamics-365-overview.md)
...
##### [通过使用多级结构计算物料清单（仅 2016 年 2 月）](../supply-chain/cost-management/tasks/calculate-bom-multilevel-structure-2016-02.md)
...
#### [含标准成本的物料清单计算](../supply-chain/cost-management/information-used-bom-calculations-standard-costs.md)
#### [更新制造环境中的标准成本](../supply-chain/cost-management/update-standard-costs-manufacturing-environment.md)
#### [更新新制造物料的标准成本](../supply-chain/cost-management/update-standard-costs-new-manufactured-item.md)
...
##### [配置数据包（仅 2017 年 7 月版本）](../dev-itpro/data-entities/configuration-data-packages.md)
#### [配置数据模板](../dev-itpro/data-entities/configuration-data-templates.md)

#### [跟踪实体更改](../dev-itpro/data-entities/entity-change-track.md)
#### [查找有关标准数据实体的信息](../dev-itpro/data-entities/data-entities-report.md)
...
#### [财务见解](../dev-itpro/analytics/financial-insights.md)
...
##### [针对电子申报 (ER) 设计配置以生成 Microsoft Office 格式的包含嵌入图像的报表（第 1 部分）](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md)
...
#### [分析传入的文档以更新应用程序数据](../dev-itpro/analytics/parse-incoming-electronic-documents.md)
#### [分析 CSV 格式的传入文档](../dev-itpro/analytics/parse-incoming-electronic-documents-csv-format.md)

##### [针对 Application update 7.3 的电子申报框架 API 更改](../dev-itpro/analytics/er-apis-app73.md)
