...
# <a name="general-journal-processing"></a><span data-ttu-id="43612-103">普通日记帐处理</span><span class="sxs-lookup"><span data-stu-id="43612-103">General journal processing</span></span>

[!include [banner](../includes/banner.md)]

<span data-ttu-id="43612-104">本文介绍 Microsoft Dynamics 365 for Finance and Operations 中可以帮助使日记帐处理更加轻松以及帮助确保获取正确数据且不影响内部控制的功能。</span><span class="sxs-lookup"><span data-stu-id="43612-104">This articles describes capabilities in Microsoft Dynamics 365 for Finance and Operations that can help make general journal processing easier, and that can also help guarantee that correct data is captured and internal control isn't compromised.</span></span>  

<span data-ttu-id="43612-105">日记帐名称</span><span class="sxs-lookup"><span data-stu-id="43612-105">Journal names</span></span>
...
-   <span data-ttu-id="43612-113">**日记帐控制** - 您可以设置对公司和科目类型的限制以及对科目段值的限制。</span><span class="sxs-lookup"><span data-stu-id="43612-113">**Journal control** – You can set up restrictions on the company and account type, and also the segment values.</span></span> 
...
### <a name="main-account"></a><span data-ttu-id="43612-130">主科目</span><span class="sxs-lookup"><span data-stu-id="43612-130">Main account</span></span>

<span data-ttu-id="43612-131">主科目设置为普通日记帐处理提供了很多选项：</span><span class="sxs-lookup"><span data-stu-id="43612-131">The main account setup provides many options for general journal processing:</span></span>

-   <span data-ttu-id="43612-132">**DC/CR 需求** - 如果主科目被限制到借方或贷方交易记录，则使用此选项。</span><span class="sxs-lookup"><span data-stu-id="43612-132">**DC/CR requirement** – Use this option if a main account is limited to debit or credit transactions.</span></span> <span data-ttu-id="43612-133">该设置在验证或过帐日记帐时验证。</span><span class="sxs-lookup"><span data-stu-id="43612-133">The setup is verified when a journal is validated or posted.</span></span>
-   <span data-ttu-id="43612-134">**默认对方科目**</span><span class="sxs-lookup"><span data-stu-id="43612-134">**Default offset account**</span></span>
-   <span data-ttu-id="43612-135">**暂停** - 在所有公司或为特定公司/法人暂停数据输入的主科目。</span><span class="sxs-lookup"><span data-stu-id="43612-135">**Suspended** – Suspend a main account for data entry across all companies or for a specific company/legal entities.</span></span>
-   <span data-ttu-id="43612-136">**不允许手动输入** - 防止用户为日记帐中的科目手动输入值。</span><span class="sxs-lookup"><span data-stu-id="43612-136">**Do not allow manual entry** – Prevent users from manually entering a value for the account in journals.</span></span>
...
### <a name="accounting-structures-and-advanced-rules-structures"></a><span data-ttu-id="43612-145">科目结构和高级规则结构</span><span class="sxs-lookup"><span data-stu-id="43612-145">Accounting structures and advanced rules structures</span></span>

<span data-ttu-id="43612-146">科目结构和高级规则结构对于确保在一般日记帐处理和任何单据化期间捕获财务报告所需的数据以及绩效跟踪极其重要。</span><span class="sxs-lookup"><span data-stu-id="43612-146">Accounting structures and advanced rules structures are extremely important for guaranteeing that the data that is required for financial reporting and performance tracking is captured during general journal processing and any documentation.</span></span> <span data-ttu-id="43612-147">科目结构和高级规则结构可让您定制数据输入体验。</span><span class="sxs-lookup"><span data-stu-id="43612-147">Accounting structures and advanced rules structures let you tailor the data entry experience.</span></span> <span data-ttu-id="43612-148">您可以仅对在所有情况下都相关的财务维度允许数据输入，还可以强制实施“始终捕获必需和正确的数据”这一要求。</span><span class="sxs-lookup"><span data-stu-id="43612-148">You can allow data entry only for financial dimensions that are relevant in each situation, and can also enforce the requirement that mandatory and correct data always be captured.</span></span>

<span data-ttu-id="43612-149">有关详细信息，请参阅以下主题：</span><span class="sxs-lookup"><span data-stu-id="43612-149">For more information, see the following topics:</span></span>
- <span data-ttu-id="43612-150">[计划：会计科目表](plan-chart-of-accounts.md)。</span><span class="sxs-lookup"><span data-stu-id="43612-150">[Planning: Chart of accounts](plan-chart-of-accounts.md).</span></span> 
- [<span data-ttu-id="43612-151">创建日记帐高级规则</span><span class="sxs-lookup"><span data-stu-id="43612-151">Create advanced rules for journals</span></span>](tasks/create-advanced-rules-journals.md)
- [<span data-ttu-id="43612-152">使用模板创建日记帐条目</span><span class="sxs-lookup"><span data-stu-id="43612-152">Create a journal entry using a template</span></span>](tasks/create-journal-entry-template.md)
- [<span data-ttu-id="43612-153">创建和验证日记帐</span><span class="sxs-lookup"><span data-stu-id="43612-153">Create and validate journals</span></span>](tasks/create-validate-journals.md)
- [<span data-ttu-id="43612-154">过帐期间日记帐</span><span class="sxs-lookup"><span data-stu-id="43612-154">Post periodic journals</span></span>](tasks/post-periodic-journals.md)
- [<span data-ttu-id="43612-155">处理分类帐分配日记帐</span><span class="sxs-lookup"><span data-stu-id="43612-155">Process ledger allocation journal</span></span>](tasks/process-ledger-allocation-journal.md)
