...
# <a name="add-new-location-roles-and-party-relationship-types"></a>添加新位置角色和当事方关系类型 

## <a name="add-new-location-roles"></a>查看新位置角色
...
## <a name="add-new-party-relationship-types"></a>添加新当事方关系类型 
