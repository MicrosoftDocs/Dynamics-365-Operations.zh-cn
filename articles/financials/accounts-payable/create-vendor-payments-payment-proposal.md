...
- <strong>发票总和的付款</strong> – 如果<strong>删除负付款</strong>选项设置为<strong>是</strong>，且供应商存在未结发票和付款的付款，则为付款同时选择未结发票和付款，并且金额一同添加以生成总计付款金额。 仅在总计导致退款时出现异常。 在这种情况下，发票和付款均不选择。 如果<strong>删除负付款</strong>选项设置为**否**，不结算发票和付款，为付款同时选择未结发票和付款，并且金额一同添加以生成总计付款金额。
