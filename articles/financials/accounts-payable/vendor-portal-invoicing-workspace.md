...
<span data-ttu-id="5ac76-105">**供应商协作开票**工作区可用于查看供应商发票信息和使用工作流功能提交发票至 Microsoft Dynamics 365 for Finance and Operations。</span><span class="sxs-lookup"><span data-stu-id="5ac76-105">The **Vendor collaboration invoicing** workspace can be used to view vendor invoice information and to submit invoices to Microsoft Dynamics 365 for Finance and Operations using workflow capabilities.</span></span>


<a name="vendor-collaboration-invoicing-workspace"></a><span data-ttu-id="5ac76-106">供应商协作开票工作区</span><span class="sxs-lookup"><span data-stu-id="5ac76-106">Vendor collaboration invoicing workspace</span></span>
----------------------------------------

### <a name="summary-tiles"></a><span data-ttu-id="5ac76-107">汇总磁贴</span><span class="sxs-lookup"><span data-stu-id="5ac76-107">Summary tiles</span></span>

<span data-ttu-id="5ac76-108">**汇总**磁贴提供了所选供应商的发票概览。</span><span class="sxs-lookup"><span data-stu-id="5ac76-108">The **Summary** tiles give an overview of the invoices for the selected vendor.</span></span> <span data-ttu-id="5ac76-109">您可以按其状态查看发票。</span><span class="sxs-lookup"><span data-stu-id="5ac76-109">You can view invoices by their state.</span></span>
-   <span data-ttu-id="5ac76-110">草稿发票尚未提交到工作流。</span><span class="sxs-lookup"><span data-stu-id="5ac76-110">Draft invoices have not been submitted to workflow.</span></span>
-   <span data-ttu-id="5ac76-111">已提交但未审核的发票为供应商已经提交，但未在 Finance and Operations 中过帐的发票。</span><span class="sxs-lookup"><span data-stu-id="5ac76-111">Submitted, not approved invoices are those invoices that the vendor has submitted, but they have not been posted in Finance and Operations.</span></span>
-   <span data-ttu-id="5ac76-112">已审核但未付款的发票为已经在 Finance and Operations 中过帐但尚未付清的发票。</span><span class="sxs-lookup"><span data-stu-id="5ac76-112">Approved, not paid invoices are those that have been posted in Finance and Operations, but they have not yet been fully paid.</span></span>
-   <span data-ttu-id="5ac76-113">已付款发票为已经在 Finance and Operations 中全额付清的发票。</span><span class="sxs-lookup"><span data-stu-id="5ac76-113">Paid invoices are those that have been fully paid in Finance and Operations.</span></span>

<span data-ttu-id="5ac76-114">单击磁贴将打开“**发票列表**”页面的筛选视图。</span><span class="sxs-lookup"><span data-stu-id="5ac76-114">Clicking on a tile will open a filtered view of the **Invoices list** page.</span></span>

### <a name="tabular-lists"></a><span data-ttu-id="5ac76-115">表格式列表</span><span class="sxs-lookup"><span data-stu-id="5ac76-115">Tabular lists</span></span>
